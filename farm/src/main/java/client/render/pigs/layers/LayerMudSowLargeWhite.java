...
import client.render.pigs.RenderSowLargeWhite;
...
public class LayerMudSowLargeWhite implements LayerRenderer<EntitySowLargeWhite>
{
	...
	@Override
	public void doRenderLayer(EntitySowLargeWhite LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
