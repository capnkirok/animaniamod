...
import client.render.pigs.RenderPigletYorkshire;
...
public class LayerMudPigletYorkshire implements LayerRenderer<PigEntityletYorkshire>
{
	...
	@Override
	public void doRenderLayer(PigEntityletYorkshire LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
