...
import client.render.pigs.RenderSowLargeBlack;
...
public class LayerMudSowLargeBlack implements LayerRenderer<EntitySowLargeBlack>
{
	...
	@Override
	public void doRenderLayer(EntitySowLargeBlack LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
