...
import client.render.pigs.RenderHogOldSpot;
...
public class LayerMudHogOldSpot implements LayerRenderer<EntityHogOldSpot>
{
	...
	@Override
	public void doRenderLayer(EntityHogOldSpot LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
