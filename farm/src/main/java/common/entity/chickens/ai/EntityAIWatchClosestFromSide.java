package common.entity.chickens.ai;
...
public class WatchClosestFromSideGoal extends Goal
{
	...
	public void updateTask()
	{
		...
		this.theWatcher.getLookHelper().setLookPosition(this.closestEntity.getX(), this.closestEntity.getY() + this.closestEntity.getEyeHeight() + 5F, this.closestEntity.getZ(), this.theWatcher.getHorizontalFaceSpeed(), this.theWatcher.getVerticalFaceSpeed());
		--this.lookTime;
	}
}