...
{// RenderPlayer
	...
	private static final ResourceLocation[] FROGS_TEXTURES = { new ResourceLocation(RenderFrogs.modid, RenderFrogs.frogsBaseDir + "default_frog.png"), new ResourceLocation(RenderFrogs.modid, RenderFrogs.frogsBaseDir + "green_frog.png") };
	...
	protected ResourceLocation getEntityTexture(T entity)
	{
		...
		else if (entity.getCustomNameTag().equals("Pepe"))
