...
public class ItemCookedLonghornRoast extends ItemFood {
	private final String name = "cooked_longhorn_roast";

	public ItemCookedLonghornRoast() {
		super (10, 10F, true); 
	...
	protected void onFoodEaten(ItemStack itemstack, World worldObj, EntityPlayer entityplayer) {
		...
		{
			entityplayer.addPotionEffect(new PotionEffect(MobEffects.INSTANT_HEALTH, 6, 1, false, false));
		}
	}
