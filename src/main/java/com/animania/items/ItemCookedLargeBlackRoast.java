...
public class ItemCookedLargeBlackRoast extends ItemFood {
	private final String name = "cooked_large_black_roast";

	public ItemCookedLargeBlackRoast() {
		super (16, 16F, true); 
	...
	protected void onFoodEaten(ItemStack itemstack, World worldObj, EntityPlayer entityplayer) {
		...
		{
			entityplayer.addPotionEffect(new PotionEffect(MobEffects.ABSORPTION, 1800, 2, false, false));
		}
	}
