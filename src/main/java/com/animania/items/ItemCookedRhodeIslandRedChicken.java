...
public class ItemCookedRhodeIslandRedChicken extends ItemFood {
	private final String name = "cooked_rhode_island_red_chicken";

	public ItemCookedRhodeIslandRedChicken() {
		super (8, 8F, true); 
	...
	protected void onFoodEaten(ItemStack itemstack, World worldObj, EntityPlayer entityplayer) {
		...
		{
			entityplayer.addPotionEffect(new PotionEffect(MobEffects.HASTE, 1200, 0, false, false));
		}
	}
