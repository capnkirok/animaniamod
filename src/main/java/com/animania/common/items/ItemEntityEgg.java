...
public class ItemEntityEgg extends Item
{
	...
	public ItemEntityEgg(String atype) {
		...
		this.name = this.name + "_" + this.animalType;
		...
		if (!playerIn.canPlayerEdit(pos, facing, stack))
			...
			if (movingobjectposition == null)
				...
				if (movingobjectposition.typeOfHit == RayTraceResult.Type.BLOCK) {
					...
					worldIn.playSound(null, entityplayer.posX, entityplayer.posY, entityplayer.posZ, ModSoundEvents.combo, SoundCategory.PLAYERS,
							0.8F, ((rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F) / 0.8F);
	...
	public void addInformation(ItemStack itemstack, EntityPlayer player, List list, boolean par4) {
		list.add(TextFormatting.GOLD + I18n.translateToLocal("item.animania_entity_egg.desc1") + " " + TextFormatting.DARK_GRAY
				+ I18n.translateToLocal("item.animania_entity_egg.desc2"));
	}
}
