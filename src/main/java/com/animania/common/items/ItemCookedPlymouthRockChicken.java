...
public class ItemCookedPlymouthRockChicken extends ItemFood {
	private final String name = "cooked_plymouth_rock_chicken";

	public ItemCookedPlymouthRockChicken() {
		super (10, 10F, true); 
	...
	protected void onFoodEaten(ItemStack itemstack, World worldObj, EntityPlayer entityplayer) {
		...
		{
			entityplayer.addPotionEffect(new PotionEffect(MobEffects.HASTE, 2400, 0, false, false));
		}
	}
