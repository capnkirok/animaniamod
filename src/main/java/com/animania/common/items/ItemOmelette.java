...
public class ItemOmelette extends ItemFood
{
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer player, List list, boolean par4) {
        if (AnimaniaConfig.gameRules.foodsGiveBonusEffects) {
            if (itemstack.getItem() == ItemHandler.cheeseOmelette || itemstack.getItem() == ItemHandler.ultimateOmelette)
                list.add(TextFormatting.GREEN + I18n.translateToLocal("tooltip.an.cheeseomelette"));
            if (itemstack.getItem() == ItemHandler.baconOmelette || itemstack.getItem() == ItemHandler.ultimateOmelette)
                list.add(TextFormatting.GREEN + I18n.translateToLocal("tooltip.an.baconomelette"));
            if (itemstack.getItem() == ItemHandler.truffleOmelette || itemstack.getItem() == ItemHandler.ultimateOmelette)
