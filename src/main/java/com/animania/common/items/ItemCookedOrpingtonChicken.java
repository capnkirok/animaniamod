...
public class ItemCookedOrpingtonChicken extends ItemFood {
	private final String name = "cooked_orpington_chicken";

	public ItemCookedOrpingtonChicken() {
		super (12, 12F, true); 
	...
	protected void onFoodEaten(ItemStack itemstack, World worldObj, EntityPlayer entityplayer) {
		...
		{
			entityplayer.addPotionEffect(new PotionEffect(MobEffects.HASTE, 3000, 0, false, false));
		}
	}
