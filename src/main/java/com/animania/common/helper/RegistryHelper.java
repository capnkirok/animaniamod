...
public class RegistryHelper
{
    ...
    public static class Entities
    {
         ...
         */
        public static void register(Class<? extends net.minecraft.entity.Entity> entityClass, String entityName, int entityID, int trackingRange,
                int updateFrequency, boolean sendsVelocityUpdates) {
            ResourceLocation registryName = new ResourceLocation(Animania.MODID, entityName);
            EntityRegistry.registerModEntity(registryName, entityClass, registryName.toString(), entityID, Animania.instance, trackingRange,
         ...
         */
        public static void registerEntity(Class<? extends net.minecraft.entity.Entity> entityClass, String entityName, int entityID,
                int trackingRange, int updateFrequency, boolean sendsVelocityUpdates, int eggPrimary, int eggSecondary) {
            ResourceLocation registryName = new ResourceLocation(Animania.MODID, entityName);
            EntityRegistry.registerModEntity(registryName, entityClass, registryName.toString(), entityID, Animania.instance, trackingRange,
