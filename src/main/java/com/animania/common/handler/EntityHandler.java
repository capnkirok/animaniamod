...
public class EntityHandler {
	...
	public static void preInit() {
		...
		*/
		...
		RegistryHelper.Entities.addSpawn(EntityFrogs.class, AnimaniaConfig.spawn.spawnProbabilityAmphibians, 1, 2, EnumCreatureType.AMBIENT, RegistryHelper.Entities.getBiomes(BiomeDictionary.Type.SWAMP));
