...
public class OldEntityHandler
{
	...
	public static void preInit() {
		...
		if (AnimaniaConfig.spawn.spawnAnimaniaCows) {
			...
			EntityRegistry.registerModEntity(ch1, EntityCowHolstein.class, "animania.CowHolstein", AnimaniaConfig.entity.CowHolsteinID, Animania.MODID, 64, 3, true);

			ResourceLocation ch2 = new ResourceLocation("animania:textures/entity/cows/bull_holstein.png");
			EntityRegistry.registerModEntity(ch2, EntityBullHolstein.class, "animania.BullHolstein", AnimaniaConfig.entity.BullHolsteinID, Animania.MODID, 64, 3, true);

			ResourceLocation ch3 = new ResourceLocation("animania:textures/entity/cows/calf_holstein.png");
			EntityRegistry.registerModEntity(ch3, EntityCalfHolstein.class, "animania.CalfHolstein", AnimaniaConfig.entity.CalfHolsteinID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(cf1, EntityCowFriesian.class, "animania.CowFriesian", AnimaniaConfig.entity.CowFriesianID, Animania.MODID, 64, 3, true);

			ResourceLocation cf2 = new ResourceLocation("animania:textures/entity/cows/bull_friesian.png");
			EntityRegistry.registerModEntity(cf2, EntityBullFriesian.class, "animania.BullFriesian", AnimaniaConfig.entity.BullFriesianID, Animania.MODID, 64, 3, true);

			ResourceLocation cf3 = new ResourceLocation("animania:textures/entity/cows/calf_friesian.png");
			EntityRegistry.registerModEntity(cf3, EntityCalfFriesian.class, "animania.CalfFriesian", AnimaniaConfig.entity.CalfFriesianID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(ca1, EntityCowAngus.class, "animania.CowAngus", AnimaniaConfig.entity.CowAngusID, Animania.MODID, 64, 3, true);

			ResourceLocation ca2 = new ResourceLocation("animania:textures/entity/cows/bull_angus.png");
			EntityRegistry.registerModEntity(ca2, EntityBullAngus.class, "animania.BullAngus", AnimaniaConfig.entity.BullAngusID, Animania.MODID, 64, 3, true);

			ResourceLocation ca3 = new ResourceLocation("animania:textures/entity/cows/calf_angus.png");
			EntityRegistry.registerModEntity(ca3, EntityCalfAngus.class, "animania.CalfAngus", AnimaniaConfig.entity.CalfAngusID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.addSpawn(EntityCowAngus.class, AnimaniaConfig.spawn.spawnProbabilityCows, 1, AnimaniaConfig.spawn.numberCowFamilies, EnumCreatureType.CREATURE, getBiomes(BiomeDictionary.Type.MUSHROOM));

			ResourceLocation cl1 = new ResourceLocation("animania:textures/entity/cows/cow_longhorn.png");
			EntityRegistry.registerModEntity(cl1, EntityCowLonghorn.class, "animania.CowLonghorn", AnimaniaConfig.entity.CowLonghornID, Animania.MODID, 64, 3, true);

			ResourceLocation cl2 = new ResourceLocation("animania:textures/entity/cows/bull_longhorn.png");
			EntityRegistry.registerModEntity(cl2, EntityBullLonghorn.class, "animania.BullLonghorn", AnimaniaConfig.entity.BullLonghornID, Animania.MODID, 64, 3, true);

			ResourceLocation cl3 = new ResourceLocation("animania:textures/entity/cows/calf_longhorn.png");
			EntityRegistry.registerModEntity(cl3, EntityCalfLonghorn.class, "animania.CalfLonghorn", AnimaniaConfig.entity.CalfLonghornID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(che1, EntityCowHereford.class, "animania.CowHereford", AnimaniaConfig.entity.CowHerefordID, Animania.MODID, 64, 3, true);

			ResourceLocation che2 = new ResourceLocation("animania:textures/entity/cows/bull_hereford.png");
			EntityRegistry.registerModEntity(che2, EntityBullHereford.class, "animania.BullHereford", AnimaniaConfig.entity.BullHerefordID, Animania.MODID, 64, 3, true);

			ResourceLocation che3 = new ResourceLocation("animania:textures/entity/cows/calf_hereford.png");
			EntityRegistry.registerModEntity(che3, EntityCalfHereford.class, "animania.CalfHereford", AnimaniaConfig.entity.CalfHerefordID, Animania.MODID, 64, 3, true);
		...
		if (AnimaniaConfig.spawn.spawnAnimaniaChickens) {
			...
			EntityRegistry.registerModEntity(chp1, EntityHenPlymouthRock.class, "animania.HenPlymouthRock", AnimaniaConfig.entity.HenPlymouthRockID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(chp2, EntityRoosterPlymouthRock.class, "animania.RoosterPlymouthRock", AnimaniaConfig.entity.RoosterPlymouthRockID, Animania.MODID, 64, 3, true);

			ResourceLocation chp3 = new ResourceLocation("animania:textures/entity/chickens/chick_specked.png");
			EntityRegistry.registerModEntity(chp3, EntityChickPlymouthRock.class, "animania.ChickPlymouthRock", AnimaniaConfig.entity.ChickPlymouthRockID, Animania.MODID, 64, 3, true);

			ResourceLocation chl1 = new ResourceLocation("animania:textures/entity/chickens/hen_white.png");
			EntityRegistry.registerModEntity(chl1, EntityHenLeghorn.class, "animania.HenLeghorn", AnimaniaConfig.entity.HenLeghornID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(chl2, EntityRoosterLeghorn.class, "animania.RoosterLeghorn", AnimaniaConfig.entity.RoosterLeghornID, Animania.MODID, 64, 3, true);

			ResourceLocation chl3 = new ResourceLocation("animania:textures/entity/chickens/chick_white.png");
			EntityRegistry.registerModEntity(chl3, EntityChickLeghorn.class, "animania.ChickLeghorn", AnimaniaConfig.entity.ChickLeghornID, Animania.MODID, 64, 3, true);

			ResourceLocation cho1 = new ResourceLocation("animania:textures/entity/chickens/hen_golden.png");
			EntityRegistry.registerModEntity(cho1, EntityHenOrpington.class, "animania.HenOrpington", AnimaniaConfig.entity.HenOrpingtonID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(cho2, EntityRoosterOrpington.class, "animania.RoosterOrpington", AnimaniaConfig.entity.RoosterOrpingtonID, Animania.MODID, 64, 3, true);

			ResourceLocation cho3 = new ResourceLocation("animania:textures/entity/chickens/chick_golden.png");
			EntityRegistry.registerModEntity(cho3, EntityChickOrpington.class, "animania.ChickOrpington", AnimaniaConfig.entity.ChickOrpingtonID, Animania.MODID, 64, 3, true);

			ResourceLocation chw1 = new ResourceLocation("animania:textures/entity/chickens/hen_brown.png");
			EntityRegistry.registerModEntity(chw1, EntityHenWyandotte.class, "animania.HenWyandotte", AnimaniaConfig.entity.HenWyandotteID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(chw2, EntityRoosterWyandotte.class, "animania.RoosterWyandotte", AnimaniaConfig.entity.RoosterWyandotteID, Animania.MODID, 64, 3, true);

			ResourceLocation chw3 = new ResourceLocation("animania:textures/entity/chickens/chick_brown.png");
			EntityRegistry.registerModEntity(chw3, EntityChickWyandotte.class, "animania.ChickWyandotte", AnimaniaConfig.entity.ChickWyandotteID, Animania.MODID, 64, 3, true);

			ResourceLocation chr1 = new ResourceLocation("animania:textures/entity/chickens/hen_red.png");
			EntityRegistry.registerModEntity(chr1, EntityHenRhodeIslandRed.class, "animania.HenRhodeIslandRed", AnimaniaConfig.entity.HenRhodeIslandRedID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(chr2, EntityRoosterRhodeIslandRed.class, "animania.RoosterRhodeIslandRed", AnimaniaConfig.entity.RoosterRhodeIslandRedID, Animania.MODID, 64, 3, true);

			ResourceLocation chr3 = new ResourceLocation("animania:textures/entity/chickens/chick_red.png");
			EntityRegistry.registerModEntity(chr3, EntityChickRhodeIslandRed.class, "animania.ChickRhodeIslandRed", AnimaniaConfig.entity.ChickRhodeIslandRedID, Animania.MODID, 64, 3, true);
		...
		if (AnimaniaConfig.spawn.spawnAnimaniaPigs) {
			...
			EntityRegistry.registerModEntity(py1, EntitySowYorkshire.class, "animania.SowYorkshire", AnimaniaConfig.entity.SowYorkshireID, Animania.MODID, 64, 3, true);

			ResourceLocation py2 = new ResourceLocation("animania:textures/entity/chickens/hog_yorkshire.png");
			EntityRegistry.registerModEntity(py2, EntityHogYorkshire.class, "animania.HogYorkshire", AnimaniaConfig.entity.HogYorkshireID, Animania.MODID, 64, 3, true);

			ResourceLocation py3 = new ResourceLocation("animania:textures/entity/chickens/piglet_yorkshire.png");
			EntityRegistry.registerModEntity(py3, EntityPigletYorkshire.class, "animania.PigletYorkshire", AnimaniaConfig.entity.PigletYorkshireID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(pos1, EntitySowOldSpot.class, "animania.SowOldSpot", AnimaniaConfig.entity.SowOldSpotID, Animania.MODID, 64, 3, true);

			ResourceLocation pos2 = new ResourceLocation("animania:textures/entity/pigs/hog_old_spot.png");
			EntityRegistry.registerModEntity(pos2, EntityHogOldSpot.class, "animania.HogOldSpot", AnimaniaConfig.entity.HogOldSpotID, Animania.MODID, 64, 3, true);

			ResourceLocation pos3 = new ResourceLocation("animania:textures/entity/pigs/piglet_old_spot.png");
			EntityRegistry.registerModEntity(pos3, EntityPigletOldSpot.class, "animania.PigletOldSpot", AnimaniaConfig.entity.PigletOldSpotID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(plb1, EntitySowLargeBlack.class, "animania.SowLargeBlack", AnimaniaConfig.entity.SowLargeBlackID, Animania.MODID, 64, 3, true);

			ResourceLocation plb2 = new ResourceLocation("animania:textures/entity/pigs/hog_large_black.png");
			EntityRegistry.registerModEntity(plb2, EntityHogLargeBlack.class, "animania.HogLargeBlack", AnimaniaConfig.entity.HogLargeBlackID, Animania.MODID, 64, 3, true);

			ResourceLocation plb3 = new ResourceLocation("animania:textures/entity/pigs/piglet_large_black.png");
			EntityRegistry.registerModEntity(plb3, EntityPigletLargeBlack.class, "animania.PigletLargeBlack", AnimaniaConfig.entity.PigletLargeBlackID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(plw1, EntitySowLargeWhite.class, "animania.SowLargeWhite", AnimaniaConfig.entity.SowLargeWhiteID, Animania.MODID, 64, 3, true);

			ResourceLocation plw2 = new ResourceLocation("animania:textures/entity/pigs/hog_large_white.png");
			EntityRegistry.registerModEntity(plw2, EntityHogLargeWhite.class, "animania.HogLargeWhite", AnimaniaConfig.entity.HogLargeWhiteID, Animania.MODID, 64, 3, true);

			ResourceLocation plw3 = new ResourceLocation("animania:textures/entity/pigs/piglet_large_white.png");
			EntityRegistry.registerModEntity(plw3, EntityPigletLargeWhite.class, "animania.PigletLargeWhite", AnimaniaConfig.entity.PigletLargeWhiteID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(pd1, EntitySowDuroc.class, "animania.SowDuroc", AnimaniaConfig.entity.SowDurocID, Animania.MODID, 64, 3, true);

			ResourceLocation pd2 = new ResourceLocation("animania:textures/entity/pigs/hog_duroc.png");
			EntityRegistry.registerModEntity(pd2, EntityHogDuroc.class, "animania.HogDuroc", AnimaniaConfig.entity.HogDurocID, Animania.MODID, 64, 3, true);

			ResourceLocation pd3 = new ResourceLocation("animania:textures/entity/pigs/piglet_duroc.png");
			EntityRegistry.registerModEntity(pd3, EntityPigletDuroc.class, "animania.PigletDuroc", AnimaniaConfig.entity.PigletDurocID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(ph1, EntitySowHampshire.class, "animania.SowHampshire", AnimaniaConfig.entity.SowHampshireID, Animania.MODID, 64, 3, true);

			ResourceLocation ph2 = new ResourceLocation("animania:textures/entity/pigs/hog_hampshire.png");
			EntityRegistry.registerModEntity(ph2, EntityHogHampshire.class, "animania.HogHampshire", AnimaniaConfig.entity.HogHampshireID, Animania.MODID, 64, 3, true);

			ResourceLocation ph3 = new ResourceLocation("animania:textures/entity/pigs/piglet_hampshire.png");
			EntityRegistry.registerModEntity(ph3, EntityPigletHampshire.class, "animania.PigletHampshire", AnimaniaConfig.entity.PigletHampshireID, Animania.MODID, 64, 3, true);
		...
		if (AnimaniaConfig.spawn.spawnAnimaniaRodents) {
			...
			EntityRegistry.registerModEntity(ha1, EntityHamster.class, "animania.Hamster", AnimaniaConfig.entity.HamsterMaleID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(fe1, EntityFerretGrey.class, "animania.FerretGrey", AnimaniaConfig.entity.FerretMaleGreyID, Animania.MODID, 64, 3, true);

			ResourceLocation fe2 = new ResourceLocation("animania:textures/entity/pigs/ferret_white.png");
			EntityRegistry.registerModEntity(fe2, EntityFerretWhite.class, "animania.FerretWhite", AnimaniaConfig.entity.FerretMaleWhiteID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(he1, EntityHedgehog.class, "animania.Hedgehog", AnimaniaConfig.entity.HedgehogMaleID, Animania.MODID, 64, 3, true);
			...
			EntityRegistry.registerModEntity(he2, EntityHedgehogAlbino.class, "animania.HedgehogAlbino", AnimaniaConfig.entity.HedgehogMaleAlbinoID, Animania.MODID, 64, 3, true);
