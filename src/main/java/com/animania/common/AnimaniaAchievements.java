...
/*
    ...
    public static void init() {
        ...
        AnimaniaAchievements.Peacocks = new Achievement("Peacocks", "an.peacocks", 2, 4, ItemHandler.entityeggpeachickblue, AnimaniaAchievements.White).registerStat();
    	...
    	/*
        AchievementPage.registerAchievementPage(AnimaniaAchievements.page = new AchievementPage("Animania", new Achievement[] { 
        				AnimaniaAchievements.Leghorn, AnimaniaAchievements.Orpington, AnimaniaAchievements.PlymouthRock,
    	 ...
    	 AnimaniaAchievements.Leghorn = new Achievement("leghorn", "an.leghorn", -2, 0, ItemHandler.entityeggchickleghorn, (Achievement) null).registerStat();
    	 AchievementPage.registerAchievementPage(AnimaniaAchievements.page = new AchievementPage("Animania", new Achievement[] { AnimaniaAchievements.Leghorn }));
