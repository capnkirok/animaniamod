...
public class EntityHenRhodeIslandRed extends EntityChicken
{
    private static final DataParameter<String>  COLOR            = EntityDataManager.<String> createKey(EntityHenRhodeIslandRed.class, DataSerializers.STRING);
    private static final DataParameter<Boolean> FED              = EntityDataManager.<Boolean> createKey(EntityHenRhodeIslandRed.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> WATERED          = EntityDataManager.<Boolean> createKey(EntityHenRhodeIslandRed.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> LAID             = EntityDataManager.<Boolean> createKey(EntityHenRhodeIslandRed.class, DataSerializers.BOOLEAN);
    ...
    public EntityHenRhodeIslandRed(World world) {
        ...
        this.tasks.addTask(7, new EntityAITempt(this, 1.2D, false, EntityHenRhodeIslandRed.TEMPTATION_ITEMS));
        ...
        this.laidTimer = AnimaniaConfig.careAndFeeding.laidTimer / 2 + 500 + this.rand.nextInt(100);
        this.happyTimer = 60;
    ...
    public String getColor() {
        return this.dataManager.get(EntityHenRhodeIslandRed.COLOR);
    }

    public void setColor(String color) {
        this.dataManager.set(EntityHenRhodeIslandRed.COLOR, String.valueOf(color));
    }
    ...
    private void ColorInitialize() {
        if (EntityHenRhodeIslandRed.ColorList == null) {
            EntityHenRhodeIslandRed.ColorList = new ArrayList();
            try {
                ...
                for (ResourceInfo i : ClassPath.from(this.getClass().getClassLoader()).getResources()) {
                    ...
                    if (m.matches()) {
                        String s = m.group(1);
                        EntityHenRhodeIslandRed.ColorList.add(s);
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityHenRhodeIslandRed.COLOR, "");
        this.dataManager.register(EntityHenRhodeIslandRed.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityHenRhodeIslandRed.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityHenRhodeIslandRed.LAID, Boolean.valueOf(true));
    }
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
        ...
        if (s1.length() > 0)
            if (EntityHenRhodeIslandRed.ColorList.contains(s1)) {
    ...
    public boolean getFed() {
        return this.dataManager.get(EntityHenRhodeIslandRed.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityHenRhodeIslandRed.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityHenRhodeIslandRed.FED, Boolean.valueOf(false));
    }

    public boolean getLaid() {
        return this.dataManager.get(EntityHenRhodeIslandRed.LAID).booleanValue();
    }

    public void setLaid(boolean laid) {
        if (laid) {
            this.dataManager.set(EntityHenRhodeIslandRed.LAID, Boolean.valueOf(true));
            this.laidTimer = AnimaniaConfig.careAndFeeding.laidTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityHenRhodeIslandRed.LAID, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityHenRhodeIslandRed.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityHenRhodeIslandRed.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityHenRhodeIslandRed.WATERED, Boolean.valueOf(false));
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY && EntityHenRhodeIslandRed.TEMPTATION_ITEMS.contains(stack.getItem());
    }
    ...
    @Override
    public EntityHenRhodeIslandRed createChild(EntityAgeable ageable) {
