...
{
    private static final DataParameter<String>  COLOR            = EntityDataManager.<String> createKey(EntityHenRhodeIslandRed.class,
            DataSerializers.STRING);
    private static final DataParameter<Boolean> FED              = EntityDataManager.<Boolean> createKey(EntityHenRhodeIslandRed.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> WATERED          = EntityDataManager.<Boolean> createKey(EntityHenRhodeIslandRed.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> LAID             = EntityDataManager.<Boolean> createKey(EntityHenRhodeIslandRed.class,
            DataSerializers.BOOLEAN);
