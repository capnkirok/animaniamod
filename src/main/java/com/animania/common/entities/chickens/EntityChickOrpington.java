...
public class EntityChickOrpington extends EntityChicken
{
    private static final DataParameter<String>  COLOR            = EntityDataManager.<String> createKey(EntityChickOrpington.class,
            DataSerializers.STRING);
    private static final DataParameter<Boolean> FED              = EntityDataManager.<Boolean> createKey(EntityChickOrpington.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> WATERED          = EntityDataManager.<Boolean> createKey(EntityChickOrpington.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>   AGE              = EntityDataManager.<Float> createKey(EntityChickOrpington.class,
    ...
    public EntityChickOrpington(World world) {
        ...
        this.tasks.addTask(4, new EntityAITempt(this, 1.2D, false, EntityChickOrpington.TEMPTATION_ITEMS));
    ...
    public String getColor() {
        return this.dataManager.get(EntityChickOrpington.COLOR);
    }

    public void setColor(String color) {
        this.dataManager.set(EntityChickOrpington.COLOR, String.valueOf(color));
    }
    ...
    private String getRandomColor() {
        ...
        Collections.shuffle(EntityChickOrpington.ColorList);
    ...
    private void ColorInitialize() {
        if (EntityChickOrpington.ColorList == null) {
            EntityChickOrpington.ColorList = new ArrayList();
            try {
                ...
                for (ResourceInfo i : ClassPath.from(this.getClass().getClassLoader()).getResources()) {
                    ...
                    if (m.matches()) {
                        String s = m.group(1);
                        EntityChickOrpington.ColorList.add(s);
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityChickOrpington.COLOR, "");
        this.dataManager.register(EntityChickOrpington.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityChickOrpington.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityChickOrpington.AGE, Float.valueOf(0));
    }
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
        ...
        this.ColorInitialize();
        if (s1.length() > 0)
            if (EntityChickOrpington.ColorList.contains(s1)) {
    ...
    public boolean getFed() {
        return this.dataManager.get(EntityChickOrpington.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityChickOrpington.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityChickOrpington.FED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityChickOrpington.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityChickOrpington.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityChickOrpington.WATERED, Boolean.valueOf(false));
    }

    public float getEntityAge() {
        return this.dataManager.get(EntityChickOrpington.AGE).floatValue();
    }

    public void setEntityAge(float age) {
        this.dataManager.set(EntityChickOrpington.AGE, Float.valueOf(age));
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY && EntityChickOrpington.TEMPTATION_ITEMS.contains(stack.getItem());
    }
