...
{
    private static final DataParameter<String>  COLOR            = EntityDataManager.<String> createKey(EntityRoosterRhodeIslandRed.class,
            DataSerializers.STRING);
    private static final DataParameter<Integer> CROWTIMER        = EntityDataManager.<Integer> createKey(EntityRoosterRhodeIslandRed.class,
            DataSerializers.VARINT);
    private static final DataParameter<Integer> CROWDURATION     = EntityDataManager.<Integer> createKey(EntityRoosterRhodeIslandRed.class,
            DataSerializers.VARINT);
    private static final DataParameter<Boolean> FED              = EntityDataManager.<Boolean> createKey(EntityRoosterRhodeIslandRed.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> WATERED          = EntityDataManager.<Boolean> createKey(EntityRoosterRhodeIslandRed.class,
            DataSerializers.BOOLEAN);
