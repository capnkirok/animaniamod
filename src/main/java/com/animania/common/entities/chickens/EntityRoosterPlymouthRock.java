...
public class EntityRoosterPlymouthRock extends EntityAnimal {
	private static final DataParameter<String> COLOR = EntityDataManager
			.<String>createKey(EntityRoosterPlymouthRock.class, DataSerializers.STRING);
	private static final DataParameter<Integer> CROWTIMER = EntityDataManager
			.<Integer>createKey(EntityRoosterPlymouthRock.class, DataSerializers.VARINT);
	...
	private static final DataParameter<Boolean> FED = EntityDataManager
			.<Boolean>createKey(EntityRoosterPlymouthRock.class, DataSerializers.BOOLEAN);
