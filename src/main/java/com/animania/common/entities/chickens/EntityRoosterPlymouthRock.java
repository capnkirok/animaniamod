...
{
    private static final DataParameter<String>  COLOR            = EntityDataManager.<String> createKey(EntityRoosterPlymouthRock.class, DataSerializers.STRING);
    private static final DataParameter<Integer> CROWTIMER        = EntityDataManager.<Integer> createKey(EntityRoosterPlymouthRock.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> CROWDURATION     = EntityDataManager.<Integer> createKey(EntityRoosterPlymouthRock.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> FED              = EntityDataManager.<Boolean> createKey(EntityRoosterPlymouthRock.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> WATERED          = EntityDataManager.<Boolean> createKey(EntityRoosterPlymouthRock.class, DataSerializers.BOOLEAN);
    ...
    public EntityRoosterPlymouthRock(World world) {
        ...
        this.tasks.addTask(2, new EntityAITempt(this, 1.2D, false, EntityRoosterPlymouthRock.TEMPTATION_ITEMS));
    ...
    public String getColor() {
        return this.dataManager.get(EntityRoosterPlymouthRock.COLOR);
    }

    public void setColor(String color) {
        this.dataManager.set(EntityRoosterPlymouthRock.COLOR, String.valueOf(color));
    }
    ...
    private String getRandomColor() {
        return "animania:textures/entity/chickens/rooster_specked.png";
    }

    private String getTextureBlink() {
        return "animania:textures/entity/chickens/rooster_specked_blink.png";
    }

    private void ColorInitialize() {
        if (EntityRoosterPlymouthRock.ColorList == null) {
            EntityRoosterPlymouthRock.ColorList = new ArrayList();
            try {
                ...
                for (ResourceInfo i : ClassPath.from(this.getClass().getClassLoader()).getResources()) {
                    ...
                    if (m.matches()) {
                        String s = m.group(1);
                        EntityRoosterPlymouthRock.ColorList.add(s);
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityRoosterPlymouthRock.COLOR, "");
        this.dataManager.register(EntityRoosterPlymouthRock.CROWTIMER, Integer.valueOf(0));
        this.dataManager.register(EntityRoosterPlymouthRock.CROWDURATION, Integer.valueOf(0));
        this.dataManager.register(EntityRoosterPlymouthRock.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityRoosterPlymouthRock.WATERED, Boolean.valueOf(true));
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
        ...
        if (s1.length() > 0)
            if (EntityRoosterPlymouthRock.ColorList.contains(s1)) {
    ...
    public boolean getFed() {
        return this.dataManager.get(EntityRoosterPlymouthRock.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityRoosterPlymouthRock.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityRoosterPlymouthRock.FED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityRoosterPlymouthRock.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityRoosterPlymouthRock.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityRoosterPlymouthRock.WATERED, Boolean.valueOf(false));
    }

    public int getCrowDuration() {
        return this.dataManager.get(EntityRoosterPlymouthRock.CROWDURATION).intValue();
    }

    public void setCrowDuration(int duration) {
        this.dataManager.set(EntityRoosterPlymouthRock.CROWDURATION, Integer.valueOf(duration));
    }

    public int getTimeUntilNextCrow() {
        return this.dataManager.get(EntityRoosterPlymouthRock.CROWTIMER).intValue();
    }

    public void setTimeUntilNextCrow(int timer) {
        this.dataManager.set(EntityRoosterPlymouthRock.CROWTIMER, Integer.valueOf(timer));
    }
    ...
    protected void dropFewItems(boolean hit, int lootlevel) {
        ...
        if (AnimaniaConfig.drops.customMobDrops) {
            ...
            dropItem = new ItemStack(ItemHandler.rawPlymouthRockChicken);
            if (this.isBurning())
                dropItem = new ItemStack(ItemHandler.cookedPlymouthRockChicken);
        }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY && EntityRoosterPlymouthRock.TEMPTATION_ITEMS.contains(stack.getItem());
    }
