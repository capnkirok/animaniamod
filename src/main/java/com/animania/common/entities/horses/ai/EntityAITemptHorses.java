...
public class EntityAITemptHorses extends EntityAIBase
{
    ...
    {
        //this.temptedEntity.getLookHelper().setLookPositionWithEntity(this.temptingPlayer, (float)(this.temptedEntity.getHorizontalFaceSpeed() + 0), (float)this.temptedEntity.getVerticalFaceSpeed());
