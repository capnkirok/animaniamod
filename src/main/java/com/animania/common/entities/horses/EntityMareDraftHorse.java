...
public class EntityMareDraftHorse extends EntityAnimal
{

	private static final DataParameter<Integer> COLOR_NUM = EntityDataManager.<Integer>createKey(EntityMareDraftHorse.class, DataSerializers.VARINT);
	private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID = EntityDataManager.<Optional<UUID>>createKey(EntityMareDraftHorse.class, DataSerializers.OPTIONAL_UNIQUE_ID);
	private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(new Item[] {Items.WHEAT, Items.APPLE, Items.CARROT});
	private static final DataParameter<Boolean> WATERED = EntityDataManager.<Boolean>createKey(EntityMareDraftHorse.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> FED = EntityDataManager.<Boolean>createKey(EntityMareDraftHorse.class, DataSerializers.BOOLEAN);
	...
	public EntityMareDraftHorse createChild(EntityAgeable p_90011_1_)
	{
		return null;
	}
