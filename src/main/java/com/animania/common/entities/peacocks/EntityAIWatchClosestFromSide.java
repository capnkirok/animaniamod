...
public class EntityAIWatchClosestFromSide extends EntityAIBase
{
    ...
    public void updateTask()
    {
    	...
    	this.theWatcher.getLookHelper().setLookPosition(this.closestEntity.posX + 20F, this.closestEntity.posY + (double)this.closestEntity.getEyeHeight(), this.closestEntity.posZ, (float)this.theWatcher.getHorizontalFaceSpeed(), (float)this.theWatcher.getVerticalFaceSpeed());
        --this.lookTime;
    }
}