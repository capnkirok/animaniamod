...
public class EntityPeacockBlue extends EntityAnimal
{
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(EntityPeacockBlue.FED, Boolean.valueOf(true));
		this.dataManager.register(EntityPeacockBlue.WATERED, Boolean.valueOf(true));
	}
	...
	public boolean getFed() {
		return this.dataManager.get(EntityPeacockBlue.FED).booleanValue();
	}

	public void setFed(boolean fed) {
		if (fed) {
			this.dataManager.set(EntityPeacockBlue.FED, Boolean.valueOf(true));
			this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
			this.setHealth(this.getHealth() + 1.0F);
		}
		else
			this.dataManager.set(EntityPeacockBlue.FED, Boolean.valueOf(false));
	}

	public boolean getWatered() {
		return this.dataManager.get(EntityPeacockBlue.WATERED).booleanValue();
	}

	public void setWatered(boolean watered) {
		if (watered) {
			this.dataManager.set(EntityPeacockBlue.WATERED, Boolean.valueOf(true));
			this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
		}
		else
			this.dataManager.set(EntityPeacockBlue.WATERED, Boolean.valueOf(false));
	}
	...
	public boolean isBreedingItem(@Nullable ItemStack stack) {
		return stack != ItemStack.EMPTY && EntityPeacockBlue.TEMPTATION_ITEMS.contains(stack.getItem());
	}
