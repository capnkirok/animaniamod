...
{
    private static final DataParameter<Boolean> FED                   = EntityDataManager.<Boolean> createKey(EntityPeafowlBlue.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> WATERED               = EntityDataManager.<Boolean> createKey(EntityPeafowlBlue.class,
            DataSerializers.BOOLEAN);
    ...
    private ResourceLocation                    resourceLocationBlink = new ResourceLocation(
            "animania:textures/entity/peacocks/peafowl_blue_blink.png");
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityPeafowlBlue.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityPeafowlBlue.WATERED, Boolean.valueOf(true));
    }
    ...
    public boolean getFed() {
        return this.dataManager.get(EntityPeafowlBlue.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityPeafowlBlue.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityPeafowlBlue.FED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityPeafowlBlue.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityPeafowlBlue.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPeafowlBlue.WATERED, Boolean.valueOf(false));
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY && EntityPeafowlBlue.TEMPTATION_ITEMS.contains(stack.getItem());
    }
