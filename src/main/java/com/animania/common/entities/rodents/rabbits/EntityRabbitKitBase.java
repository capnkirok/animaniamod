...
public class EntityRabbitKitBase extends EntityTameable implements TOPInfoProviderRodent
{

	protected static final DataParameter<Boolean> FED = EntityDataManager.<Boolean>createKey(EntityRabbitKitBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> WATERED = EntityDataManager.<Boolean>createKey(EntityRabbitKitBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> TAMED = EntityDataManager.<Boolean>createKey(EntityRabbitKitBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> SITTING = EntityDataManager.<Boolean>createKey(EntityRabbitKitBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> RIDING = EntityDataManager.<Boolean>createKey(EntityRabbitKitBase.class, DataSerializers.BOOLEAN);
	...
	public EntityRabbitKitBase(World worldIn)
	{
		...
		this.jumpHelper = new EntityRabbitKitBase.RabbitJumpHelper(this);
		this.moveHelper = new EntityRabbitKitBase.RabbitMoveHelper(this);
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(9, new EntityAITemptRodents(this, 1.2D, false, EntityRabbitKitBase.TEMPTATION_ITEMS));
	...
	{
		super.entityInit();
		this.dataManager.register(EntityRabbitKitBase.FED, Boolean.valueOf(true));
		this.dataManager.register(EntityRabbitKitBase.WATERED, Boolean.valueOf(true));
		this.dataManager.register(EntityRabbitKitBase.TAMED, Boolean.valueOf(false));
		this.dataManager.register(EntityRabbitKitBase.SITTING, Boolean.valueOf(false));
		this.dataManager.register(EntityRabbitKitBase.RIDING, Boolean.valueOf(false));
	...
	{
		return this.dataManager.get(EntityRabbitKitBase.SITTING).booleanValue();
	}

	public void setRabbitSitting(boolean flag)
	{
		if (flag)
			this.dataManager.set(EntityRabbitKitBase.SITTING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityRabbitKitBase.SITTING, Boolean.valueOf(false));
	}

	public boolean isRabbitRiding()
	{
		return this.dataManager.get(EntityRabbitKitBase.RIDING).booleanValue();
	}

	public void setRabbitRiding(boolean flag)
	{
		if (flag)
			this.dataManager.set(EntityRabbitKitBase.RIDING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityRabbitKitBase.RIDING, Boolean.valueOf(false));
	}

	public boolean getFed()
	{
		return this.dataManager.get(EntityRabbitKitBase.FED).booleanValue();
	}
	...
	public void setFed(boolean fed)
	{
		if (fed)
		{
			this.dataManager.set(EntityRabbitKitBase.FED, Boolean.valueOf(true));
			this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
			this.setHealth(this.getHealth() + 1.0F);
		}
		else
			this.dataManager.set(EntityRabbitKitBase.FED, Boolean.valueOf(false));
	}

	public boolean getWatered()
	{
		return this.dataManager.get(EntityRabbitKitBase.WATERED).booleanValue();
	}
	...
	public void setWatered(boolean watered)
	{
		if (watered)
		{
			this.dataManager.set(EntityRabbitKitBase.WATERED, Boolean.valueOf(true));
			this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
		}
		else
			this.dataManager.set(EntityRabbitKitBase.WATERED, Boolean.valueOf(false));
	}

	public boolean getIsTamed()
	{
		return this.dataManager.get(EntityRabbitKitBase.TAMED).booleanValue();
	}

	public void setIsTamed(boolean fed)
	{
		if (fed)
			this.dataManager.set(EntityRabbitKitBase.TAMED, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityRabbitKitBase.TAMED, Boolean.valueOf(false));
	}
	...
	@Override
	public EntityRabbitKitBase createChild(EntityAgeable ageable)
	{
		return null;
	}
	...
	{
		return stack != ItemStack.EMPTY && EntityRabbitKitBase.TEMPTATION_ITEMS.contains(stack.getItem());
	}

	public class RabbitJumpHelper extends EntityJumpHelper
	{
		private final EntityRabbitKitBase theEntity;
		private boolean canJump;

		public RabbitJumpHelper(EntityRabbitKitBase entityRabbitBase)
		{
	...
	static class RabbitMoveHelper extends EntityMoveHelper
	{
		...
		public RabbitMoveHelper(EntityRabbitKitBase entityRabbitBase)
		{
			super(entityRabbitBase);
			this.theEntity = entityRabbitBase;
		}
