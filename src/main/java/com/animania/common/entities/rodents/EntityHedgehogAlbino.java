...
public class EntityHedgehogAlbino extends EntityTameable
{
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(8, new EntityAITempt(this, 1.2D, false, EntityHedgehogAlbino.TEMPTATION_ITEMS));
	...
	protected void consumeItemFromStack(EntityPlayer player, ItemStack stack) {
		...
		player.addStat(AnimaniaAchievements.AlbinoHedgehog, 1);
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(EntityHedgehogAlbino.FED, Boolean.valueOf(true));
		this.dataManager.register(EntityHedgehogAlbino.WATERED, Boolean.valueOf(true));
		this.dataManager.register(EntityHedgehogAlbino.TAMED, Boolean.valueOf(false));
		this.dataManager.register(EntityHedgehogAlbino.SITTING, Boolean.valueOf(false));
		this.dataManager.register(EntityHedgehogAlbino.RIDING, Boolean.valueOf(false));
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand) {
		...
		if (stack != ItemStack.EMPTY && stack.getItem() == Items.WATER_BUCKET) {
			...
			if (!this.isHedgehogRiding()) {
				...
				props.setPetType("HedgehogAlbino");
				this.setHedgehogRiding(true);
			}
	...
	public boolean isHedgehogSitting() {
		return this.dataManager.get(EntityHedgehogAlbino.SITTING).booleanValue();
	}

	public void setHedgehogSitting(boolean flag) {
		if (flag)
			this.dataManager.set(EntityHedgehogAlbino.SITTING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityHedgehogAlbino.SITTING, Boolean.valueOf(false));
	}

	public boolean isHedgehogRiding() {
		return this.dataManager.get(EntityHedgehogAlbino.RIDING).booleanValue();
	}

	public void setHedgehogRiding(boolean flag) {
		if (flag)
			this.dataManager.set(EntityHedgehogAlbino.RIDING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityHedgehogAlbino.RIDING, Boolean.valueOf(false));
	}

	public boolean getFed() {
		return this.dataManager.get(EntityHedgehogAlbino.FED).booleanValue();
	}

	public void setFed(boolean fed) {
		if (fed) {
			this.dataManager.set(EntityHedgehogAlbino.FED, Boolean.valueOf(true));
			this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
			this.setHealth(this.getHealth() + 1.0F);
		}
		else
			this.dataManager.set(EntityHedgehogAlbino.FED, Boolean.valueOf(false));
	}

	public boolean getWatered() {
		return this.dataManager.get(EntityHedgehogAlbino.WATERED).booleanValue();
	}

	public void setWatered(boolean watered) {
		if (watered) {
			this.dataManager.set(EntityHedgehogAlbino.WATERED, Boolean.valueOf(true));
			this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
		}
		else
			this.dataManager.set(EntityHedgehogAlbino.WATERED, Boolean.valueOf(false));
	}

	public boolean getIsTamed() {
		return this.dataManager.get(EntityHedgehogAlbino.TAMED).booleanValue();
	}

	public void setIsTamed(boolean fed) {
		if (fed)
			this.dataManager.set(EntityHedgehogAlbino.TAMED, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityHedgehogAlbino.TAMED, Boolean.valueOf(false));
	}
	...
	@Override
	public EntityHedgehogAlbino createChild(EntityAgeable ageable) {
		return null;
	}
	...
	public boolean isBreedingItem(@Nullable ItemStack stack) {
		return stack != ItemStack.EMPTY && EntityHedgehogAlbino.TEMPTATION_ITEMS.contains(stack.getItem());
	}
}