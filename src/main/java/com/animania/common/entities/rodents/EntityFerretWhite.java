...
public class EntityFerretWhite extends EntityTameable
{
	...
	protected void consumeItemFromStack(EntityPlayer player, ItemStack stack) {
		...
		player.addStat(AnimaniaAchievements.WhiteFerret, 1);
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(EntityFerretWhite.FED, Boolean.valueOf(true));
		this.dataManager.register(EntityFerretWhite.WATERED, Boolean.valueOf(true));
		this.dataManager.register(EntityFerretWhite.TAMED, Boolean.valueOf(false));
		this.dataManager.register(EntityFerretWhite.SITTING, Boolean.valueOf(false));
		this.dataManager.register(EntityFerretWhite.RIDING, Boolean.valueOf(false));
	...
	public boolean isFerretSitting() {
		return this.dataManager.get(EntityFerretWhite.SITTING).booleanValue();
	}

	public void setFerretSitting(boolean flag) {
		if (flag)
			this.dataManager.set(EntityFerretWhite.SITTING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityFerretWhite.SITTING, Boolean.valueOf(false));
	}

	public boolean isFerretRiding() {
		return this.dataManager.get(EntityFerretWhite.RIDING).booleanValue();
	}

	public void setFerretRiding(boolean flag) {
		if (flag)
			this.dataManager.set(EntityFerretWhite.RIDING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityFerretWhite.RIDING, Boolean.valueOf(false));
	}

	public boolean getFed() {
		return this.dataManager.get(EntityFerretWhite.FED).booleanValue();
	}

	public void setFed(boolean fed) {
		if (fed) {
			this.dataManager.set(EntityFerretWhite.FED, Boolean.valueOf(true));
			this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
			this.setHealth(this.getHealth() + 1.0F);
		}
		else
			this.dataManager.set(EntityFerretWhite.FED, Boolean.valueOf(false));
	}

	public boolean getWatered() {
		return this.dataManager.get(EntityFerretWhite.WATERED).booleanValue();
	}

	public void setWatered(boolean watered) {
		if (watered) {
			this.dataManager.set(EntityFerretWhite.WATERED, Boolean.valueOf(true));
			this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
		}
		else
			this.dataManager.set(EntityFerretWhite.WATERED, Boolean.valueOf(false));
	}

	public boolean getIsTamed() {
		return this.dataManager.get(EntityFerretWhite.TAMED).booleanValue();
	}

	public void setIsTamed(boolean fed) {
		if (fed)
			this.dataManager.set(EntityFerretWhite.TAMED, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityFerretWhite.TAMED, Boolean.valueOf(false));
	}
	...
	@Override
	public EntityFerretWhite createChild(EntityAgeable ageable) {
		return null;
	}
	...
	public boolean isBreedingItem(@Nullable ItemStack stack) {
		return stack != ItemStack.EMPTY && EntityFerretWhite.TEMPTATION_ITEMS.contains(stack.getItem());
	}
}