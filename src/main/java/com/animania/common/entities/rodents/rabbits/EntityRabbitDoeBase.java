...
public class EntityRabbitDoeBase extends EntityTameable implements TOPInfoProviderRodent
{

	protected static final DataParameter<Boolean> FED = EntityDataManager.<Boolean>createKey(EntityRabbitDoeBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> WATERED = EntityDataManager.<Boolean>createKey(EntityRabbitDoeBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> TAMED = EntityDataManager.<Boolean>createKey(EntityRabbitDoeBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> SITTING = EntityDataManager.<Boolean>createKey(EntityRabbitDoeBase.class, DataSerializers.BOOLEAN);
	protected static final DataParameter<Boolean> RIDING = EntityDataManager.<Boolean>createKey(EntityRabbitDoeBase.class, DataSerializers.BOOLEAN);
	...
	public EntityRabbitDoeBase(World worldIn)
	{
		...
		this.jumpHelper = new EntityRabbitDoeBase.RabbitJumpHelper(this);
		this.moveHelper = new EntityRabbitDoeBase.RabbitMoveHelper(this);
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(9, new EntityAITemptRodents(this, 1.2D, false, EntityRabbitDoeBase.TEMPTATION_ITEMS));
	...
	{
		super.entityInit();
		this.dataManager.register(EntityRabbitDoeBase.FED, Boolean.valueOf(true));
		this.dataManager.register(EntityRabbitDoeBase.WATERED, Boolean.valueOf(true));
		this.dataManager.register(EntityRabbitDoeBase.TAMED, Boolean.valueOf(false));
		this.dataManager.register(EntityRabbitDoeBase.SITTING, Boolean.valueOf(false));
		this.dataManager.register(EntityRabbitDoeBase.RIDING, Boolean.valueOf(false));
	...
	{
		return this.dataManager.get(EntityRabbitDoeBase.SITTING).booleanValue();
	}

	public void setRabbitSitting(boolean flag)
	{
		if (flag)
			this.dataManager.set(EntityRabbitDoeBase.SITTING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityRabbitDoeBase.SITTING, Boolean.valueOf(false));
	}

	public boolean isRabbitRiding()
	{
		return this.dataManager.get(EntityRabbitDoeBase.RIDING).booleanValue();
	}

	public void setRabbitRiding(boolean flag)
	{
		if (flag)
			this.dataManager.set(EntityRabbitDoeBase.RIDING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityRabbitDoeBase.RIDING, Boolean.valueOf(false));
	}

	public boolean getFed()
	{
		return this.dataManager.get(EntityRabbitDoeBase.FED).booleanValue();
	}
	...
	public void setFed(boolean fed)
	{
		if (fed)
		{
			this.dataManager.set(EntityRabbitDoeBase.FED, Boolean.valueOf(true));
			this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
			this.setHealth(this.getHealth() + 1.0F);
		}
		else
			this.dataManager.set(EntityRabbitDoeBase.FED, Boolean.valueOf(false));
	}

	public boolean getWatered()
	{
		return this.dataManager.get(EntityRabbitDoeBase.WATERED).booleanValue();
	}
	...
	public void setWatered(boolean watered)
	{
		if (watered)
		{
			this.dataManager.set(EntityRabbitDoeBase.WATERED, Boolean.valueOf(true));
			this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
		}
		else
			this.dataManager.set(EntityRabbitDoeBase.WATERED, Boolean.valueOf(false));
	}

	public boolean getIsTamed()
	{
		return this.dataManager.get(EntityRabbitDoeBase.TAMED).booleanValue();
	}

	public void setIsTamed(boolean fed)
	{
		if (fed)
			this.dataManager.set(EntityRabbitDoeBase.TAMED, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityRabbitDoeBase.TAMED, Boolean.valueOf(false));
	}
	...
	@Override
	public EntityRabbitDoeBase createChild(EntityAgeable ageable)
	{
		return null;
	}
	...
	{
		return stack != ItemStack.EMPTY && EntityRabbitDoeBase.TEMPTATION_ITEMS.contains(stack.getItem());
	}

	public class RabbitJumpHelper extends EntityJumpHelper
	{
		private final EntityRabbitDoeBase theEntity;
		private boolean canJump;

		public RabbitJumpHelper(EntityRabbitDoeBase entityRabbitBase)
		{
	...
	static class RabbitMoveHelper extends EntityMoveHelper
	{
		...
		public RabbitMoveHelper(EntityRabbitDoeBase entityRabbitBase)
		{
			super(entityRabbitBase);
			this.theEntity = entityRabbitBase;
		}
