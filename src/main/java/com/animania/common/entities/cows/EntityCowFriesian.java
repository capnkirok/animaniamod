...
public class EntityCowFriesian extends EntityCow
{
	private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID   = EntityDataManager.<Optional<UUID>> createKey(EntityCowFriesian.class,
	...
	public EntityCowFriesian(World world) {
		...
		this.tasks.addTask(6, new EntityAITempt(this, 1.25D, false, EntityCowFriesian.TEMPTATION_ITEMS));
	...
	protected void entityInit() {
		...
		super.entityInit();
		this.dataManager.register(EntityCowFriesian.MATE_UNIQUE_ID, Optional.<UUID> absent());
		this.dataManager.register(EntityCowFriesian.FED, Boolean.valueOf(true));
		this.dataManager.register(EntityCowFriesian.WATERED, Boolean.valueOf(true));
	}
	...
	public UUID getMateUniqueId() {
		return (UUID) ((Optional) this.dataManager.get(EntityCowFriesian.MATE_UNIQUE_ID)).orNull();
	}

	public void setMateUniqueId(@Nullable UUID uniqueId) {
		this.dataManager.set(EntityCowFriesian.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
	}

	public boolean getFed() {
		return this.dataManager.get(EntityCowFriesian.FED).booleanValue();
	}

	public void setFed(boolean fed) {
		if (fed) {
			this.dataManager.set(EntityCowFriesian.FED, Boolean.valueOf(true));
			this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
			this.setHealth(this.getHealth() + 1.0F);
		}
		else
			this.dataManager.set(EntityCowFriesian.FED, Boolean.valueOf(false));
	}

	public boolean getWatered() {
		return this.dataManager.get(EntityCowFriesian.WATERED).booleanValue();
	}

	public void setWatered(boolean watered) {
		if (watered) {
			this.dataManager.set(EntityCowFriesian.WATERED, Boolean.valueOf(true));
			this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
		}
		else
			this.dataManager.set(EntityCowFriesian.WATERED, Boolean.valueOf(false));
	}
