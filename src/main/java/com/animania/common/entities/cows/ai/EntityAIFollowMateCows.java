            ...
            if (this.thisAnimal instanceof EntityBullHolstein) {
                    ...
                    for (int k = 0; k <= esize - 1; k++) {
                        ...
                        if (entity != null
                                && entity.getPersistentID().toString()
                                        .equalsIgnoreCase(((EntityBullHolstein) this.thisAnimal).getMateUniqueId().toString())
                ...
                if (ec.getMateUniqueId() == null)
                    ...
                    for (int k = 0; k <= esize - 1; k++) {
                        ...
                        if (entity != null
                                && entity.getPersistentID().toString()
                                        .equalsIgnoreCase(((EntityBullAngus) this.thisAnimal).getMateUniqueId().toString())
                                && x2 <= 40 && y2 <= 8 && z2 <= 40 && x2 >= 5 && z2 >= 5) {
                            this.mateAnimal = (EntityAnimal) entity;
                            return true;
                ...
                if (ec.getMateUniqueId() == null)
                    ...
                    for (int k = 0; k <= esize - 1; k++) {
                        ...
                        if (entity != null
                                && entity.getPersistentID().toString()
                                        .equalsIgnoreCase(((EntityBullLonghorn) this.thisAnimal).getMateUniqueId().toString())
                                && x2 <= 40 && y2 <= 8 && z2 <= 40 && x2 >= 5 && z2 >= 5) {
                            this.mateAnimal = (EntityAnimal) entity;
                            return true;
                ...
                if (ec.getMateUniqueId() == null)
                    ...
                    for (int k = 0; k <= esize - 1; k++) {
                        ...
                        if (entity != null
                                && entity.getPersistentID().toString()
                                        .equalsIgnoreCase(((EntityBullFriesian) this.thisAnimal).getMateUniqueId().toString())
                                && x2 <= 40 && y2 <= 8 && z2 <= 40 && x2 >= 5 && z2 >= 5) {
                            this.mateAnimal = (EntityAnimal) entity;
                            return true;
                ...
                if (ec.getMateUniqueId() == null)
                    ...
                    for (int k = 0; k <= esize - 1; k++) {
                        ...
                        if (entity != null
                                && entity.getPersistentID().toString()
                                        .equalsIgnoreCase(((EntityBullHereford) this.thisAnimal).getMateUniqueId().toString())
                                && x2 <= 40 && y2 <= 8 && z2 <= 40 && x2 >= 5 && z2 >= 5) {
                            this.mateAnimal = (EntityAnimal) entity;
                            return true;
