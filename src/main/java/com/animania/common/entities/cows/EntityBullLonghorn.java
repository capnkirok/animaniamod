...
public class EntityBullLonghorn extends EntityCow
{
    ...
    public EntityBullLonghorn(World world) {
        ...
        this.tasks.addTask(7, new EntityAITempt(this, 1.25D, false, EntityBullLonghorn.TEMPTATION_ITEMS));
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityBullLonghorn.MATE_UNIQUE_ID, Optional.<UUID> absent());
        this.dataManager.register(EntityBullLonghorn.FIGHTING, Boolean.valueOf(false));
    ...
    public static void registerFixesCow(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntityBullLonghorn.class);
    }
    ...
    public UUID getMateUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityBullLonghorn.MATE_UNIQUE_ID)).orNull();
    }

    public void setMateUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityBullLonghorn.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }

    public boolean getFighting() {
        return this.dataManager.get(EntityBullLonghorn.FIGHTING).booleanValue();
    }

    public void setFighting(boolean fighting) {
        if (fighting)
            this.dataManager.set(EntityBullLonghorn.FIGHTING, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityBullLonghorn.FIGHTING, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityBullLonghorn.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityBullLonghorn.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityBullLonghorn.FED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityBullLonghorn.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityBullLonghorn.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityBullLonghorn.WATERED, Boolean.valueOf(false));
    }
    ...
    protected void playStepSound(BlockPos pos, Block blockIn) {
        this.playSound(SoundEvents.ENTITY_COW_STEP, 0.10F, 0.8F);
    }
    ...
    protected void dropFewItems(boolean hit, int lootlevel) {
		...
		} else
		{
            ...
            dropItem = new ItemStack(ItemHandler.rawLonghornBeef, 1);
            if (this.isBurning())
                dropItem = new ItemStack(ItemHandler.cookedLonghornRoast, 1);
        }
    ...
    @Override
    public EntityBullLonghorn createChild(EntityAgeable p_90011_1_) {
        return null;
    }
}