...
public class EntityCowHereford extends EntityCow
{
    ...
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntityCowHereford.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntityCowHereford.class,
            DataSerializers.BOOLEAN);
    ...
    public EntityCowHereford(World world) {
        ...
        this.tasks.addTask(4, new EntityAIPanicCows(this, 2.4D));
        this.tasks.addTask(5, new EntityAIMateCows(this, 1.0D));
        this.tasks.addTask(6, new EntityAITempt(this, 1.25D, false, EntityCowHereford.TEMPTATION_ITEMS));
    ...
    public static void registerFixesCow(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntityCowHereford.class);
    }
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityCowHereford.MATE_UNIQUE_ID, Optional.<UUID> absent());
        this.dataManager.register(EntityCowHereford.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityCowHereford.WATERED, Boolean.valueOf(true));
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (cowCount <= AnimaniaConfig.spawn.spawnLimitCows) {
            ...
            if (chooser == 0) {
                EntityBullHereford entityCow = new EntityBullHereford(this.world);
                ...
                EntityCalfHereford entityCow = new EntityCalfHereford(this.world);
                entityCow.setPosition(this.posX, this.posY, this.posZ);
                this.world.spawnEntity(entityCow);
    ...
    public UUID getMateUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityCowHereford.MATE_UNIQUE_ID)).orNull();
    }

    public void setMateUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityCowHereford.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityCowHereford.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityCowHereford.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityCowHereford.FED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityCowHereford.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityCowHereford.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityCowHereford.WATERED, Boolean.valueOf(false));
    }
    ...
    @Override
    public EntityCowHereford createChild(EntityAgeable p_90011_1_) {
        return null;
    }
}