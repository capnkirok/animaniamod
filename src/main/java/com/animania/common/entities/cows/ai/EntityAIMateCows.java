...
public class EntityAIMateCows extends EntityAIBase
{
    ...
    private EntityAnimal getNearbyMate() {
        ...
        if (this.theAnimal instanceof EntityCowAngus || this.theAnimal instanceof EntityCowFriesian || this.theAnimal instanceof EntityCowHereford
                || this.theAnimal instanceof EntityCowHolstein || this.theAnimal instanceof EntityCowLonghorn) {
        ...
        else if (this.theAnimal instanceof EntityBullAngus || this.theAnimal instanceof EntityBullAngus
                || this.theAnimal instanceof EntityBullFriesian || this.theAnimal instanceof EntityBullHereford
                || this.theAnimal instanceof EntityBullHolstein || this.theAnimal instanceof EntityBullLonghorn) {
            ...
            for (int k = 0; k <= esize - 1; k++) {
                ...
                if (entity != null && (entity instanceof EntityCowAngus || entity instanceof EntityCowFriesian || entity instanceof EntityCowHereford
                        || entity instanceof EntityCowHolstein || entity instanceof EntityCowLonghorn) && x2 <= 4 && y2 <= 2 && z2 <= 4) {
