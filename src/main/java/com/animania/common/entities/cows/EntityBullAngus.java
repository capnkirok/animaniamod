...
public class EntityBullAngus extends EntityCow
{
	...
	public EntityBullAngus(World world)
	{
		...
		this.tasks.addTask(7, new EntityAITempt(this, 1.25D, false, EntityBullAngus.TEMPTATION_ITEMS));
	...
	{
		super.entityInit();
		this.dataManager.register(EntityBullAngus.MATE_UNIQUE_ID, Optional.<UUID>absent());
		this.dataManager.register(EntityBullAngus.FIGHTING, Boolean.valueOf(false));
		this.dataManager.register(EntityBullAngus.FED, Boolean.valueOf(true));
		this.dataManager.register(EntityBullAngus.WATERED, Boolean.valueOf(true));
	...
	{
		return (UUID) ((Optional) this.dataManager.get(EntityBullAngus.MATE_UNIQUE_ID)).orNull();
	}

	public void setMateUniqueId(@Nullable UUID uniqueId)
	{
		this.dataManager.set(EntityBullAngus.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
	}
	...
	{
		return this.dataManager.get(EntityBullAngus.FIGHTING).booleanValue();
	}

	public void setFighting(boolean fighting)
	{
		if (fighting)
			this.dataManager.set(EntityBullAngus.FIGHTING, Boolean.valueOf(true));
		else
			this.dataManager.set(EntityBullAngus.FIGHTING, Boolean.valueOf(false));
	}

	public boolean getFed()
	{
		return this.dataManager.get(EntityBullAngus.FED).booleanValue();
	}
	...
	public void setFed(boolean fed)
	{
		if (fed)
		{
			this.dataManager.set(EntityBullAngus.FED, Boolean.valueOf(true));
			this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
			this.setHealth(this.getHealth() + 1.0F);
		} else
			this.dataManager.set(EntityBullAngus.FED, Boolean.valueOf(false));
	}

	public boolean getWatered()
	{
		return this.dataManager.get(EntityBullAngus.WATERED).booleanValue();
	}
	...
	public void setWatered(boolean watered)
	{
		if (watered)
		{
			this.dataManager.set(EntityBullAngus.WATERED, Boolean.valueOf(true));
			this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
		} else
			this.dataManager.set(EntityBullAngus.WATERED, Boolean.valueOf(false));
	}
	...
	protected void dropFewItems(boolean hit, int lootlevel)
	{
		...
		{
			dropItem = new ItemStack(ItemHandler.rawAngusBeef, 1);
			if (this.isBurning())
				dropItem = new ItemStack(ItemHandler.cookedAngusRoast, 1);
		}
