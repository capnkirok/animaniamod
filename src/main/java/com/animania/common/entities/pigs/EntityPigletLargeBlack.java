...
{
    private static final DataParameter<Optional<UUID>> PARENT_UNIQUE_ID = EntityDataManager.<Optional<UUID>> createKey(EntityPigletLargeBlack.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntityPigletLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntityPigletLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntityPigletLargeBlack.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntityPigletLargeBlack.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntityPigletLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntityPigletLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntityPigletLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          AGE              = EntityDataManager.<Float> createKey(EntityPigletLargeBlack.class,
            DataSerializers.FLOAT);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(9, new EntityAITempt(this, 1.2D, false, EntityPigletLargeBlack.TEMPTATION_ITEMS));
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityPigletLargeBlack.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletLargeBlack.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletLargeBlack.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletLargeBlack.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletLargeBlack.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletLargeBlack.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletLargeBlack.PLAYED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletLargeBlack.AGE, Float.valueOf(0));
        this.dataManager.register(EntityPigletLargeBlack.PARENT_UNIQUE_ID, Optional.<UUID> absent());
    ...
    public UUID getParentUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityPigletLargeBlack.PARENT_UNIQUE_ID)).orNull();
    }

    public void setParentUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityPigletLargeBlack.PARENT_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntityPigletLargeBlack.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntityPigletLargeBlack.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletLargeBlack.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityPigletLargeBlack.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityPigletLargeBlack.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityPigletLargeBlack.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntityPigletLargeBlack.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntityPigletLargeBlack.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletLargeBlack.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityPigletLargeBlack.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityPigletLargeBlack.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletLargeBlack.WATERED, Boolean.valueOf(false));
    }

    public float getEntityAge() {
        return this.dataManager.get(EntityPigletLargeBlack.AGE).floatValue();
    }

    public void setEntityAge(float age) {
        this.dataManager.set(EntityPigletLargeBlack.AGE, Float.valueOf(age));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntityPigletLargeBlack.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntityPigletLargeBlack.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletLargeBlack.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntityPigletLargeBlack.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntityPigletLargeBlack.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntityPigletLargeBlack.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntityPigletLargeBlack.SPLASHTIMER, Float.valueOf(timer));
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntityPigletLargeBlack.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}