...
public class EntitySowOldSpot extends EntityAnimal
{
    private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID   = EntityDataManager.<Optional<UUID>> createKey(EntitySowOldSpot.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntitySowOldSpot.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntitySowOldSpot.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntitySowOldSpot.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntitySowOldSpot.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntitySowOldSpot.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntitySowOldSpot.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntitySowOldSpot.class,
            DataSerializers.BOOLEAN);
    ...
    public EntitySowOldSpot(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(10, new EntityAITempt(this, 1.2D, false, EntitySowOldSpot.TEMPTATION_ITEMS));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        for (int k = 0; k <= esize - 1; k++) {
            ...
            if (entity.getName().contains("Duroc") || entity.getName().contains("Hampshire") || entity.getName().contains("LargeBlack")
                    || entity.getName().contains("OldSpot") || entity.getName().contains("LargeWhite") || entity.getName().contains("Yorkshire")) {
        ...
        if (pigCount <= AnimaniaConfig.spawn.spawnLimitPigs) {
            ...
            if (chooser == 0) {
                EntityHogOldSpot entityPig = new EntityHogOldSpot(this.world);
                ...
                entityPig.setMateUniqueId(this.entityUniqueID);
                this.setMateUniqueId(entityPig.getUniqueID());
                EntityPigletOldSpot entityPiglet = new EntityPigletOldSpot(this.world);
    ...
    protected void consumeItemFromStack(EntityPlayer player, ItemStack stack) {
        ...
        player.addStat(AnimaniaAchievements.OldSpot, 1);
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntitySowOldSpot.MATE_UNIQUE_ID, Optional.<UUID> absent());
        this.dataManager.register(EntitySowOldSpot.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntitySowOldSpot.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntitySowOldSpot.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowOldSpot.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowOldSpot.FED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowOldSpot.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowOldSpot.PLAYED, Boolean.valueOf(true));
    }
    ...
    public UUID getMateUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntitySowOldSpot.MATE_UNIQUE_ID)).orNull();
    }

    public void setMateUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntitySowOldSpot.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    protected void dropFewItems(boolean hit, int lootlevel) {
        ...
        if (AnimaniaConfig.drops.customMobDrops) {
            ...
            dropItem = new ItemStack(ItemHandler.rawOldSpotPork);
            if (this.isBurning())
                dropItem = new ItemStack(ItemHandler.cookedOldSpotRoast);
        }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntitySowOldSpot.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntitySowOldSpot.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowOldSpot.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntitySowOldSpot.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntitySowOldSpot.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntitySowOldSpot.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntitySowOldSpot.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntitySowOldSpot.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowOldSpot.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntitySowOldSpot.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntitySowOldSpot.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowOldSpot.WATERED, Boolean.valueOf(false));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntitySowOldSpot.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntitySowOldSpot.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowOldSpot.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntitySowOldSpot.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntitySowOldSpot.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntitySowOldSpot.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntitySowOldSpot.SPLASHTIMER, Float.valueOf(timer));
    }
        ...
        if (this.gestationTimer > -1 && this.getMateUniqueId() != null) {
            ...
            if (this.gestationTimer == 0) {
                ...
                for (int k = 0; k <= esize - 1; k++) {
                    ...
                    if (entity != null && this.getFed() && this.getWatered() && entity.getPersistentID().toString().equals(MateID) && x2 <= 20
                            && y2 <= 20 && z2 <= 20) {

                        this.setInLove(null);

                        if (!this.world.isRemote)
                            if (entity instanceof EntityHogOldSpot) {
                                EntityPigletOldSpot entityPig = new EntityPigletOldSpot(this.world);
    ...
    @Override
    public EntitySowOldSpot createChild(EntityAgeable ageable) {
        return null;
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntitySowOldSpot.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}