...
{
    private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID   = EntityDataManager.<Optional<UUID>> createKey(EntitySowYorkshire.class,
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(8, new EntityAIFindMud(this, 1.2D));
        ...
        this.tasks.addTask(11, new EntityAITempt(this, 1.2D, false, EntitySowYorkshire.TEMPTATION_ITEMS));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (pigCount <= AnimaniaConfig.spawn.spawnLimitPigs) {
            ...
            if (chooser == 0) {
                ...
                entityPig.setMateUniqueId(this.entityUniqueID);
                this.setMateUniqueId(entityPig.getUniqueID());
                EntityPigletYorkshire entityPiglet = new EntityPigletYorkshire(this.world);
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntitySowYorkshire.MATE_UNIQUE_ID, Optional.<UUID> absent());
        this.dataManager.register(EntitySowYorkshire.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntitySowYorkshire.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntitySowYorkshire.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowYorkshire.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowYorkshire.FED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowYorkshire.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowYorkshire.PLAYED, Boolean.valueOf(true));
    }
    ...
    public UUID getMateUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntitySowYorkshire.MATE_UNIQUE_ID)).orNull();
    }

    public void setMateUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntitySowYorkshire.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntitySowYorkshire.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntitySowYorkshire.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowYorkshire.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntitySowYorkshire.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntitySowYorkshire.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntitySowYorkshire.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntitySowYorkshire.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntitySowYorkshire.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowYorkshire.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntitySowYorkshire.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntitySowYorkshire.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowYorkshire.WATERED, Boolean.valueOf(false));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntitySowYorkshire.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntitySowYorkshire.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowYorkshire.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntitySowYorkshire.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntitySowYorkshire.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntitySowYorkshire.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntitySowYorkshire.SPLASHTIMER, Float.valueOf(timer));
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntitySowYorkshire.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}