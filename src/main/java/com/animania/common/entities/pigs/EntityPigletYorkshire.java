...
public class EntityPigletYorkshire extends EntityAnimal
{
    private static final DataParameter<Optional<UUID>> PARENT_UNIQUE_ID = EntityDataManager.<Optional<UUID>> createKey(EntityPigletYorkshire.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntityPigletYorkshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntityPigletYorkshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntityPigletYorkshire.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntityPigletYorkshire.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntityPigletYorkshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntityPigletYorkshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntityPigletYorkshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          AGE              = EntityDataManager.<Float> createKey(EntityPigletYorkshire.class,
            DataSerializers.FLOAT);
    ...
    public EntityPigletYorkshire(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(9, new EntityAITempt(this, 1.2D, false, EntityPigletYorkshire.TEMPTATION_ITEMS));
    ...
    protected void consumeItemFromStack(EntityPlayer player, ItemStack stack) {
        ...
        if (player.hasAchievement(AnimaniaAchievements.Duroc) && player.hasAchievement(AnimaniaAchievements.Yorkshire)
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityPigletYorkshire.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletYorkshire.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletYorkshire.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletYorkshire.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletYorkshire.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletYorkshire.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletYorkshire.PLAYED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletYorkshire.AGE, Float.valueOf(0));
        this.dataManager.register(EntityPigletYorkshire.PARENT_UNIQUE_ID, Optional.<UUID> absent());
    }
    ...
    public UUID getParentUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityPigletYorkshire.PARENT_UNIQUE_ID)).orNull();
    }

    public void setParentUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityPigletYorkshire.PARENT_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntityPigletYorkshire.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntityPigletYorkshire.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletYorkshire.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityPigletYorkshire.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityPigletYorkshire.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityPigletYorkshire.FED, Boolean.valueOf(false));
    }

    public boolean getPlayed() {
        return this.dataManager.get(EntityPigletYorkshire.PLAYED).booleanValue();
    }
    ...
    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntityPigletYorkshire.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletYorkshire.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityPigletYorkshire.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityPigletYorkshire.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletYorkshire.WATERED, Boolean.valueOf(false));
    }

    public float getEntityAge() {
        return this.dataManager.get(EntityPigletYorkshire.AGE).floatValue();
    }

    public void setEntityAge(float age) {
        this.dataManager.set(EntityPigletYorkshire.AGE, Float.valueOf(age));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntityPigletYorkshire.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntityPigletYorkshire.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletYorkshire.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntityPigletYorkshire.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntityPigletYorkshire.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntityPigletYorkshire.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntityPigletYorkshire.SPLASHTIMER, Float.valueOf(timer));
    }
            ...
            if (fed && watered) {
                ...
                if (age >= .8 && !this.world.isRemote) {
                    ...
                    if (this.rand.nextInt(2) < 1) {
                        EntitySowYorkshire entityPig = new EntitySowYorkshire(this.world);
    ...
    @Override
    public EntityPigletYorkshire createChild(EntityAgeable ageable) {
        return null;
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntityPigletYorkshire.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}