...
public class EntityAIMatePigs extends EntityAIBase
{
    ...
    private EntityAnimal getNearbyMate() {
        ...
        if (this.theAnimal instanceof EntitySowDuroc || this.theAnimal instanceof EntitySowDuroc || this.theAnimal instanceof EntitySowHampshire
                || this.theAnimal instanceof EntitySowLargeBlack || this.theAnimal instanceof EntitySowLargeWhite
                || this.theAnimal instanceof EntitySowOldSpot | this.theAnimal instanceof EntitySowYorkshire) {
            ...
            for (int k = 0; k <= esize - 1; k++) {
                ...
                if (entity != null && (entity instanceof EntityHogDuroc || entity instanceof EntityHogHampshire
                        || entity instanceof EntityHogLargeBlack || entity instanceof EntityHogLargeWhite || entity instanceof EntityHogOldSpot
                        || entity instanceof EntityHogYorkshire) && x2 <= 4 && y2 <= 2 && z2 <= 4) {
        ...
        else if (this.theAnimal instanceof EntityHogDuroc || this.theAnimal instanceof EntityHogHampshire
                || this.theAnimal instanceof EntityHogLargeBlack || this.theAnimal instanceof EntityHogLargeWhite
                || this.theAnimal instanceof EntityHogOldSpot || this.theAnimal instanceof EntityHogYorkshire) {
            ...
            for (int k = 0; k <= esize - 1; k++) {
                ...
                if (entity != null && (entity instanceof EntitySowDuroc || entity instanceof EntitySowHampshire
                        || entity instanceof EntitySowLargeBlack || entity instanceof EntitySowLargeWhite || entity instanceof EntitySowOldSpot
                        || entity instanceof EntitySowYorkshire) && x2 <= 4 && y2 <= 2 && z2 <= 4) {
