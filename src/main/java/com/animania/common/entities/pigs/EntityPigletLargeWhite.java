...
{
    private static final DataParameter<Optional<UUID>> PARENT_UNIQUE_ID = EntityDataManager.<Optional<UUID>> createKey(EntityPigletLargeWhite.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntityPigletLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntityPigletLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntityPigletLargeWhite.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntityPigletLargeWhite.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntityPigletLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntityPigletLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntityPigletLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          AGE              = EntityDataManager.<Float> createKey(EntityPigletLargeWhite.class,
            DataSerializers.FLOAT);
    ...
    public EntityPigletLargeWhite(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(9, new EntityAITempt(this, 1.2D, false, EntityPigletLargeWhite.TEMPTATION_ITEMS));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.30D); // was
                                                                                             // 32D
    }
    ...
    protected void consumeItemFromStack(EntityPlayer player, ItemStack stack) {
        ...
        player.addStat(AnimaniaAchievements.LargeWhite, 1);
        if (player.hasAchievement(AnimaniaAchievements.Duroc) && player.hasAchievement(AnimaniaAchievements.LargeWhite)
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityPigletLargeWhite.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletLargeWhite.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletLargeWhite.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletLargeWhite.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletLargeWhite.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletLargeWhite.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletLargeWhite.PLAYED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletLargeWhite.AGE, Float.valueOf(0));
        this.dataManager.register(EntityPigletLargeWhite.PARENT_UNIQUE_ID, Optional.<UUID> absent());
    ...
    public UUID getParentUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityPigletLargeWhite.PARENT_UNIQUE_ID)).orNull();
    }

    public void setParentUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityPigletLargeWhite.PARENT_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntityPigletLargeWhite.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntityPigletLargeWhite.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletLargeWhite.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityPigletLargeWhite.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityPigletLargeWhite.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityPigletLargeWhite.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntityPigletLargeWhite.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntityPigletLargeWhite.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletLargeWhite.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityPigletLargeWhite.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityPigletLargeWhite.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletLargeWhite.WATERED, Boolean.valueOf(false));
    }

    public float getEntityAge() {
        return this.dataManager.get(EntityPigletLargeWhite.AGE).floatValue();
    }

    public void setEntityAge(float age) {
        this.dataManager.set(EntityPigletLargeWhite.AGE, Float.valueOf(age));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntityPigletLargeWhite.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntityPigletLargeWhite.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletLargeWhite.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntityPigletLargeWhite.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntityPigletLargeWhite.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntityPigletLargeWhite.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntityPigletLargeWhite.SPLASHTIMER, Float.valueOf(timer));
    }
            ...
            if (fed && watered) {
                ...
                if (age >= .8 && !this.world.isRemote) {
                    ...
                    if (this.rand.nextInt(2) < 1) {
                        EntitySowLargeWhite entityPig = new EntitySowLargeWhite(this.world);
                        ...
                        EntityHogLargeWhite entityPig = new EntityHogLargeWhite(this.world);
                        entityPig.setPosition(this.posX, this.posY + .5, this.posZ);
                        String name = this.getCustomNameTag();
                        if (name != "")
                            entityPig.setCustomNameTag(name);
    ...
    @Override
    public EntityPigletLargeWhite createChild(EntityAgeable ageable) {
        return null;
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntityPigletLargeWhite.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}