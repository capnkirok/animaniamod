...
{
    private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID   = EntityDataManager.<Optional<UUID>> createKey(EntitySowLargeBlack.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntitySowLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntitySowLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntitySowLargeBlack.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntitySowLargeBlack.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntitySowLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntitySowLargeBlack.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntitySowLargeBlack.class,
            DataSerializers.BOOLEAN);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(10, new EntityAITempt(this, 1.2D, false, EntitySowLargeBlack.TEMPTATION_ITEMS));
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntitySowLargeBlack.MATE_UNIQUE_ID, Optional.<UUID> absent());
        this.dataManager.register(EntitySowLargeBlack.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntitySowLargeBlack.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntitySowLargeBlack.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowLargeBlack.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowLargeBlack.FED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowLargeBlack.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowLargeBlack.PLAYED, Boolean.valueOf(true));
    }
    ...
    public UUID getMateUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntitySowLargeBlack.MATE_UNIQUE_ID)).orNull();
    }

    public void setMateUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntitySowLargeBlack.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    protected void dropFewItems(boolean hit, int lootlevel) {
        ...
        if (AnimaniaConfig.drops.customMobDrops) {
            ...
            dropItem = new ItemStack(ItemHandler.rawLargeBlackPork);
            if (this.isBurning())
                dropItem = new ItemStack(ItemHandler.cookedLargeBlackRoast);
        }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntitySowLargeBlack.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntitySowLargeBlack.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowLargeBlack.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntitySowLargeBlack.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntitySowLargeBlack.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntitySowLargeBlack.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntitySowLargeBlack.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntitySowLargeBlack.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowLargeBlack.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntitySowLargeBlack.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntitySowLargeBlack.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowLargeBlack.WATERED, Boolean.valueOf(false));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntitySowLargeBlack.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntitySowLargeBlack.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowLargeBlack.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntitySowLargeBlack.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntitySowLargeBlack.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntitySowLargeBlack.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntitySowLargeBlack.SPLASHTIMER, Float.valueOf(timer));
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntitySowLargeBlack.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}