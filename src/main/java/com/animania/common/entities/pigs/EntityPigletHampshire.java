...
public class EntityPigletHampshire extends EntityAnimal
{
    private static final DataParameter<Optional<UUID>> PARENT_UNIQUE_ID = EntityDataManager.<Optional<UUID>> createKey(EntityPigletHampshire.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntityPigletHampshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntityPigletHampshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntityPigletHampshire.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntityPigletHampshire.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntityPigletHampshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntityPigletHampshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntityPigletHampshire.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          AGE              = EntityDataManager.<Float> createKey(EntityPigletHampshire.class,
            DataSerializers.FLOAT);
    ...
    public EntityPigletHampshire(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(9, new EntityAITempt(this, 1.2D, false, EntityPigletHampshire.TEMPTATION_ITEMS));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.305D); // was
                                                                                              // 32D
    }
    ...
    protected void consumeItemFromStack(EntityPlayer player, ItemStack stack) {
        ...
        player.addStat(AnimaniaAchievements.Hampshire, 1);
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityPigletHampshire.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletHampshire.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletHampshire.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletHampshire.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletHampshire.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletHampshire.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletHampshire.PLAYED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletHampshire.AGE, Float.valueOf(0));
        this.dataManager.register(EntityPigletHampshire.PARENT_UNIQUE_ID, Optional.<UUID> absent());
    ...
    public UUID getParentUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityPigletHampshire.PARENT_UNIQUE_ID)).orNull();
    }

    public void setParentUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityPigletHampshire.PARENT_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntityPigletHampshire.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntityPigletHampshire.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletHampshire.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityPigletHampshire.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityPigletHampshire.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityPigletHampshire.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntityPigletHampshire.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntityPigletHampshire.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletHampshire.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityPigletHampshire.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityPigletHampshire.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletHampshire.WATERED, Boolean.valueOf(false));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntityPigletHampshire.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntityPigletHampshire.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletHampshire.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntityPigletHampshire.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntityPigletHampshire.MUDTIMER, Float.valueOf(timer));
    }

    public float getEntityAge() {
        return this.dataManager.get(EntityPigletHampshire.AGE).floatValue();
    }

    public void setEntityAge(float age) {
        this.dataManager.set(EntityPigletHampshire.AGE, Float.valueOf(age));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntityPigletHampshire.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntityPigletHampshire.SPLASHTIMER, Float.valueOf(timer));
    }
            ...
            if (fed && watered) {
                ...
                if (age >= .8 && !this.world.isRemote) {
                    ...
                    if (this.rand.nextInt(2) < 1) {
                        EntitySowHampshire entityPig = new EntitySowHampshire(this.world);
                        ...
                        EntityHogHampshire entityPig = new EntityHogHampshire(this.world);
                        entityPig.setPosition(this.posX, this.posY + .5, this.posZ);
                        String name = this.getCustomNameTag();
                        if (name != "")
                            entityPig.setCustomNameTag(name);
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntityPigletHampshire.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}