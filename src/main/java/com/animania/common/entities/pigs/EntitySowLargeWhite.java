...
public class EntitySowLargeWhite extends EntityAnimal
{
    private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID   = EntityDataManager.<Optional<UUID>> createKey(EntitySowLargeWhite.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntitySowLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntitySowLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntitySowLargeWhite.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntitySowLargeWhite.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntitySowLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntitySowLargeWhite.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntitySowLargeWhite.class,
            DataSerializers.BOOLEAN);
    ...
    public EntitySowLargeWhite(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(10, new EntityAITempt(this, 1.2D, false, EntitySowLargeWhite.TEMPTATION_ITEMS));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (pigCount <= AnimaniaConfig.spawn.spawnLimitPigs) {
            ...
            if (chooser == 0) {
                ...
                entityPig.setMateUniqueId(this.entityUniqueID);
                this.setMateUniqueId(entityPig.getUniqueID());
                EntityPigletLargeWhite entityPiglet = new EntityPigletLargeWhite(this.world);
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntitySowLargeWhite.MATE_UNIQUE_ID, Optional.<UUID> absent());
        this.dataManager.register(EntitySowLargeWhite.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntitySowLargeWhite.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntitySowLargeWhite.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowLargeWhite.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowLargeWhite.FED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowLargeWhite.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowLargeWhite.PLAYED, Boolean.valueOf(true));
    ...
    public UUID getMateUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntitySowLargeWhite.MATE_UNIQUE_ID)).orNull();
    }

    public void setMateUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntitySowLargeWhite.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            ...
            this.dataManager.set(EntitySowLargeWhite.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntitySowLargeWhite.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntitySowLargeWhite.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntitySowLargeWhite.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntitySowLargeWhite.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntitySowLargeWhite.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowLargeWhite.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntitySowLargeWhite.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntitySowLargeWhite.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowLargeWhite.WATERED, Boolean.valueOf(false));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntitySowLargeWhite.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntitySowLargeWhite.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowLargeWhite.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntitySowLargeWhite.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntitySowLargeWhite.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntitySowLargeWhite.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntitySowLargeWhite.SPLASHTIMER, Float.valueOf(timer));
    }
    ...
    @Override
    public EntitySowLargeWhite createChild(EntityAgeable ageable) {
        return null;
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntitySowLargeWhite.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}