...
public class EntityPigletOldSpot extends EntityAnimal
{
    ...
    public EntityPigletOldSpot(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(9, new EntityAITempt(this, 1.2D, false, EntityPigletOldSpot.TEMPTATION_ITEMS));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.31D); // was
                                                                                             // 32D
    }
    ...
    protected void consumeItemFromStack(EntityPlayer player, ItemStack stack) {
        ...
        if (player.hasAchievement(AnimaniaAchievements.Duroc) && player.hasAchievement(AnimaniaAchievements.OldSpot)
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityPigletOldSpot.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletOldSpot.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletOldSpot.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletOldSpot.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletOldSpot.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletOldSpot.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletOldSpot.PLAYED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletOldSpot.AGE, Float.valueOf(0));
        this.dataManager.register(EntityPigletOldSpot.PARENT_UNIQUE_ID, Optional.<UUID> absent());
    ...
    public UUID getParentUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityPigletOldSpot.PARENT_UNIQUE_ID)).orNull();
    }

    public void setParentUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityPigletOldSpot.PARENT_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntityPigletOldSpot.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntityPigletOldSpot.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletOldSpot.SADDLED, Boolean.valueOf(false));
    }

    public float getEntityAge() {
        return this.dataManager.get(EntityPigletOldSpot.AGE).floatValue();
    }

    public void setEntityAge(float age) {
        this.dataManager.set(EntityPigletOldSpot.AGE, Float.valueOf(age));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntityPigletOldSpot.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntityPigletOldSpot.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletOldSpot.MUDDY, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityPigletOldSpot.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityPigletOldSpot.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityPigletOldSpot.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntityPigletOldSpot.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntityPigletOldSpot.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletOldSpot.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityPigletOldSpot.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityPigletOldSpot.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletOldSpot.WATERED, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntityPigletOldSpot.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntityPigletOldSpot.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntityPigletOldSpot.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntityPigletOldSpot.SPLASHTIMER, Float.valueOf(timer));
    }
            ...
            if (fed && watered) {
                ...
                if (age >= .8 && !this.world.isRemote) {
                    ...
                    if (this.rand.nextInt(2) < 1) {
                        EntitySowOldSpot entityPig = new EntitySowOldSpot(this.world);
    ...
    @Override
    public EntityPigletOldSpot createChild(EntityAgeable ageable) {
        return null;
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntityPigletOldSpot.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}