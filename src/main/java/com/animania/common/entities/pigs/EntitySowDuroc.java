...
public class EntitySowDuroc extends EntityAnimal
{
    private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID   = EntityDataManager.<Optional<UUID>> createKey(EntitySowDuroc.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntitySowDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntitySowDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntitySowDuroc.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntitySowDuroc.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntitySowDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntitySowDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntitySowDuroc.class,
            DataSerializers.BOOLEAN);
    ...
    public EntitySowDuroc(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(10, new EntityAITempt(this, 1.2D, false, EntitySowDuroc.TEMPTATION_ITEMS));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (pigCount <= AnimaniaConfig.spawn.spawnLimitPigs) {
            ...
            if (chooser == 0) {
                ...
                entityPig.setMateUniqueId(this.entityUniqueID);
                this.setMateUniqueId(entityPig.getUniqueID());
                EntityPigletDuroc entityPiglet = new EntityPigletDuroc(this.world);
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntitySowDuroc.MATE_UNIQUE_ID, Optional.<UUID> absent());
        this.dataManager.register(EntitySowDuroc.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntitySowDuroc.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntitySowDuroc.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowDuroc.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntitySowDuroc.FED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowDuroc.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntitySowDuroc.PLAYED, Boolean.valueOf(true));
    ...
    public UUID getMateUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntitySowDuroc.MATE_UNIQUE_ID)).orNull();
    }

    public void setMateUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntitySowDuroc.MATE_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    protected void dropFewItems(boolean hit, int lootlevel) {
        ...
        if (AnimaniaConfig.drops.customMobDrops) {
            ...
            dropItem = new ItemStack(ItemHandler.rawDurocPork);
            if (this.isBurning())
                dropItem = new ItemStack(ItemHandler.cookedDurocRoast);
        }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntitySowDuroc.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntitySowDuroc.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowDuroc.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntitySowDuroc.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntitySowDuroc.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntitySowDuroc.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntitySowDuroc.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntitySowDuroc.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowDuroc.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntitySowDuroc.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntitySowDuroc.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntitySowDuroc.WATERED, Boolean.valueOf(false));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntitySowDuroc.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntitySowDuroc.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntitySowDuroc.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntitySowDuroc.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntitySowDuroc.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntitySowDuroc.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntitySowDuroc.SPLASHTIMER, Float.valueOf(timer));
    }
    ...
    @Override
    public EntitySowDuroc createChild(EntityAgeable ageable) {
        return null;
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntitySowDuroc.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}