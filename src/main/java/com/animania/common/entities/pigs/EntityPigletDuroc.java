...
public class EntityPigletDuroc extends EntityAnimal
{
    private static final DataParameter<Optional<UUID>> PARENT_UNIQUE_ID = EntityDataManager.<Optional<UUID>> createKey(EntityPigletDuroc.class,
            DataSerializers.OPTIONAL_UNIQUE_ID);
    private static final DataParameter<Boolean>        SADDLED          = EntityDataManager.<Boolean> createKey(EntityPigletDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        MUDDY            = EntityDataManager.<Boolean> createKey(EntityPigletDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          SPLASHTIMER      = EntityDataManager.<Float> createKey(EntityPigletDuroc.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float>          MUDTIMER         = EntityDataManager.<Float> createKey(EntityPigletDuroc.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Boolean>        FED              = EntityDataManager.<Boolean> createKey(EntityPigletDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        WATERED          = EntityDataManager.<Boolean> createKey(EntityPigletDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean>        PLAYED           = EntityDataManager.<Boolean> createKey(EntityPigletDuroc.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Float>          AGE              = EntityDataManager.<Float> createKey(EntityPigletDuroc.class,
            DataSerializers.FLOAT);
    ...
    public EntityPigletDuroc(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(9, new EntityAITempt(this, 1.2D, false, EntityPigletDuroc.TEMPTATION_ITEMS));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.315D); // was
                                                                                              // 32D
    }
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(EntityPigletDuroc.SADDLED, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletDuroc.MUDDY, Boolean.valueOf(false));
        this.dataManager.register(EntityPigletDuroc.MUDTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletDuroc.SPLASHTIMER, Float.valueOf(0.0F));
        this.dataManager.register(EntityPigletDuroc.FED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletDuroc.WATERED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletDuroc.PLAYED, Boolean.valueOf(true));
        this.dataManager.register(EntityPigletDuroc.AGE, Float.valueOf(0));
        this.dataManager.register(EntityPigletDuroc.PARENT_UNIQUE_ID, Optional.<UUID> absent());
    ...
    public UUID getParentUniqueId() {
        return (UUID) ((Optional) this.dataManager.get(EntityPigletDuroc.PARENT_UNIQUE_ID)).orNull();
    }

    public void setParentUniqueId(@Nullable UUID uniqueId) {
        this.dataManager.set(EntityPigletDuroc.PARENT_UNIQUE_ID, Optional.fromNullable(uniqueId));
    }
    ...
    public boolean getSaddled() {
        return this.dataManager.get(EntityPigletDuroc.SADDLED).booleanValue();
    }
    ...
    public void setSaddled(boolean saddled) {
        if (saddled)
            this.dataManager.set(EntityPigletDuroc.SADDLED, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletDuroc.SADDLED, Boolean.valueOf(false));
    }

    public boolean getFed() {
        return this.dataManager.get(EntityPigletDuroc.FED).booleanValue();
    }

    public void setFed(boolean fed) {
        if (fed) {
            this.dataManager.set(EntityPigletDuroc.FED, Boolean.valueOf(true));
            this.fedTimer = AnimaniaConfig.careAndFeeding.feedTimer + this.rand.nextInt(100);
            this.setHealth(this.getHealth() + 1.0F);
        }
        else
            this.dataManager.set(EntityPigletDuroc.FED, Boolean.valueOf(false));
    }
    ...
    public boolean getPlayed() {
        return this.dataManager.get(EntityPigletDuroc.PLAYED).booleanValue();
    }

    public void setPlayed(boolean played) {
        if (played) {
            this.dataManager.set(EntityPigletDuroc.PLAYED, Boolean.valueOf(true));
            this.playedTimer = AnimaniaConfig.careAndFeeding.playTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletDuroc.PLAYED, Boolean.valueOf(false));
    }

    public boolean getWatered() {
        return this.dataManager.get(EntityPigletDuroc.WATERED).booleanValue();
    }

    public void setWatered(boolean watered) {
        if (watered) {
            this.dataManager.set(EntityPigletDuroc.WATERED, Boolean.valueOf(true));
            this.wateredTimer = AnimaniaConfig.careAndFeeding.waterTimer + this.rand.nextInt(100);
        }
        else
            this.dataManager.set(EntityPigletDuroc.WATERED, Boolean.valueOf(false));
    }

    public float getEntityAge() {
        return this.dataManager.get(EntityPigletDuroc.AGE).floatValue();
    }

    public void setEntityAge(float age) {
        this.dataManager.set(EntityPigletDuroc.AGE, Float.valueOf(age));
    }

    public boolean getMuddy() {
        return this.dataManager.get(EntityPigletDuroc.MUDDY).booleanValue();
    }

    public void setMuddy(boolean muddy) {
        if (muddy)
            this.dataManager.set(EntityPigletDuroc.MUDDY, Boolean.valueOf(true));
        else
            this.dataManager.set(EntityPigletDuroc.MUDDY, Boolean.valueOf(false));
    }

    public Float getMudTimer() {
        return this.dataManager.get(EntityPigletDuroc.MUDTIMER).floatValue();
    }

    public void setMudTimer(Float timer) {
        this.dataManager.set(EntityPigletDuroc.MUDTIMER, Float.valueOf(timer));
    }

    public Float getSplashTimer() {
        return this.dataManager.get(EntityPigletDuroc.SPLASHTIMER).floatValue();
    }

    public void setSplashTimer(Float timer) {
        this.dataManager.set(EntityPigletDuroc.SPLASHTIMER, Float.valueOf(timer));
    }
            ...
            if (fed && watered) {
                ...
                if (age >= .8 && !this.world.isRemote) {
                    ...
                    if (this.rand.nextInt(2) < 1) {
                        EntitySowDuroc entityPig = new EntitySowDuroc(this.world);
                        ...
                        EntityHogDuroc entityPig = new EntityHogDuroc(this.world);
                        entityPig.setPosition(this.posX, this.posY + .5, this.posZ);
                        String name = this.getCustomNameTag();
                        if (name != "")
                            entityPig.setCustomNameTag(name);
    ...
    @Override
    public EntityPigletDuroc createChild(EntityAgeable ageable) {
        return null;
    }
    ...
    public boolean isBreedingItem(@Nullable ItemStack stack) {
        return stack != ItemStack.EMPTY
                && (EntityPigletDuroc.TEMPTATION_ITEMS.contains(stack.getItem()) || ItemStack.areItemStacksEqual(stack, this.slop));
    }
}