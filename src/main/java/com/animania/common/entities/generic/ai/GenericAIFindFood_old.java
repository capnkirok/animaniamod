...
@Deprecated
public class GenericAIFindFood_old<T extends EntityCreature & IFoodEating> extends EntityAIBase
{
	...
	public GenericAIFindFood_old(T entity, double speedIn, @Nullable EntityAIBase eatAI, boolean eatBlocks)
	{
		this.entity = entity;
		this.speed = speedIn;
		this.setMutexBits(3);
