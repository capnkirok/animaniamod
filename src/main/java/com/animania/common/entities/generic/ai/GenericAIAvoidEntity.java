...
public class GenericAIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T>
{
    ...
    public GenericAIAvoidEntity(CreatureEntity entityIn, Class<T> classToAvoidIn, Predicate <? super T > avoidTargetSelectorIn, float avoidDistanceIn, double farSpeedIn, double nearSpeedIn)
    {
