...
public class GenericAIEatGrass_old extends EntityAIBase
{
	...
	public GenericAIEatGrass_old(EntityCreature grassEaterEntityIn, boolean eatsGrass)
	{
	...
	public GenericAIEatGrass_old(EntityCreature grassEaterEntityIn)
	{
