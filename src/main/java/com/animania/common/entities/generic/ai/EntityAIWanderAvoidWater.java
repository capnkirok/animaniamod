...
public class EntityAIWanderAvoidWater extends EntityAIWander
{
	...
	public boolean shouldExecute()
	{
		...
		if (this.entity instanceof EntityAnimaniaCow) {
			EntityAnimaniaCow entityAV = (EntityAnimaniaCow) this.entity;
			if (entityAV.getSleeping()) {
				isSleeping = true;
			}
		}
		
		if (this.entity instanceof EntityAnimaniaChicken) {
			EntityAnimaniaChicken entityChk = (EntityAnimaniaChicken) this.entity;
		...
		if (this.entity instanceof EntityAnimaniaHorse) {
			EntityAnimaniaHorse entityChk = (EntityAnimaniaHorse) this.entity;
			if (entityChk.getSleeping()) {
				isSleeping = true;
			}
		}
		
		if (this.entity instanceof EntityAnimaniaPeacock) {
			EntityAnimaniaPeacock entityChk = (EntityAnimaniaPeacock) this.entity;
			if (entityChk.getSleeping()) {
				isSleeping = true;
			}
		}
