...
@Deprecated
public class GenericAIFindSaltLick_old extends EntityAIBase
{
	...
	public GenericAIFindSaltLick_old(EntityCreature entityInIn, double speedIn, @Nullable EntityAIBase eatAI)
	{
