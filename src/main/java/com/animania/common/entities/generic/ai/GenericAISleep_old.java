...
public class GenericAISleep_old<T extends EntityCreature & ISleeping> extends EntityAIBase
{
	...
	public GenericAISleep_old(T entity, double speedIn, Block bed1, Block bed2, Class parentClass)
	{
		this.entity = entity;
		this.speed = speedIn;
		this.setMutexBits(3);
