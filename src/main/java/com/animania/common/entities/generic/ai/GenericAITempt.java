...
public class GenericAITempt extends EntityAIBase
{
    ...
    {
        this.temptedEntity.getLookHelper().setLookPositionWithEntity(this.temptingPlayer, (float)(this.temptedEntity.getHorizontalFaceSpeed()), (float)this.temptedEntity.getVerticalFaceSpeed());
