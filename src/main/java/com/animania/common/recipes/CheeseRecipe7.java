...
public class CheeseRecipe7 implements IRecipe
{
    ...
    private ItemStack       milk        = UniversalBucket.getFilledBucket(ForgeModContainer.getInstance().universalBucket,
            BlockHandler.fluidMilkSheep);

    public CheeseRecipe7() {
        this.recipeOutput = new ItemStack(ItemHandler.cheeseWheelSheep);
