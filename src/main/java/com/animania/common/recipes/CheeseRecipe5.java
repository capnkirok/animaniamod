...
public class CheeseRecipe5 implements IRecipe
{
    ...
    private ItemStack       milk        = UniversalBucket.getFilledBucket(ForgeModContainer.getInstance().universalBucket,
            BlockHandler.fluidMilkGoat);

    public CheeseRecipe5() {
        this.recipeOutput = new ItemStack(ItemHandler.cheeseWheelGoat);
