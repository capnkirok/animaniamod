...
public class CheeseRecipe10 implements IRecipe
{
    ...
    public CheeseRecipe10() {
        this.recipeOutput = new ItemStack(ItemHandler.cheeseWedgeJersey, 4);
        this.recipeItems.add(new ItemStack(ItemHandler.carvingKnife));
        this.recipeItems.add(new ItemStack(Item.getItemFromBlock(BlockHandler.blockCheeseJersey)));
