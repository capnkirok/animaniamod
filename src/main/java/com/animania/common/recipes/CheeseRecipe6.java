...
public class CheeseRecipe6 implements IRecipe
{
    ...
    public CheeseRecipe6() {
        this.recipeOutput = new ItemStack(ItemHandler.cheeseWedgeGoat, 4);
        this.recipeItems.add(new ItemStack(ItemHandler.carvingKnife));
        this.recipeItems.add(new ItemStack(Item.getItemFromBlock(BlockHandler.blockCheeseGoat)));
