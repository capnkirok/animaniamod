...
public class CheeseRecipe8 implements IRecipe
{
    ...
    public CheeseRecipe8() {
        this.recipeOutput = new ItemStack(ItemHandler.cheeseWedgeSheep, 4);
        this.recipeItems.add(new ItemStack(ItemHandler.carvingKnife));
        this.recipeItems.add(new ItemStack(Item.getItemFromBlock(BlockHandler.blockCheeseSheep)));
