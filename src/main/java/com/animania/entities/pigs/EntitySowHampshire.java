...
{
	private static final DataParameter<Optional<UUID>> MATE_UNIQUE_ID = EntityDataManager.<Optional<UUID>>createKey(EntitySowHampshire.class, DataSerializers.OPTIONAL_UNIQUE_ID);
	private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntitySowHampshire.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MUDDY = EntityDataManager.<Boolean>createKey(EntitySowHampshire.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Float> SPLASHTIMER = EntityDataManager.<Float>createKey(EntitySowHampshire.class, DataSerializers.FLOAT);
	private static final DataParameter<Float> MUDTIMER = EntityDataManager.<Float>createKey(EntitySowHampshire.class, DataSerializers.FLOAT);
	private static final DataParameter<Boolean> FED = EntityDataManager.<Boolean>createKey(EntitySowHampshire.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> WATERED = EntityDataManager.<Boolean>createKey(EntitySowHampshire.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> PLAYED = EntityDataManager.<Boolean>createKey(EntitySowHampshire.class, DataSerializers.BOOLEAN);
	...
	public EntitySowHampshire(World worldIn)
	{
		...
		this.gestationTimer = Animania.gestationTimer + rand.nextInt(200);
		this.happyTimer = 60;
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
	{
		...
		if (pigCount <= Animania.spawnLimitPigs) {
	...
	protected void dropFewItems(boolean hit, int lootlevel)
	{
		...
		if (Animania.customMobDrops) {
			...
			dropItem = Animania.rawHampshirePork;
			if (this.isBurning()) {
				dropItem = Animania.cookedHampshireRoast;
			}
		}
	...
	public void onLivingUpdate()
	{
		...
		//System.out.println("F: " + fed + ", W: " + watered + ", " + "P: " + played);
		...
		if (this.gestationTimer > -1 && this.getMateUniqueId() != null) {
			...
			if (gestationTimer == 0 ) {
				...
				gestationTimer = Animania.gestationTimer + rand.nextInt(2000);
