...
public class EntityHenWyandotte extends EntityAnimal
{
	...
	public EntityHenWyandotte(World world)
	{
		...
		this.laidTimer = Animania.laidTimer/2 + 1000 + rand.nextInt(100);
		this.happyTimer = 60;
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
	{
		...
		if (chickenCount <= Animania.spawnLimitChickens) {
	...
	protected void dropFewItems(boolean hit, int lootlevel)
	{
		...
		if (Animania.customMobDrops) {
			...
			dropItem = Animania.rawWyandotteChicken;
			if (this.isBurning()) {
				dropItem = Animania.cookedWyandotteChicken;
			}
		}
