...
public class EntityHenLeghorn extends EntityAnimal
{
	...
	public EntityHenLeghorn(World world)
	{
		...
		this.laidTimer = Animania.laidTimer/2 + 0 + rand.nextInt(100);
		this.happyTimer = 60;
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
	{
		...
		if (chickenCount <= Animania.spawnLimitChickens) {
			...
			if (chooser == 0) {
				...
				entityChicken.setPosition(this.posX,  this.posY, this.posZ);
				this.world.spawnEntity(entityChicken);
				EntityChickLeghorn entityChick = new EntityChickLeghorn(this.world);
	...
	private String getRandomColor()
	{
		...
		return "animania:textures/entity/chickens/hen_white.png";
	}

	private String getTextureBlink()
	{
		return "animania:textures/entity/chickens/hen_white_blink.png";
	}
