...
public class ModelPeachick extends ModelBase
{
	...
	public ModelPeachick(float par1)
	{
		...
		Head.addBox( -1.51F, -2.5F, -2F, 3, 3, 4);
		Head.setRotationPoint( 0F, 7.300148F - 13.3998F, -4.456411F  + 1F);
		
		BeakBottom = new ModelRenderer( this, 19, 0 );
		BeakBottom.setTextureSize( 64, 64 );
		BeakBottom.addBox( -0.5F, -0.5F, -1F, 1, 1, 2);
		BeakBottom.setRotationPoint( 0F, 6.662474F - 13.3998F, -7.51361F  + 1F);
		
		BeakTop = new ModelRenderer( this, 19, 0 );
		BeakTop.setTextureSize( 64, 64 );
		BeakTop.addBox( -0.5F, -0.5F, -1F, 1, 1, 2);
		BeakTop.setRotationPoint( 0F, 6.360796F - 13.3998F, -7.418793F  + 1F);
		...
		Wing1b = new ModelRenderer( this, 2, 41 );
		...
		Wing2b = new ModelRenderer( this, 2, 41 );
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
	{
		...
		Foot1b.rotateAngleX = -1.692242E-07F;
		...
		Foot2b.rotateAngleX = -1.692242E-07F;
