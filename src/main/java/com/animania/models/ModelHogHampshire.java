...
public class ModelHogHampshire extends ModelBase
{
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entitylivingbaseIn instanceof EntityHogHampshire) {
			this.Head.rotationPointY = 11.0F + ((EntityHogHampshire)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
