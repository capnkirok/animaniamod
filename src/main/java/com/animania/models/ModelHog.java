...
public class ModelHog extends ModelBase
{
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entitylivingbaseIn instanceof EntityHogYorkshire) {
			this.Head.rotationPointY = 11.0F + ((EntityHogYorkshire)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntityHogYorkshire)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		} else if (entitylivingbaseIn instanceof EntityHogOldSpot) {
			this.Head.rotationPointY = 11.0F + ((EntityHogOldSpot)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntityHogOldSpot)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		} else if (entitylivingbaseIn instanceof EntityHogDuroc) {
			this.Head.rotationPointY = 11.0F + ((EntityHogDuroc)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntityHogDuroc)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		} else if (entitylivingbaseIn instanceof EntityHogLargeWhite) {
			this.Head.rotationPointY = 11.0F + ((EntityHogLargeWhite)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntityHogLargeWhite)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		}
