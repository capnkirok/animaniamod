...
public class ModelBull extends ModelBase
{
	...
	public ModelBull()
	{
		...
		Head.setRotationPoint(0F, 5F, -13.0F); // was -14.5F
		...
		Ring.setRotationPoint(0.0F, 3F, -4.2F); // Ring.setRotationPoint( 0F, 8F, -17F );
		 */
		...
		Horn1C.setRotationPoint( 7.121497F, -5.6769695F, -3.15219F ); //Left Horn
		...
		Horn1B1.setRotationPoint( -7.406949F, -4.71F, -2.0F ); //Right Horn -2.24409F 

		Horn1C1 = new ModelRenderer( this, 52, 1 );
		Horn1C1.setTextureSize( 128, 64 );
		Horn1C1.addBox( -0.5F, -1F, -0.5F, 1, 2, 1);
		Horn1C1.setRotationPoint( -7.079102F, -5.7030411F, -3.22298F ); //Right Horn
	...
	public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
	{
		...
		/*
		Horn1A.rotateAngleX = 2.246168E-09F;
		Horn1A.rotateAngleY = 1.047198F;
		Horn1A.rotateAngleZ = -0.08726646F;
		Horn1B.rotateAngleX = -0.0803136F;
		Horn1B.rotateAngleY = -0.1207999F;
		Horn1B.rotateAngleZ = -0.2959706F;
		Horn1C.rotateAngleX = 0.7922572F;
		Horn1C.rotateAngleY = -0.4584013F;
		Horn1C.rotateAngleZ = -0.7087464F;
		Horn2.rotateAngleX = 0F;
		Horn2.rotateAngleY = 0F;
		Horn2.rotateAngleZ = 0F;
		Horn1A1.rotateAngleX = -6.177809E-10F;
		Horn1A1.rotateAngleY = 2.094395F;
		Horn1A1.rotateAngleZ = -0.08726646F;
		Horn1B1.rotateAngleX = -0.07557276F;
		Horn1B1.rotateAngleY = 0.130027F;
		Horn1B1.rotateAngleZ = 0.2617994F;
		Horn1C1.rotateAngleX = 0.8074888F;
		Horn1C1.rotateAngleY = 0.4332161F;
		Horn1C1.rotateAngleZ = 0.6443824F;
		 */
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7)
	{
		...
		} else if (par7 instanceof EntityBullHolstein) {

			EntityBullHolstein eb = (EntityBullHolstein)par7;

			if (eb.getFighting()) {
				this.Head.rotationPointY = 14.0F + ((EntityBullHolstein)par7).getHeadRotationPointY(1) * 9.0F;
				this.headRotationAngleX = ((EntityBullHolstein)par7).getHeadRotationAngleX(-3);
			} else {
				this.Head.rotateAngleX = par5 / (180F / (float)Math.PI);
				this.Head.rotateAngleY = par4 / (180F / (float)Math.PI);
				this.Head.rotateAngleX = this.headRotationAngleX;
			}
		} else if (par7 instanceof EntityBullFriesian) {

			EntityBullFriesian eb = (EntityBullFriesian)par7;
			if (eb.getFighting()) {
				this.Head.rotationPointY = 14.0F + ((EntityBullFriesian)par7).getHeadRotationPointY(1) * 9.0F;
				this.headRotationAngleX = ((EntityBullFriesian)par7).getHeadRotationAngleX(-3);
			} else {
				this.Head.rotateAngleX = par5 / (180F / (float)Math.PI);
				this.Head.rotateAngleY = par4 / (180F / (float)Math.PI);
				this.Head.rotateAngleX = this.headRotationAngleX;
