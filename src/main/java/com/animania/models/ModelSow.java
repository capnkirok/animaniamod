...
public class ModelSow extends ModelBase
{
	...
	public ModelSow( float par1 )
	{
		...
		Ear1.setRotationPoint( 3F, -2.75F, -5F );
		...
		Ear1a.setRotationPoint( 4.850319F, 6.900764F -12F, -11.55445F + 6F );
		...
		Ear2a.setRotationPoint( -4.850319F, 6.900764F - 12F, -11.55445F + 6F );
		...
		Ear2b.setRotationPoint( -4.013302F, 7.511297F - 12F, -11.97475F + 6F );
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entitylivingbaseIn instanceof EntitySowYorkshire) {
			this.Head.rotationPointY = 11.0F + ((EntitySowYorkshire)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntitySowYorkshire)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		} else if (entitylivingbaseIn instanceof EntitySowOldSpot) {
			this.Head.rotationPointY = 11.0F + ((EntitySowOldSpot)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntitySowOldSpot)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		} else if (entitylivingbaseIn instanceof EntitySowDuroc) {
			this.Head.rotationPointY = 11.0F + ((EntitySowDuroc)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntitySowDuroc)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		} else if (entitylivingbaseIn instanceof EntitySowLargeWhite) {
			this.Head.rotationPointY = 11.0F + ((EntitySowLargeWhite)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntitySowLargeWhite)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		}
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		Ear1a.rotateAngleX = -0.2617994F;
		Ear1a.rotateAngleY = 0.3490658F;
		Ear1a.rotateAngleZ = 0.6981317F;
		Ear1b.rotateAngleX = -0.2617994F;
		Ear1b.rotateAngleY = 0.3490658F;
		Ear1b.rotateAngleZ = 0.6981317F;
		Ear2.rotateAngleX = -0.2617994F;
		Ear2.rotateAngleY = -0.3490658F;
		Ear2.rotateAngleZ = -0.6981317F;
		Ear2a.rotateAngleX = -0.2617994F;
		Ear2a.rotateAngleY = -0.3490658F;
		Ear2a.rotateAngleZ = -0.6981317F;
		Ear2b.rotateAngleX = -0.2617994F;
		Ear2b.rotateAngleY = -0.3490658F;
		Ear2b.rotateAngleZ = -0.6981317F;
		...
		/*
		Tail1b.rotateAngleX = 1.429837F;
		Tail1b.rotateAngleY = -2.936972F;
		Tail1b.rotateAngleZ = -2.911069F;
		Tail1c.rotateAngleX = 1.429839F;
		Tail1c.rotateAngleY = -2.936972F;
		Tail1c.rotateAngleZ = -2.911069F;
		Tail1d.rotateAngleX = 1.429839F;
		Tail1d.rotateAngleY = -2.936972F;
		Tail1d.rotateAngleZ = -2.911069F;
		*/
