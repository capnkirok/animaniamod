...
public class RenderHogOldSpot extends RenderLiving
{
	private static final ResourceLocation PIG_TEXTURES = new ResourceLocation("animania:textures/entity/pigs/hog_old_spot.png");
	private static final ResourceLocation PIG_TEXTURES_BLINK = new ResourceLocation("animania:textures/entity/pigs/hog_old_spot_blink.png");

	public RenderHogOldSpot(RenderManager rm)
	{
		super(rm, new ModelHog(), 0.5F);
		this.addLayer(new LayerMudHogOldSpot(this));
	}

	protected void preRenderScale(EntityHogOldSpot entity, float f)
	{
	...
	{
		preRenderScale((EntityHogOldSpot)entityliving, f);
	}

	protected ResourceLocation getEntityTexture(Entity par1Entity)
	{
		EntityHogOldSpot entity = (EntityHogOldSpot)par1Entity;
