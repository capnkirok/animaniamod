...
public class RenderPigletDuroc extends RenderLiving
{
	private static final ResourceLocation PIG_TEXTURES = new ResourceLocation("animania:textures/entity/pigs/piglet_duroc.png");
	private static final ResourceLocation PIG_TEXTURES_BLINK = new ResourceLocation("animania:textures/entity/pigs/piglet_duroc_blink.png");
	...
	protected void preRenderScale(EntityPigletDuroc entity, float f)
	{
		...
		if (blockchk == Animania.blockMud  && !entity.getMuddy()) {
			GlStateManager.translate(0.0F, entity.height - 0.50F + (age * .1F), 0.0F);
	...
	{
		preRenderScale((EntityPigletDuroc)entityliving, f);
	}

	protected ResourceLocation getEntityTexture(Entity par1Entity)
	{
		EntityPigletDuroc entity = (EntityPigletDuroc)par1Entity; 
