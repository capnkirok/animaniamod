...
public class RenderPigletLargeWhite extends RenderLiving
{
	...
	private static final ResourceLocation PIG_TEXTURES_BLINK = new ResourceLocation("animania:textures/entity/pigs/piglet_large_white_blink.png");
	...
	protected void preRenderScale(EntityPigletLargeWhite entity, float f)
	{
	...
	{
		preRenderScale((EntityPigletLargeWhite)entityliving, f);
	}

	protected ResourceLocation getEntityTexture(Entity par1Entity)
	{
		EntityPigletLargeWhite entity = (EntityPigletLargeWhite)par1Entity; 
