...
public class LayerMudPigletDuroc implements LayerRenderer<EntityPigletDuroc>
{
	...
	public void doRenderLayer(EntityPigletDuroc entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
