...
public class LayerMudSowOldSpot implements LayerRenderer<EntitySowOldSpot>
{
	...
	public void doRenderLayer(EntitySowOldSpot entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
