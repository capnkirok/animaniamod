...
public class RenderSowDuroc extends RenderLiving
{
	private static final ResourceLocation PIG_TEXTURES = new ResourceLocation("animania:textures/entity/pigs/sow_duroc.png");
	private static final ResourceLocation PIG_TEXTURES_BLINK = new ResourceLocation("animania:textures/entity/pigs/sow_duroc_blink.png");
	...
	protected void preRenderScale(EntitySowDuroc entity, float f)
	{
	...
	{
		preRenderScale((EntitySowDuroc)entityliving, f);
	}

	protected ResourceLocation getEntityTexture(Entity par1Entity)
	{
		EntitySowDuroc entity = (EntitySowDuroc)par1Entity; 
