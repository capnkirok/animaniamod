...
public class ModelHog extends ModelBase
{
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (LivingEntityIn instanceof EntityHogYorkshire entityHogYorkshire)
		{
		...
		else if (LivingEntityIn instanceof EntityHogOldSpot entityHogOldSpot)
		{
		...
		else if (LivingEntityIn instanceof EntityHogDuroc entityHogDuroc)
		{
		...
		else if (LivingEntityIn instanceof EntityHogLargeWhite entityHogLargeWhite)
		{
