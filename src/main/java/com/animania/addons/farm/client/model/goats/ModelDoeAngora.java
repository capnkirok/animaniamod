...
public class ModelDoeAngora extends ModelBase
{
	...
	public ModelDoeAngora()
	{
		this(0.0f);
	}

	public ModelDoeAngora(float par1)
	{
		...
		this.Udder = new ModelRenderer(this, 10, 10);
		this.Udder.setTextureSize(128, 256);
		this.Udder.addBox(-3F, -2F, -3F, 6, 4, 6);
		this.Udder.setRotationPoint(0F, 15.37166F, 17.41618F);
		this.Udder1 = new ModelRenderer(this, 15, 15);
		this.Udder1.setTextureSize(128, 256);
		this.Udder1.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder1.setRotationPoint(2F, 17.87166F, 15.41618F);
		this.Udder2 = new ModelRenderer(this, 15, 15);
		this.Udder2.setTextureSize(128, 256);
		this.Udder2.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder2.setRotationPoint(-2F, 17.87166F, 15.41618F);
		this.Udder3 = new ModelRenderer(this, 15, 15);
		this.Udder3.setTextureSize(128, 256);
		this.Udder3.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder3.setRotationPoint(-2F, 17.87166F, 19.41618F);
		this.Udder4 = new ModelRenderer(this, 15, 15);
		this.Udder4.setTextureSize(128, 256);
		this.Udder4.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder4.setRotationPoint(2F, 17.87166F, 19.41618F);
		...
		this.Horn1_R.setTextureSize(128, 256);
		this.Horn1_R.addBox(-1F, -7.5F, -1F, 2, 7, 2);
		this.Horn1_R.setRotationPoint(-1.691772F, -5.616201F - 7.738533F, -8.545192F + 0.9885842F);
		this.Horn2_R = new ModelRenderer(this, 38, 71);
		this.Horn2_R.setTextureSize(128, 256);
		this.Horn2_R.addBox(-1F, -7.4F, 1.7F, 2, 7, 2);
		this.Horn2_R.setRotationPoint(-6.685526F, -9.676292F - 7.738533F, -7.587014F + 0.9885842F);
		...
		this.Horn1_L.setTextureSize(128, 256);
		this.Horn1_L.addBox(-1F, -7.5F, -1F, 2, 7, 2);
		this.Horn1_L.setRotationPoint(1.691772F, -5.616201F - 7.738533F, -8.545192F + 0.9885842F);
		this.Horn2_L = new ModelRenderer(this, 38, 71);
		this.Horn2_L.setTextureSize(128, 256);
		this.Horn2_L.addBox(-1F, -7.4F, 1.7F, 2, 7, 2);
		this.Horn2_L.setRotationPoint(6.685524F, -9.676292F - 7.738533F, -7.587016F + 0.9885842F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.Horn1_R.rotateAngleX = -0.7281986F;
		this.Horn1_R.rotateAngleY = -0.4957607F;
		this.Horn1_R.rotateAngleZ = -0.6505846F;

		this.Horn2_R.rotateAngleX = -.308694F;
		this.Horn2_R.rotateAngleY = -.19F;
		this.Horn2_R.rotateAngleZ = -1.523367F;

		this.Horn1_L.rotateAngleX = -0.7281986F;
		this.Horn1_L.rotateAngleY = 0.4957606F;
		this.Horn1_L.rotateAngleZ = 0.6505845F;

		this.Horn2_L.rotateAngleX = -.308693F;
		this.Horn2_L.rotateAngleY = .19F;
		this.Horn2_L.rotateAngleZ = 1.523367F;
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		this.HeadNode.rotationPointY = +7.75F + ((EntityDoeAngora) LivingEntityIn).getHeadAnchorPointY(partialTickTime) * 6.0F;
		this.headRotationAngleX = ((EntityDoeAngora) LivingEntityIn).getHeadAngleX(partialTickTime);
