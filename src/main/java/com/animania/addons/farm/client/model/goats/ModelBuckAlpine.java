...
public class ModelBuckAlpine extends ModelBase
{
	...
	public ModelBuckAlpine(float par1)
	{
		...
		this.Horn3_R.setTextureSize(128, 128);
		this.Horn3_R.addBox(-1F, -6F, -1F, 2, 6, 2);
		this.Horn3_R.setRotationPoint(-6.09127F, -10.93122F - 7.738533F, 1.051931F + 0.9885842F);
		...
		this.Horn3_L.setTextureSize(128, 128);
		this.Horn3_L.addBox(-1F, -6F, -1F, 2, 6, 2);
		this.Horn3_L.setRotationPoint(6.09127F, -10.93122F - 7.738533F, 1.051931F + 0.9885842F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.Horn3_L.rotateAngleX = -0.8089435F;
		this.Horn3_L.rotateAngleZ = -3.165597F;
	...
	public void setLivingAnimations(LivingEntity entity, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if ((entity instanceof EntityBuckAlpine eb) && !eb.getFighting())
		{
