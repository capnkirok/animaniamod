...
import com.animania.addons.farm.client.render.pigs.layers.LayerMudSowLargeBlack;
...
public class RenderSowLargeBlack<T extends EntitySowLargeBlack> extends RenderLiving<T>
{
	...
	{
		return RenderSowLargeBlack.PIG_TEXTURES;
	}

	static class Factory<T extends EntitySowLargeBlack> implements IRenderFactory<T>
	{
		@Override
		public Render<? super T> createRenderFor(RenderManager manager)
		{
			return new RenderSowLargeBlack(manager);
		}
	}
}