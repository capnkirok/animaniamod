...
public class ModelPiglet extends ModelBase
{
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (LivingEntityIn instanceof PigEntityletYorkshire PigEntityletYorkshire)
		{
		...
		else if (LivingEntityIn instanceof PigEntityletOldSpot PigEntityletOldSpot)
		{
		...
		else if (LivingEntityIn instanceof PigEntityletDuroc PigEntityletDuroc)
		{
		...
		else if (LivingEntityIn instanceof PigEntityletLargeWhite PigEntityletLargeWhite)
		{
