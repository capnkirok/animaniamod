...
public class ModelCalf extends ModelBase
{
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (LivingEntityIn instanceof EntityCalfHolstein entityCalfHolstein)
		{
		...
		else if (LivingEntityIn instanceof EntityCalfFriesian entityCalfFriesian)
		{
		...
		else if (LivingEntityIn instanceof EntityCalfHereford entityCalfHereford)
		{
		...
		else if (LivingEntityIn instanceof EntityCalfHighland entityCalfHighland)
		{
		...
		else if (LivingEntityIn instanceof EntityCalfMooshroom entityCalfMooshrom)
		{
		...
		else if (LivingEntityIn instanceof EntityCalfJersey entityCalfJersey)
		{
		...
		else if (LivingEntityIn instanceof EntityCalfAngus entityCalfAngus)
		{
