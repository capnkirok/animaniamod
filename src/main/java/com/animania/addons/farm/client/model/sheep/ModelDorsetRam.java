...
public class ModelDorsetRam extends ModelBase implements IColoredModel
{
	...
	public ModelDorsetRam(float par1)
	{
		...
		this.WoolBody1.addBox(-5F, -6.5F, -6F, 10, 15, 12);
		...
		this.LeftHorn2.setRotationPoint(3.841148F - .5F, -4.314388F - 5.110041F, -20.11477F + 11.14083F + .8F);

		this.LeftHorn3 = new ModelRenderer(this, 80, 15);
		this.LeftHorn3.setTextureSize(128, 128);
		this.LeftHorn3.addBox(1F, -1F, -1F, 6, 2, 2);
		this.LeftHorn3.setRotationPoint(6.125732F - .6F, -2.09454F - 5.110041F - 3.3F, -16.77217F + 11.14083F + 1.5F);

		this.RightHorn2 = new ModelRenderer(this, 80, 15);
		this.RightHorn2.setTextureSize(128, 128);
		this.RightHorn2.addBox(-6F, -1F, -1F, 6, 2, 2);
		this.RightHorn2.setRotationPoint(-3.841148F + .5F, -4.31439F - 5.110041F, -20.11477F + 11.14083F + .8F);

		this.RightHorn3 = new ModelRenderer(this, 80, 15);
		this.RightHorn3.setTextureSize(128, 128);
		this.RightHorn3.addBox(-7F, -1F, -1F, 6, 2, 2);
		this.RightHorn3.setRotationPoint(-6.125732F + .6F, -2.094542F - 5.110041F - 3.3F, -16.77217F + 11.14083F + 1.5F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.RightHorn1.rotateAngleX = 0.08560022F;
		this.RightHorn1.rotateAngleY = 0.5243015F;
		...
		this.LeftHorn3.rotateAngleY = 0.15F;
		this.LeftHorn3.rotateAngleZ = 1.064569F;

		this.RightHorn2.rotateAngleX = 0.05121716F;
		this.RightHorn2.rotateAngleY = 0.9075359F;
		this.RightHorn2.rotateAngleZ = -0.06658728F;
		this.RightHorn3.rotateAngleX = -0.2553108F;
		this.RightHorn3.rotateAngleY = -0.15F;
	...
	public void setLivingAnimations(LivingEntity entity, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entity instanceof EntityRamDorset entityRamDorser)
		{
		...
		else if (entity instanceof EntityEweDorset entityEweDorset)
		{
		...
		else if (entity instanceof EntityLambDorset entityLampDorset)
		{
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if ((entity instanceof EntityRamDorset eb) && (eb.getFighting() && eb.getRivalUniqueId() != null))
		{
