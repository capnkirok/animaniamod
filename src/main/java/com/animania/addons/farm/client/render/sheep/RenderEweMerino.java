...
public class RenderEweMerino<T extends EntityEweMerino> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES = { new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "white_ewe.png"), new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "brown_ewe.png") };
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED = { new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "white_ewe_sheared.png"), new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "brown_ewe_sheared.png") };
