...
public class ModelBuckAngora extends ModelBase
{
	...
	public ModelBuckAngora(float par1)
	{
		...
		this.Horn3_R.setTextureSize(128, 256);
		this.Horn3_R.addBox(-1F, -6F, -1F, 2, 6, 2);
		this.Horn3_R.setRotationPoint(-12.27423F, -9.172562F - 7.738533F, -3.402195F + 0.9885842F);
		...
		this.Horn3_L.setTextureSize(128, 256);
		this.Horn3_L.addBox(-1F, -6F, -1F, 2, 6, 2);
		this.Horn3_L.setRotationPoint(12.27422F, -9.172562F - 7.738533F, -3.402196F + 0.9885842F);
		...
		this.HeadNode.addChild(this.Horn3_R);
		this.HeadNode.addChild(this.Horn1_L);
		this.HeadNode.addChild(this.Horn2_L);
		this.HeadNode.addChild(this.Horn3_L);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.Horn3_R.rotateAngleX = -1.085297F;
		this.Horn3_R.rotateAngleY = -0.5934884F;
		this.Horn3_R.rotateAngleZ = -0.3137805F;
		...
		this.Horn3_L.rotateAngleX = -1.085297F;
		this.Horn3_L.rotateAngleY = 0.5934881F;
		this.Horn3_L.rotateAngleZ = 0.3137808F;
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		this.HeadNode.rotationPointY = +7.75F + ((EntityBuckAngora) LivingEntityIn).getHeadAnchorPointY(partialTickTime) * 6.0F;
		this.headRotationAngleX = ((EntityBuckAngora) LivingEntityIn).getHeadAngleX(partialTickTime);
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if ((entity instanceof EntityBuckAngora eb) && (eb.getFighting() && eb.getRivalUniqueId() != null))
		{
