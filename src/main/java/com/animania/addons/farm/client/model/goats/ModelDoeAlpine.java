...
public class ModelDoeAlpine extends ModelBase
{
	...
	public ModelDoeAlpine()
	{
		this(0.0f);
	}

	public ModelDoeAlpine(float par1)
	{
		...
		this.Udder = new ModelRenderer(this, 5, 14);
		this.Udder.setTextureSize(128, 128);
		this.Udder.addBox(-3F, -2F, -3F, 6, 4, 6);
		this.Udder.setRotationPoint(0F, 14.37547F, 17.50334F);
		this.Udder1 = new ModelRenderer(this, 10, 19);
		this.Udder1.setTextureSize(128, 128);
		this.Udder1.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder1.setRotationPoint(2F, 16.87547F, 15.50334F);
		this.Udder2 = new ModelRenderer(this, 10, 19);
		this.Udder2.setTextureSize(128, 128);
		this.Udder2.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder2.setRotationPoint(-2F, 16.87547F, 15.50334F);
		this.Udder3 = new ModelRenderer(this, 10, 19);
		this.Udder3.setTextureSize(128, 128);
		this.Udder3.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder3.setRotationPoint(-2F, 16.87547F, 19.50334F);
		this.Udder4 = new ModelRenderer(this, 10, 19);
		this.Udder4.setTextureSize(128, 128);
		this.Udder4.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.Udder4.setRotationPoint(2F, 16.87547F, 19.50334F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.Snout3.rotateAngleY = 0F;
		this.Snout3.rotateAngleZ = 0F;
		this.Nose.rotateAngleX = 0.4037857F;
		this.Nose.rotateAngleY = 0F;
		this.Nose.rotateAngleZ = 0F;
		this.Snout1.rotateAngleX = 1.101219F;
		this.Snout1.rotateAngleY = 0F;
		this.Snout1.rotateAngleZ = 0F;
		this.Snout2.rotateAngleX = 0.4037857F;
		this.Snout2.rotateAngleY = 0F;
		this.Snout2.rotateAngleZ = 0F;
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		this.HeadNode.rotationPointY = +7.75F + ((EntityDoeAlpine) LivingEntityIn).getHeadAnchorPointY(partialTickTime) * 6.0F;
		this.headRotationAngleX = ((EntityDoeAlpine) LivingEntityIn).getHeadAngleX(partialTickTime);
