...
public class ModelMerinoRam extends ModelBase implements IColoredModel
{
	...
	public ModelMerinoRam(float par1)
	{
		...
		this.RightFrontLegWool.addBox(-2F, -2F, -2.5F, 4, 12, 5);
		...
		this.RightBackLegWool.addBox(-2F, -1F, -2.5F, 4, 14, 5);
		...
		this.WoolBody1.addBox(-5F, -6.5F, -6F, 10, 17, 12);
		this.WoolBody1.setRotationPoint(0F, 7.704449F, 0.009471932F + 7F);
		this.WoolBody2 = new ModelRendererColored(this, 1, 103);
		this.WoolBody2.setTextureSize(128, 128);
		this.WoolBody2.addBox(-5.5F, -6.5F, -5F, 11, 17, 8);
		...
		this.WoolHips.addBox(-6F, -6F, -6F, 12, 16, 8);
		...
		this.LeftBackLegWool.addBox(-2F, -1F, -2.5F, 4, 14, 5);
		...
		this.LeftFrontLegWool.addBox(-2F, -2F, -2.5F, 4, 12, 5);
		...
		this.LeftHorn1.setRotationPoint(1F, -1.045092F - 5.110041F, -21.4337F + 11.14083F);
		...
		this.HeadWool.addBox(-3.5F, -3F, -6F, 7, 2, 6);
		this.HeadWool.setRotationPoint(0F, -0.7184505F - 5.110041F, -17.17421F + 11.14083F);
		this.RightHorn1 = new ModelRenderer(this, 80, 15);
		this.RightHorn1.setTextureSize(128, 128);
		this.RightHorn1.addBox(-5F, -1F, -1F, 5, 2, 2);
		this.RightHorn1.setRotationPoint(-1F, -1.045094F - 5.110041F, -21.4337F + 11.14083F);

		this.RightHorn2 = new ModelRenderer(this, 80, 15);
		this.RightHorn2.setTextureSize(128, 128);
		this.RightHorn2.addBox(-6F, -1F, -1F, 6, 2, 2);
		this.RightHorn2.setRotationPoint(-3.841148F, -4.31439F - 5.110041F + .4F, -20.11477F + 11.14083F + .8F);

		this.RightHorn3 = new ModelRenderer(this, 80, 15);
		this.RightHorn3.setTextureSize(128, 128);
		this.RightHorn3.addBox(-7F, -1F, -1F, 6, 2, 2);
		this.RightHorn3.setRotationPoint(-6.125732F - 1F, -2.094542F - 5.110041F - .8F, -16.77217F + 11.14083F + 2F);

		this.RightHorn4 = new ModelRenderer(this, 80, 15);
		this.RightHorn4.setTextureSize(128, 128);
		this.RightHorn4.addBox(-5F, -1F, 0F, 4, 2, 2);
		this.RightHorn4.setRotationPoint(-4.833957F, 2.566025F - 5.110041F, -18.38786F + 11.14083F + 2F);

		this.LeftHorn2 = new ModelRenderer(this, 80, 15);
		this.LeftHorn2.setTextureSize(128, 128);
		this.LeftHorn2.addBox(0F, -1F, -1F, 6, 2, 2);
		this.LeftHorn2.setRotationPoint(3.841148F, -4.314388F - 5.110041F + .4F, -20.11477F + 11.14083F + .8F);

		this.LeftHorn3 = new ModelRenderer(this, 80, 15);
		this.LeftHorn3.setTextureSize(128, 128);
		this.LeftHorn3.addBox(1F, -1F, -1F, 6, 2, 2);
		this.LeftHorn3.setRotationPoint(6.125732F + 1F, -2.09454F - 5.110041F - .8F, -16.77217F + 11.14083F + 2F);

		this.LeftHorn4 = new ModelRenderer(this, 80, 15);
		this.LeftHorn4.setTextureSize(128, 128);
		this.LeftHorn4.addBox(1F, -1F, 0F, 4, 2, 2);
		this.LeftHorn4.setRotationPoint(4.833957F, 2.566027F - 5.110041F, -18.38786F + 11.14083F + 2F);

		this.NeckWool = new ModelRendererColored(this, 59, 69);
		this.NeckWool.setTextureSize(128, 128);
		this.NeckWool.addBox(-3.5F, -3F, -5F, 7, 11, 10);
		...
		this.NeckWool2.addBox(-4F, -3F, -2F, 8, 12, 4);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.LeftHorn1.rotateAngleX = 0.0856002F;
		this.LeftHorn1.rotateAngleY = -0.5243015F;
		this.LeftHorn1.rotateAngleZ = -0.699971F;
		this.LeftHorn2.rotateAngleX = 0.1127634F;
		this.LeftHorn2.rotateAngleY = -0.9091168F;
		this.LeftHorn2.rotateAngleZ = 0.5917696F;
		this.LeftHorn3.rotateAngleX = -0.1363656F;
		this.LeftHorn3.rotateAngleY = .2F;
		this.LeftHorn3.rotateAngleZ = 1.690024F;
		this.LeftHorn4.rotateAngleX = -1F;
		// LeftHorn4.rotateAngleY = -1.828805F;
		this.LeftHorn4.rotateAngleZ = .5F;
		...
		this.RightHorn1.rotateAngleX = 0.0856002F;
		this.RightHorn1.rotateAngleY = 0.5243016F;
		this.RightHorn1.rotateAngleZ = 0.699971F;
		this.RightHorn2.rotateAngleX = 0.1127634F;
		this.RightHorn2.rotateAngleY = 0.9091169F;
		this.RightHorn2.rotateAngleZ = -0.5917696F;
		this.RightHorn3.rotateAngleX = -0.1363656F;
		this.RightHorn3.rotateAngleY = -.2F;
		this.RightHorn3.rotateAngleZ = -1.690024F;
		this.RightHorn4.rotateAngleX = -1F;
		// RightHorn4.rotateAngleY = 1.828805F;
		this.RightHorn4.rotateAngleZ = -.5F;
	...
	public void setLivingAnimations(LivingEntity entity, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entity instanceof EntityRamMerino entityRamMerino)
		{
		...
		else if (entity instanceof EntityEweMerino entityEweMerino)
		{
		...
		else if (entity instanceof EntityLambMerino entityLambMerino)
		{
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if ((entity instanceof EntityRamMerino eb) && (eb.getFighting() && eb.getRivalUniqueId() != null))
		{
