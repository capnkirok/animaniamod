...
public class ModelFriesianSheep extends ModelBase implements IColoredModel
{
	...
	public void setLivingAnimations(LivingEntity entity, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entity instanceof EntityRamFriesian entityRamFriesian)
		{
		...
		else if (entity instanceof EntityEweFriesian entityEweFriesian)
		{
		...
		else if (entity instanceof EntityLambFriesian entityLambFriesian)
		{
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if ((entity instanceof EntityRamFriesian eb) && (eb.getFighting() && eb.getRivalUniqueId() != null))
		{
