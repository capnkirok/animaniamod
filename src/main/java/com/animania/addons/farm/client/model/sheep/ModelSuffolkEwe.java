...
public class ModelSuffolkEwe extends ModelBase implements IColoredModel
{
	...
	public ModelSuffolkEwe(float par1)
	{
		...
		this.LeftHorn2.setRotationPoint(3.841148F, -4.314388F - 5.110041F, -20.11477F + 11.14083F);
		this.LeftHorn3 = new ModelRenderer(this, 80, 15);
		this.LeftHorn3.setTextureSize(128, 128);
		this.LeftHorn3.addBox(1F, -1F, -1F, 6, 2, 2);
		this.LeftHorn3.setRotationPoint(6.125732F, -2.09454F - 5.110041F, -16.77217F + 11.14083F);
		this.LeftHorn4 = new ModelRenderer(this, 80, 15);
		this.LeftHorn4.setTextureSize(128, 128);
		this.LeftHorn4.addBox(1F, -1F, 0F, 4, 2, 2);
		this.LeftHorn4.setRotationPoint(4.833957F, 2.566027F - 5.110041F, -18.38786F + 11.14083F);
		...
		this.RightHorn2.setRotationPoint(-3.841148F, -4.31439F - 5.110041F, -20.11477F + 11.14083F);
		this.RightHorn3 = new ModelRenderer(this, 80, 15);
		this.RightHorn3.setTextureSize(128, 128);
		this.RightHorn3.addBox(-7F, -1F, -1F, 6, 2, 2);
		this.RightHorn3.setRotationPoint(-6.125732F, -2.094542F - 5.110041F, -16.77217F + 11.14083F);
		this.RightHorn4 = new ModelRenderer(this, 80, 15);
		this.RightHorn4.setTextureSize(128, 128);
		this.RightHorn4.addBox(-5F, -1F, 0F, 4, 2, 2);
		this.RightHorn4.setRotationPoint(-4.833957F, 2.566025F - 5.110041F, -18.38786F + 11.14083F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.UpperJawDetail1.rotateAngleX = 0.824727F;
		this.UpperJawDetail2.rotateAngleX = 0.6350154F;
		...
		this.LeftHorn3.rotateAngleY = -0.8194962F;
		this.LeftHorn3.rotateAngleZ = 1.064569F;
		this.LeftHorn4.rotateAngleX = -0.2553108F;
		this.LeftHorn4.rotateAngleY = -0.8194963F;
	...
	public void setLivingAnimations(LivingEntity entity, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entity instanceof EntityEweSuffolk entityEweSuffolk)
		{
