...
public class ModelKidKinder extends ModelBase
{
	...
	public ModelKidKinder()
	{
		this(0.0f);
	}

	public ModelKidKinder(float par1)
	{
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		this.HeadNode.rotationPointY = +7.75F + ((EntityKidKinder) LivingEntityIn).getHeadAnchorPointY(partialTickTime) * 6.0F;
		this.headRotationAngleX = ((EntityKidKinder) LivingEntityIn).getHeadAngleX(partialTickTime);
