...
public class ModelSow extends ModelBase
{
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (LivingEntityIn instanceof EntitySowYorkshire entitySowYorkshire)
		{
		...
		else if (LivingEntityIn instanceof EntitySowOldSpot entitySowOldSpot)
		{
		...
		else if (LivingEntityIn instanceof EntitySowDuroc entitySowDuroc)
		{
		...
		else if (LivingEntityIn instanceof EntitySowLargeWhite entitySowLargeWhite)
		{
