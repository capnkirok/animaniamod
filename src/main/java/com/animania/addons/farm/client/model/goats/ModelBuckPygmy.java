...
public class ModelBuckPygmy extends ModelBase
{
	...
	public ModelBuckPygmy(float par1)
	{
		...
		this.Reproductive1.setRotationPoint(0F, 14.03065F, 13.60571F);
		...
		this.Reproductive2.setRotationPoint(0F, 13.87588F, 15.5722F);
		...
		this.Beard.setRotationPoint(0F, 5.209013F - 10.73092F, -14.48907F + 1.162896F);
		...
		this.Horn1_L.setRotationPoint(1.064111F, -1.984159F - 10.73092F, -8.833616F + 1.162896F);

		this.Horn2_L = new ModelRenderer(this, 38, 71);
		this.Horn2_L.setTextureSize(128, 128);
		this.Horn2_L.addBox(-0.75F, -5F, -1F, 1, 4, 2);
		this.Horn2_L.setRotationPoint(2.798228F, -5.939657F - 10.73092F, -5.761665F + 1.162896F);
		...
		this.Horn1_R.setRotationPoint(-1.06411F, -1.984159F - 10.73092F, -8.833616F + 1.162896F);

		this.Horn2_R = new ModelRenderer(this, 38, 71);
		this.Horn2_R.setTextureSize(128, 128);
		this.Horn2_R.addBox(-0.25F, -5F, -1F, 1, 4, 2);
		this.Horn2_R.setRotationPoint(-2.798228F, -5.939657F - 10.73092F, -5.761665F + 1.162896F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.Beard.rotateAngleY = 0F;
		this.Beard.rotateAngleZ = 0F;
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if ((entity instanceof EntityBuckPygmy eb) && (eb.getFighting() && eb.getRivalUniqueId() != null))
		{
			// this.HeadNode.rotationPointY = 13.75F + ((EntityBuckPygmy)
