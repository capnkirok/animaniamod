...
{	
	...
	public ModelBuckPygmy(float par1)
	{
		...
		Beard.setRotationPoint( 0F, 5.209013F - 10.73092F, -14.48907F + 1.162896F );
		...
		Horn1_L.setRotationPoint( 1.064111F, -1.984159F - 10.73092F, -8.833616F + 1.162896F );
		
		Horn2_L = new ModelRenderer( this, 38, 71 );
		Horn2_L.setTextureSize( 128, 128 );
		Horn2_L.addBox( -0.75F, -5F, -1F, 1, 4, 2);
		Horn2_L.setRotationPoint( 2.798228F, -5.939657F - 10.73092F, -5.761665F + 1.162896F );
		...
		Horn1_R.setRotationPoint( -1.06411F, -1.984159F - 10.73092F, -8.833616F + 1.162896F );
		
		Horn2_R = new ModelRenderer( this, 38, 71 );
		Horn2_R.setTextureSize( 128, 128 );
		Horn2_R.addBox( -0.25F, -5F, -1F, 1, 4, 2);
		Horn2_R.setRotationPoint( -2.798228F, -5.939657F - 10.73092F, -5.761665F + 1.162896F );
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		Horn2_L.rotateAngleX = -0.8807437F;
		Horn2_L.rotateAngleY = -0.139558F;
		Horn2_L.rotateAngleZ = 0.4298474F;
		Bud_R.rotateAngleX = 0.1493226F;
		Bud_R.rotateAngleY = -0.1260779F;
		Bud_R.rotateAngleZ = -0.09751798F;
		Horn1_R.rotateAngleX = -0.6566104F;
		Horn1_R.rotateAngleY = 0.013392F;
		Horn1_R.rotateAngleZ = -0.3415253F;
		Horn2_R.rotateAngleX = -0.8807439F;
		Horn2_R.rotateAngleY = 0.139558F;
		Horn2_R.rotateAngleZ = -0.4298474F;
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		this.HeadNode.rotationPointY = + 7.75F + ((EntityBuckPygmy)LivingEntityIn).getHeadAnchorPointY(partialTickTime) * 6.0F;
		this.headRotationAngleX = ((EntityBuckPygmy)LivingEntityIn).getHeadAngleX(partialTickTime);
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if (entity instanceof EntityBuckPygmy) {
