...
public class ModelSowLargeBlack extends ModelBase
{
	...
	public ModelSowLargeBlack(float par1)
	{
		...
		/*
		 * Ear1 = new ModelRenderer( this, 3, 28 ); Ear1.setTextureSize( 64, 32
		 * ); Ear1.addBox( -1.5F, -2.5F, -0.5F, 3, 3, 1);
		 * //Ear1.setRotationPoint( 3F, 9.25F, -11F ); Ear1.setRotationPoint(
		 * 3F, -2.75F, -5F );
		 *
		 * Ear1a = new ModelRenderer( this, 2, 27 ); Ear1a.setTextureSize( 64,
		 * 32 ); Ear1a.addBox( -1.5F, -0.5F, -1F, 3, 1, 2);
		 * //Ear1a.setRotationPoint( 4.850319F, 6.900764F, -11.55445F );
		 * Ear1a.setRotationPoint( 4.850319F, 6.900764F -12F, -11.55445F + 6F );
		 *
		 * Ear1b = new ModelRenderer( this, 3, 28 ); Ear1b.setTextureSize( 64,
		 * 32 ); Ear1b.addBox( -1F, -0.5F, -0.5F, 2, 1, 1);
		 * //Ear1b.setRotationPoint( 4.013302F, 7.511297F, -11.97475F );
		 * Ear1b.setRotationPoint( 4.013302F, 7.511297F -12f, -11.97475F + 6F );
		 *
		 * Ear2 = new ModelRenderer( this, 3, 28 ); Ear2.setTextureSize( 64, 32
		 * ); Ear2.addBox( -1.5F, -2.5F, -0.5F, 3, 3, 1);
		 * //Ear2.setRotationPoint( -3F, 9.25F, -11F ); Ear2.setRotationPoint(
		 * -3F, 9.25F -12F, -11F + 6F );
		 *
		 * Ear2a = new ModelRenderer( this, 2, 27 ); Ear2a.setTextureSize( 64,
		 * 32 ); Ear2a.addBox( -1.5F, -0.5F, -1F, 3, 1, 2);
		 * //Ear2a.setRotationPoint( -4.850319F, 6.900764F, -11.55445F );
		 * Ear2a.setRotationPoint( -4.850319F, 6.900764F - 12F, -11.55445F + 6F
		 * );
		 *
		 * Ear2b = new ModelRenderer( this, 3, 28 ); Ear2b.setTextureSize( 64,
		 * 32 ); Ear2b.addBox( -1F, -0.5F, -0.5F, 2, 1, 1);
	...
	public void setLivingAnimations(LivingEntity LivingEntityIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (LivingEntityIn instanceof EntitySowLargeBlack entitySowLargeBlack)
		{
