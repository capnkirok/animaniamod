...
public class RenderRamMerino<T extends EntityRamMerino> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES = { new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "white_ram.png"), new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "brown_ram.png") };
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED = { new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "white_ram_sheared.png"), new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "brown_ram_sheared.png") };
