...
public class ModelCatExotic extends ModelBase
{
	...
	public ModelCatExotic()
	{
		...
		this.lower_body = new ModelRendererAnimania(this, 78, 43);
		this.lower_body.setTextureSize(128, 64);
		this.lower_body.addBox(-3.5F, -4.5F, -5.5F, 7, 9, 11);
		this.lower_body.setRotationPoint(0.0F, -1.0F, 3.0F);
		...
		this.back_leg_r1.setRotationPoint(-4.0F, -4.0F, 2.0F);
		...
		this.back_leg_r2.addBox(-1.0F, -5.0F, -1.5F, 2, 10, 3);
		this.back_leg_r2.setRotationPoint(0.0F, 1.0F, 1.0F);
		...
		this.back_leg_l1.setRotationPoint(4.0F, -4.0F, 2.0F);
		...
		this.back_leg_l2.addBox(-1.0F, -5.0F, -1.5F, 2, 10, 3);
		this.back_leg_l2.setRotationPoint(0.0F, 1.0F, 1.0F);
		this.back_leg_l2.setOffset(-0.01F, 3.5F, 0.7F);
		this.neck1 = new ModelRendererAnimania(this, 14, 21);
		this.neck1.setTextureSize(128, 64);
		this.neck1.addBox(-2.5F, -3.0F, -3.5F, 5, 6, 7);
		this.neck1.setRotationPoint(0.0F, 1.0F, -2.0F);
		...
		this.head_base.addBox(-3.0F, -3.5F, -2.5F, 6, 7, 5);
		...
		this.head_front.setRotationPoint(0.0F, 3.0F, 2.0F);
		...
		this.head_slope.setRotationPoint(0.0F, -2.0F, 3.0F);
		...
		this.jaw.setRotationPoint(0.0F, 2.4F, -0.0F);
		this.jaw.setOffset(0.0F, -0.2F, -1.0F);
		this.cheek_r = new ModelRendererAnimania(this, 32, 41);
		this.cheek_r.setTextureSize(128, 64);
		this.cheek_r.addBox(-1.5F, -3.0F, -1.5F, 3, 6, 3);
		this.cheek_r.setRotationPoint(-1.0F, 0.5F, 1.0F);
		this.cheek_r.setOffset(-2.0F, -0.6F, -1.0F);
		this.cheek_r2 = new ModelRendererAnimania(this, 32, 35);
		this.cheek_r2.setTextureSize(128, 64);
		this.cheek_r2.addBox(-1.5F, -2.0F, -1.0F, 3, 4, 2);
		...
		this.cheek_l.addBox(-1.5F, -3.0F, -1.5F, 3, 6, 3);
		this.cheek_l.setRotationPoint(1.0F, 0.5F, 1.0F);
		this.cheek_l.setOffset(2.0F, -0.6F, -1.0F);
		this.cheek_l2 = new ModelRendererAnimania(this, 32, 35);
		this.cheek_l2.setTextureSize(128, 64);
		this.cheek_l2.addBox(-1.5F, -2.0F, -1.0F, 3, 4, 2);
		...
		this.ear_r.setRotationPoint(-2.0F, -2.0F, -0.0F);
		this.ear_r.setOffset(-0.5F, -0.6F, -1.0F);
		this.ear_r2 = new ModelRendererAnimania(this, 0, 0);
		this.ear_r2.setTextureSize(128, 64);
		this.ear_r2.addBox(-1.0F, -0.5F, -0.5F, 2, 1, 1);
		this.ear_r2.setRotationPoint(0.0F, 0.6F, -2.5F);
		...
		this.ear_l.setRotationPoint(2.0F, -2.0F, -0.0F);
		this.ear_l.setOffset(0.5F, -0.6F, -1.0F);
		this.ear_l2 = new ModelRendererAnimania(this, 0, 0);
		this.ear_l2.setTextureSize(128, 64);
		this.ear_l2.addBox(-1.0F, -0.5F, -0.5F, 2, 1, 1);
		this.ear_l2.setRotationPoint(0.0F, 0.6F, -2.5F);
		...
		this.leg_r2.setRotationPoint(0.0F, 2.0F, 0.2F);
		...
		this.leg_l2.setRotationPoint(0.0F, 2.0F, 0.2F);
	...
	public void render(Entity entity, float f1, float f2, float f3, float f4, float f5, float scale)
	{
		...
		this.neck1.rotateAngleX = -0.698679734182858F;
		this.head_base.rotateAngleX = 0.77376030794515F;
		this.head_front.rotateAngleX = -0.18688811097430083F;
		...
		this.ear_r2.rotateAngleX = 0.15707963267948966F;
		...
		this.ear_l2.rotateAngleX = 0.15707963267948966F;
