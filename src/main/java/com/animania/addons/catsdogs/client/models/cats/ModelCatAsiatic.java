...
public class ModelCatAsiatic extends ModelBase
{
	...
	public ModelCatAsiatic()
	{
		...
		this.head_base.setRotationPoint(0.0F, -2.0F, -2.3F);
	...
	public void setupAngles()
	{
		...
		this.cheek_l2.setRotationPoint(-1.0F, 0.6F, 1.5F);
		this.cheek_l2.setOffset(2.0F, -0.6F, -1.0F);
		this.ear_r.rotateAngleX = -1.1344657591255662F;
		this.ear_r.rotateAngleY = 1.9198621771937625F;
		this.ear_r.rotateAngleZ = -1.3962634015954636F;
		this.ear_r.setRotationPoint(-2.5F, -2.7F, 0.7F);
		this.ear_r.setOffset(-0.5F, -0.6F, -0.5F);
		...
		this.ear_r3.setRotationPoint(0.0F, 0.6F, -0.5F);
		this.ear_r3.setOffset(0.0F, -0.6F, -0.0F);
		this.ear_l.rotateAngleX = -1.1344657591255662F;
		this.ear_l.rotateAngleY = -1.9198621771937625F;
		this.ear_l.rotateAngleZ = 1.3962651469247156F;
		this.ear_l.setRotationPoint(2.5F, -2.7F, 0.7F);
		this.ear_l.setOffset(0.5F, -0.6F, -0.5F);
