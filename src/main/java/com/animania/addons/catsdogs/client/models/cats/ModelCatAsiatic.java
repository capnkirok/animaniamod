...
public class ModelCatAsiatic extends ModelBase
{
	...
	public ModelCatAsiatic()
	{
		...
		this.head_base.setRotationPoint(0.0F, -2.6F, -3.0F);
		...
		this.head_front.setRotationPoint(0.0F, 1.2F, 1.2F);
		...
		this.cheek_r.setRotationPoint(-0.6F, 0.5F, 2.0F);
		...
		this.cheek_l.setRotationPoint(0.6F, 0.5F, 2.0F);
		...
		this.ear_l = new ModelRendererAnimania(this, -1, -1);
		this.ear_l.setTextureSize(128, 64);
		this.ear_l.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1);
		this.ear_l.setRotationPoint(0.0F, 0.6F, -0.5F);
		this.ear_l.setOffset(0.0F, -0.6F, -0.0F);
		this.ear_l1 = new ModelRendererAnimania(this, 3, 3);
		this.ear_l1.setTextureSize(128, 64);
		this.ear_l1.addBox(-1.5F, -0.5F, -2.0F, 3, 1, 4);
		this.ear_l1.setRotationPoint(2.0F, -1.9999F, -0.0F);
		this.ear_l1.setOffset(0.5F, -0.6F, -0.5F);
	...
	public void render(Entity entity, float f1, float f2, float f3, float f4, float f5, float scale)
	{
		...
		this.ear_r.rotateAngleX = -1.196047956452934F;
		this.ear_r.rotateAngleY = 1.2649500646631662F;
		this.ear_r.rotateAngleZ = -0.9976563803787386F;
		this.ear_r2.rotateAngleX = 0.13962634015954636F;
		this.ear_l.rotateAngleX = 0.20053833105414848F;
		this.ear_l1.rotateAngleX = -1.196047956452934F;
		this.ear_l1.rotateAngleY = -1.2649500646631662F;
		this.ear_l1.rotateAngleZ = 0.9976581257079907F;
