...
public class ModelGreatDane extends ModelBase
{
	...
	public ModelGreatDane()
	{
		...
		this.leg_l2 = new ModelRendererAnimania(this, 13, 53);
		...
		this.head_base.setRotationPoint(0.0F, -0.4F, -6.4F);
	...
	public void setupAngles()
	{
		...
		this.neck1.rotateAngleX = -1.144651500640205F;
		...
		this.upper_jaw_detail.rotateAngleX = 0.06293308216841154F;
