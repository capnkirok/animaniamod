...
public class ModelGreatDane extends ModelBase
{
	...
	public ModelGreatDane()
	{
		...
		this.lower_body.addBox(-3.0F, -3.5F, -6.5F, 6, 7, 13);
		this.lower_body.setRotationPoint(0.0F, -1.2F, 7.0F);
		...
		this.tail2.addBox(-1.0F, -1.0F, -3.0F, 2, 2, 6);
		this.tail2.setRotationPoint(0.0F, -1.0F, 3.0F);
		this.tail2.setOffset(0.0F, 1.0F, 2.5F);
		this.tail3 = new ModelRendererAnimania(this, 65, 8);
		this.tail3.setTextureSize(128, 64);
		this.tail3.addBox(-0.5F, -1.0F, -2.5F, 1, 2, 5);
		...
		this.back_leg_l1.setRotationPoint(2.5F, -3.0F, 3.0F);
		this.back_leg_l1.setOffset(0.0F, 5.0F, 0.5F);
		this.back_leg_l2 = new ModelRendererAnimania(this, 0, 37);
		this.back_leg_l2.setTextureSize(128, 64);
		this.back_leg_l2.addBox(-1.0F, -6.5F, -1.0F, 2, 13, 2);
		this.back_leg_l2.setRotationPoint(0.0F, 1.5F, 0.5F);
		...
		this.back_leg_r1.setRotationPoint(-2.5F, -3.0F, 3.0F);
		this.back_leg_r1.setOffset(0.0F, 5.0F, 0.5F);
		this.back_leg_r2 = new ModelRendererAnimania(this, 0, 37);
		this.back_leg_r2.setTextureSize(128, 64);
		this.back_leg_r2.addBox(-1.0F, -6.5F, -1.0F, 2, 13, 2);
		this.back_leg_r2.setRotationPoint(0.0F, 1.5F, 0.5F);
		...
		this.neck1.addBox(-2.5F, -3.0F, -6.0F, 5, 6, 12);
		this.neck1.setRotationPoint(0.0F, -2.5F, -2.7F);
		...
		this.head_base.setRotationPoint(0.0F, -0.8F, -6.4F);
		...
		this.head_front.addBox(-2.5F, -1.5F, -3.5F, 5, 3, 7);
		...
		this.upper_jaw_detail.setRotationPoint(0.0F, -3.0F, 4.0F);
		this.upper_jaw_detail.setOffset(0.0F, 1.0F, -5.0F);
		this.jaw = new ModelRendererAnimania(this, 84, 4);
		this.jaw.setTextureSize(128, 64);
		this.jaw.addBox(-2.0F, -0.5F, -3.0F, 4, 1, 6);
		...
		this.ear_r.setRotationPoint(-2.0F, -2.0F, 0.7F);
		...
		this.leg_r1.setRotationPoint(-3.3F, -1.0F, -3.0F);
	...
	public void render(Entity entity, float f1, float f2, float f3, float f4, float f5, float scale)
	{
		...
		this.neck1.rotateAngleX = -1.0664712221263712F;
		this.head_base.rotateAngleX = 1.3738621006461162F;
		this.head_front.rotateAngleX = -0.03422939729011279F;
		this.nose.rotateAngleX = -0.091106186954104F;
		this.upper_jaw_detail.rotateAngleX = 0.042860050441224755F;
		this.jaw.rotateAngleX = -0.07672118325916674F;
		this.ear_r.rotateAngleX = -1.293639786907449F;
		this.ear_r.rotateAngleY = 2.588148747782391F;
		this.ear_r.rotateAngleZ = -2.3736477827122884F;
