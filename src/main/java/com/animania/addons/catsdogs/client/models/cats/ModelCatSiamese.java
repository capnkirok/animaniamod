...
public class ModelCatSiamese extends ModelBase
{
	...
	public ModelCatSiamese()
	{
		this.body = new ModelRendererAnimania(this, 38, 44);
		this.body.setTextureSize(128, 64);
		this.body.addBox(-3.0F, -4.0F, -5.5F, 6, 8, 11);
		...
		this.tail.addBox(-1.0F, -1.0F, -4.5F, 2, 2, 9);
		...
		this.tail2.addBox(-1.0F, -1.0F, -2.5F, 2, 2, 5);
		...
		this.tail3.addBox(-1.0F, -1.0F, -3.5F, 2, 2, 7);
		this.tail3.setRotationPoint(0.0F, 0.0F, 1.5F);
		this.tail3.setOffset(0.0F, -0.0F, 3.0F);
		this.tail4 = new ModelRendererAnimania(this, 64, 8);
		this.tail4.setTextureSize(128, 64);
		this.tail4.addBox(-1.0F, -1.0F, -2.0F, 2, 2, 4);
		this.tail4.setRotationPoint(0.0F, 1.0E-4F, 3.0F);
		this.tail4.setOffset(0.0F, -0.0F, 2.0F);
		...
		this.neck1.addBox(-2.5F, -2.5F, -4.0F, 5, 5, 8);
		...
		this.head_front.setRotationPoint(0.0F, 1.5F, 1.2F);
		...
		this.jaw.setOffset(0.0F, -0.0F, -2.0F);
	...
	public void render(Entity entity, float f1, float f2, float f3, float f4, float f5, float scale)
	{
		...
		this.tail4.rotateAngleX = -5.991786880595865F;
		this.back_leg_r1.rotateAngleX = -1.7453292519943296E-6F;
		this.back_leg_l1.rotateAngleX = -1.7453292519943296E-6F;
		this.neck1.rotateAngleX = -0.7626390699514422F;
		this.head_base.rotateAngleX = 0.9867114206394823F;
		...
		this.jaw.rotateAngleX = 0.08399397025222712F;
