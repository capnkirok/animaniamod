...
{	
	...
	public ModelRagdoll(float par1)
	{
	...
	public void setLivingAnimations(EntityLivingBase entity, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		/*
		if (entity instanceof EntityTomRagdoll) {
			EntityTomRagdoll eb = (EntityTomRagdoll) entity;
			
			this.Neck1.rotationPointY = + 7.75F + eb.getHeadRotationPointY(partialTickTime) * 6.0F;
