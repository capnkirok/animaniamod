...
public class ModelCatTabby extends ModelBase
{
	...
	public ModelCatTabby()
	{
		...
		this.ear_r.setRotationPoint(-2.0F, -1.5F, -0.0F);
		...
		this.ear_l.setRotationPoint(2.0F, -1.5F, -0.0F);
	...
	public void render(Entity entity, float f1, float f2, float f3, float f4, float f5, float scale)
	{
		...
		this.jaw.rotateAngleX = 0.1459566493565298F;
		...
		this.ear_r.rotateAngleX = -1.2555148147268849F;
		this.ear_r.rotateAngleY = 1.9439040876399845F;
		this.ear_r.rotateAngleZ = -1.903089563082097F;
		this.ear_r2.rotateAngleX = 0.13962634015954636F;
		this.ear_r3.rotateAngleX = 0.20053833105414848F;
		this.ear_l.rotateAngleX = -1.2555165600561369F;
		this.ear_l.rotateAngleY = -1.9439040876399845F;
		this.ear_l.rotateAngleZ = 1.903089563082097F;
