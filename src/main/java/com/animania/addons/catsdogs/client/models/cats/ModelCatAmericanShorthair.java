...
public class ModelCatAmericanShorthair extends ModelBase
{
	...
	public ModelCatAmericanShorthair()
	{
		...
		this.head_front.setRotationPoint(0.0F, 1.3F, 1.4F);
		...
		this.head_slope.setRotationPoint(0.0F, -1.5F, 3.0F);
		...
		this.jaw.setRotationPoint(0.0F, 2.6F, -1.8F);
	...
	public void setupAngles()
	{
		...
		this.back_leg_l2.setRotationPoint(0.0F, 2.0F, 1.0F);
		this.back_leg_l2.setOffset(-0.01F, 3.5F, 0.7F);
		this.neck1.rotateAngleX = -0.7687285237116505F;
		this.neck1.rotateAngleY = 0.0F;
		this.neck1.rotateAngleZ = 0.0F;
		this.neck1.setRotationPoint(0.0F, 1.0F, -2.0F);
		this.neck1.setOffset(0.0F, -0.0F, -5.0F);
		this.head_base.rotateAngleX = 0.823969939866523F;
		this.head_base.rotateAngleY = 0.0F;
		this.head_base.rotateAngleZ = 0.0F;
		this.head_base.setRotationPoint(0.0F, -2.0F, -3.0F);
		this.head_base.setOffset(0.0F, 1.0F, -3.0F);
		this.head_front.rotateAngleX = 0.21118483949131386F;
