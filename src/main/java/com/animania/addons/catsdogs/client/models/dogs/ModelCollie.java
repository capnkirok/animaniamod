...
public class ModelCollie extends ModelBase
{
	...
	public void setupAngles()
	{
		...
		this.ear_l21.rotateAngleY = -0.0F;
		this.ear_l21.rotateAngleZ = -0.0F;
		this.cheek.rotateAngleX = -0.36139136557644985F;
		this.cheek.rotateAngleY = -0.2775701829201702F;
		this.cheek.rotateAngleZ = -0.0F;
		this.cheek1.rotateAngleX = 0.0F;
		this.cheek1.rotateAngleY = -0.0F;
		this.cheek1.rotateAngleZ = -0.0F;
		...
		this.cheek111.rotateAngleX = 0.0F;
