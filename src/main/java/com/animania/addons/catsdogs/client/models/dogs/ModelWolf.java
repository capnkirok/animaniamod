...
public class ModelWolf extends ModelBase
{
	...
	public ModelWolf()
	{
		...
		this.leg_l2 = new ModelRendererAnimania(this, 4, 39);
		...
		this.toe_l = new ModelRendererAnimania(this, 15, 62);
		this.toe_l.setTextureSize(128, 64);
		this.toe_l.addBox(-1.0F, -0.5F, -0.5F, 2, 1, 1);
		this.toe_l.setRotationPoint(0.0099F, -3.5F, 0.6001F);
		this.toe_l.setOffset(-0.01F, 7.5F, -1.5F);
		...
		this.tail4 = new ModelRendererAnimania(this, 82, 14);
		this.tail4.setTextureSize(128, 64);
		this.tail4.addBox(-1.0F, -1.5F, -1.5F, 2, 3, 3);
		this.tail4.setRotationPoint(0.0F, 1.0E-4F, 1.0F);
		this.tail4.setOffset(0.0F, -0.0F, 1.0F);
		...
		this.back_leg_r2 = new ModelRendererAnimania(this, 4, 39);
		...
		this.back_toe_r = new ModelRendererAnimania(this, 4, 50);
		this.back_toe_r.setTextureSize(128, 64);
		this.back_toe_r.addBox(-1.0F, -0.5F, -0.5F, 2, 1, 1);
		this.back_toe_r.setRotationPoint(0.0F, 2.5F, 0.5F);
		...
		this.back_toe_l = new ModelRendererAnimania(this, 1, 50);
		this.back_toe_l.setTextureSize(128, 64);
		this.back_toe_l.addBox(-1.0F, -0.5F, -0.5F, 2, 1, 1);
		this.back_toe_l.setRotationPoint(0.0F, 2.5F, 0.5F);
		...
		this.neck1.setRotationPoint(0.0F, -2.8F, -4.0F);
		...
		this.head_base.setRotationPoint(0.0F, -0.6F, -4.0F);
		...
		this.ear_r.setRotationPoint(-2.3F, -2.0F, 0.7001F);
		...
		this.chops_l = new ModelRendererAnimania(this, 38, 0);
		this.chops_l.setTextureSize(128, 64);
		this.chops_l.addBox(-2.0F, -1.0F, -2.5F, 4, 2, 5);
		this.chops_l.setRotationPoint(2.0F, 1.61F, -1.5F);
		...
		this.ear_l.setRotationPoint(2.3F, -1.9999F, 0.7F);
		...
		this.toe_l1 = new ModelRendererAnimania(this, 12, 62);
		this.toe_l1.setTextureSize(128, 64);
		this.toe_l1.addBox(-1.0F, -0.5F, -0.5F, 2, 1, 1);
		this.toe_l1.setRotationPoint(-0.12F, -3.5F, 0.6001F);
		this.toe_l1.setOffset(0.12F, 7.5F, -1.5F);
		...
		this.back_leg_r1.addChild(this.back_toe_r);
		...
		this.leg_r2.addChild(this.toe_l1);
	...
	public void setupAngles()
	{
		...
		this.tail4.rotateAngleX = -1.7453292519943296E-6F;
		...
		this.neck1.rotateAngleX = -0.5496041814530144F;
		this.neck1.rotateAngleY = 0.0F;
		this.neck1.rotateAngleZ = 0.0F;
		this.head_base.rotateAngleX = 1.0487683475233927F;
		...
		this.chops_r.rotateAngleX = -1.328134474243865F;
		this.chops_r.rotateAngleY = -2.827960477664916F;
		this.chops_r.rotateAngleZ = -2.213908268252759F;
		this.ear_r.rotateAngleX = -1.1145864589453507F;
		this.ear_r.rotateAngleY = 2.1374366670766274F;
		this.ear_r.rotateAngleZ = -2.102786645436784F;
		this.ear_r2.rotateAngleX = 0.3141592653589793F;
		this.ear_r2.rotateAngleY = 0.0F;
		this.ear_r2.rotateAngleZ = 0.0F;
		this.chops_l.rotateAngleX = -1.328134474243865F;
		this.chops_l.rotateAngleY = 2.827960477664916F;
		this.chops_l.rotateAngleZ = 2.213908268252759F;
		this.ear_l.rotateAngleX = -1.1145864589453507F;
		this.ear_l.rotateAngleY = -2.1374366670766274F;
		this.ear_l.rotateAngleZ = 2.102786645436784F;
		this.ear_l2.rotateAngleX = 0.3141592653589793F;
		...
		this.toe_l1.rotateAngleX = 0.0F;
		this.toe_l1.rotateAngleY = 0.0F;
		this.toe_l1.rotateAngleZ = 0.0F;
	}
