...
public class CatsDogsAddonBlockHandler
{
	...
	public static void preInit()
	{
		...
		dogPillow = new BlockProp("dog_pillow", Material.CLOTH, MapColor.CLOTH, SoundType.CLOTH).setAABB(1, 0, 1, 15, 1, 15).setHardness(1.0f).setResistance(0.8f);
		litterBox = new BlockProp("litter_box", Material.CLOTH, MapColor.CLOTH, SoundType.STONE).setAABB(1, 0, 1, 15, 3, 15).setHardness(1.5f).setResistance(0.8f);
