...
public class RenderDoeRex<T extends RabbitEntityDoeRex> extends RenderLiving<T>
{
	...
	protected void preRenderScale(RabbitEntityDoeRex entity, float f)
	{
	...
	static class Factory<T extends RabbitEntityDoeRex> implements IRenderFactory<T>
	{
		@Override
