...
public class RenderDoeCottontail<T extends RabbitEntityDoeCottontail> extends RenderLiving<T>
{
	...
	static class Factory<T extends RabbitEntityDoeCottontail> implements IRenderFactory<T>
	{
		@Override
