...
public class ModelLop extends ModelBase
{
	...
	public ModelLop(float par1)
	{
		...
		this.EarR1 = new ModelRenderer(this, 25, 0);
		this.EarR1.setTextureSize(128, 128);
		this.EarR1.addBox(-1F, -1.1F, -0.7F, 2, 1, 2);
		this.EarR1.setRotationPoint(-3.0F, 10.71813F - 15.88453F, -6.550904F + 3.429656F);

		this.EarR2 = new ModelRenderer(this, 3, 0);
		this.EarR2.setTextureSize(128, 128);
		this.EarR2.addBox(-1.5F, -1.1F, 0F, 3, 1, 7);
		this.EarR2.setRotationPoint(-3.292489F + 2.2F, 9.867092F - 10.71813F + 5.6F, -6.222733F + 6.550904F + 3.5F);

		this.EarL1 = new ModelRenderer(this, 25, 0);
		this.EarL1.setTextureSize(128, 128);
		this.EarL1.addBox(-1F, -1.1F, -0.7F, 2, 1, 2);
		this.EarL1.setRotationPoint(3.0F, 10.71813F - 15.88453F, -6.550904F + 3.429656F);

		this.EarL2 = new ModelRenderer(this, 3, 0);
		this.EarL2.setTextureSize(128, 128);
		this.EarL2.addBox(-1.5F, -1.1F, 0F, 3, 1, 7);
		this.EarL2.setRotationPoint(3.224298F - 2.2F, 9.938663F - 10.71813F + 5.6F, -6.207649F + 6.550904F + 3.5F);
		...
		this.Neck1.addChild(this.EarR1);
		this.EarR1.addChild(this.EarR2);

		this.Neck1.addChild(this.EarL1);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		this.EarR1.rotateAngleX = -0.7976383F;
		this.EarR1.rotateAngleY = 1.35309F;
		this.EarR1.rotateAngleZ = 0.1836136F;

		this.EarR2.rotateAngleX = -2.233634F;
		// EarR2.rotateAngleY = .8F;
		this.EarR2.rotateAngleZ = -3.030268F;

		this.EarL1.rotateAngleX = -0.7976383F;
		this.EarL1.rotateAngleY = -1.35309F;
		this.EarL1.rotateAngleZ = -0.1836136F;

		this.EarL2.rotateAngleX = -2.233634F;
		// EarL2.rotateAngleY = 1.604991F;
		this.EarL2.rotateAngleZ = 3.030268F;
