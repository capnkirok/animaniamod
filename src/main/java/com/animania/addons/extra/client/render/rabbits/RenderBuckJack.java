...
public class RenderBuckJack<T extends RabbitEntityBuckJack> extends RenderLiving<T>
{
	...
	protected void preRenderScale(RabbitEntityBuckJack entity, float f)
	{
	...
	protected ResourceLocation getEntityTexture(T entity)
	{
		if (entity.getCustomNameTag().trim().equals("Killer")) {
			return RenderBuckJack.killerRabbitTextures;
		} else {
			return RenderBuckJack.rabbitTextures;
		}
	}

	static class Factory<T extends RabbitEntityBuckJack> implements IRenderFactory<T>
	{
		@Override
		public Render<? super T> createRenderFor(RenderManager manager)
		{
			return new RenderBuckJack(manager);
		}
