...
public class RenderBuckCottontail<T extends RabbitEntityBuckCottontail> extends RenderLiving<T>
{
	...
	protected void preRenderScale(RabbitEntityBuckCottontail entity, float f)
	{
	...
	static class Factory<T extends RabbitEntityBuckCottontail> implements IRenderFactory<T>
	{
		@Override
