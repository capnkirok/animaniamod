...
{// RenderPlayer
	...
	private static final ResourceLocation[] FROGS_TEXTURES = { new ResourceLocation(RenderDartFrogs.modid, RenderDartFrogs.frogsBaseDir + "red_dart_frog.png"), new ResourceLocation(RenderDartFrogs.modid, RenderDartFrogs.frogsBaseDir + "blue_dart_frog.png"), new ResourceLocation(RenderDartFrogs.modid, RenderDartFrogs.frogsBaseDir + "yellow_dart_frog.png") };
