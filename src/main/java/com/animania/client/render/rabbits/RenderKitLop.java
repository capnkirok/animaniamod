...
public class RenderKitLop<T extends EntityRabbitKitLop> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] RABBIT_TEXTURES_BLINK = new ResourceLocation[] { new ResourceLocation(RenderKitLop.modid, RenderKitLop.rabbitBaseDir + "rabbit_lop_" + "black_blink.png"), new ResourceLocation(RenderKitLop.modid, RenderKitLop.rabbitBaseDir + "rabbit_lop_" + "brown_blink.png"), new ResourceLocation(RenderKitLop.modid, RenderKitLop.rabbitBaseDir + "rabbit_lop_" + "golden_blink.png"), new ResourceLocation(RenderKitLop.modid, RenderKitLop.rabbitBaseDir + "rabbit_lop_" + "olive_blink.png"), new ResourceLocation(RenderKitLop.modid, RenderKitLop.rabbitBaseDir + "rabbit_lop_" + "patch_black_blink.png"), new ResourceLocation(RenderKitLop.modid, RenderKitLop.rabbitBaseDir + "rabbit_lop_" + "patch_brown_blink.png"), new ResourceLocation(RenderKitLop.modid, RenderKitLop.rabbitBaseDir + "rabbit_lop_" + "patch_grey_blink.png") };
