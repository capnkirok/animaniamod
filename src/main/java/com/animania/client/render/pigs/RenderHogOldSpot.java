...
public class RenderHogOldSpot<T extends EntityHogOldSpot> extends RenderLiving<T>
{
	...
	protected ResourceLocation getEntityTexture(T entity) {
		...
		if (blinkTimer < 7 && blinkTimer >= 0)
			return RenderHogOldSpot.PIG_TEXTURES_BLINK;
		else
	...
	static class Factory<T extends EntityHogOldSpot> implements IRenderFactory<T>
	{
		...
		public Render<? super T> createRenderFor(RenderManager manager) {
			return new RenderHogOldSpot(manager);
		}
	}
}