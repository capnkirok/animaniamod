...
public class RenderPigletDuroc<T extends EntityPigletDuroc> extends RenderLiving<T>
{
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        ...
        if (blinkTimer < 7 && blinkTimer >= 0)
            return RenderPigletDuroc.PIG_TEXTURES_BLINK;
        else
            return RenderPigletDuroc.PIG_TEXTURES;
    }

    static class Factory<T extends EntityPigletDuroc> implements IRenderFactory<T>
    {
        @Override
