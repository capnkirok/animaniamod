...
public class RenderHenLeghorn<T extends EntityHenLeghorn> extends RenderLiving<T>
{
	...
	static class Factory<T extends EntityHenLeghorn> implements IRenderFactory<T>
	{
		@Override
		public Render<? super T> createRenderFor(RenderManager manager) {
			return new RenderHenLeghorn(manager);
		}
	}
}