...
public class RenderRoosterLeghorn<T extends EntityRoosterLeghorn> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityRoosterLeghorn> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderRoosterLeghorn(manager);
        }
    }
