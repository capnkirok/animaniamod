...
public class RenderRoosterPlymouthRock<T extends EntityRoosterPlymouthRock> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityRoosterPlymouthRock> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderRoosterPlymouthRock(manager);
        }
    }
