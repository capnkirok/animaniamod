...
public class RenderChickPlymouthRock<T extends EntityChickPlymouthRock> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityChickPlymouthRock> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderChickPlymouthRock(manager);
        }
    }
