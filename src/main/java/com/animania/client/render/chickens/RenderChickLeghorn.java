...
public class RenderChickLeghorn<T extends EntityChickLeghorn> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityChickLeghorn> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderChickLeghorn(manager);
        }
    }
