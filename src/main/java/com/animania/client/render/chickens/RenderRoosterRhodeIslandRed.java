...
public class RenderRoosterRhodeIslandRed<T extends EntityRoosterRhodeIslandRed> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityRoosterRhodeIslandRed> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderRoosterRhodeIslandRed(manager);
        }
    }
