...
public class RenderHenPlymouthRock<T extends EntityHenPlymouthRock> extends RenderLiving<T>
{
    ...
    public static class Factory<T extends EntityHenPlymouthRock> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderHenPlymouthRock(manager);
        }
    }
}
