...
public class RenderRamMerino<T extends EntityRamMerino> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES = new ResourceLocation[] { new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "white_ram.png"), new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "brown_ram.png") };

	private static final ResourceLocation[] SHEEP_TEXTURES_BLINK = new ResourceLocation[] { new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "white_ram_blink.png"), new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "brown_ram_blink.png") };

	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED = new ResourceLocation[] { new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "white_ram_sheared.png"), new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "brown_ram_sheared.png") };

	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED_BLINK = new ResourceLocation[] { new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "white_ram_sheared_blink.png"), new ResourceLocation(RenderRamMerino.modid, RenderRamMerino.SheepBaseDir + "sheep_merino_" + "brown_ram_sheared_blink.png") };
