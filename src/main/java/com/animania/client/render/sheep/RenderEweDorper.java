...
public class RenderEweDorper<T extends EntityEweDorper> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_BLINK = new ResourceLocation[] { new ResourceLocation(RenderEweDorper.modid, RenderEweDorper.SheepBaseDir + "sheep_dorper_blink.png") };
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED_BLINK = new ResourceLocation[] { new ResourceLocation(RenderEweDorper.modid, RenderEweDorper.SheepBaseDir + "sheep_dorper_sheared_blink.png") };
