...
public class RenderRamDorper<T extends EntityRamDorper> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_BLINK = new ResourceLocation[] { new ResourceLocation(RenderRamDorper.modid, RenderRamDorper.SheepBaseDir + "sheep_dorper_blink.png") };
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED_BLINK = new ResourceLocation[] { new ResourceLocation(RenderRamDorper.modid, RenderRamDorper.SheepBaseDir + "sheep_dorper_sheared_blink.png") };
