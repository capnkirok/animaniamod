...
public class RenderLambSuffolk<T extends EntityLambSuffolk> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_BLINK = new ResourceLocation[] { new ResourceLocation(RenderLambSuffolk.modid, RenderLambSuffolk.SheepBaseDir + "sheep_suffolk_" + "white_ewe_blink.png"), new ResourceLocation(RenderLambSuffolk.modid, RenderLambSuffolk.SheepBaseDir + "sheep_suffolk_" + "brown_ewe_blink.png") };
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED_BLINK = new ResourceLocation[] { new ResourceLocation(RenderLambSuffolk.modid, RenderLambSuffolk.SheepBaseDir + "sheep_suffolk_" + "white_ewe_sheared_blink.png"), new ResourceLocation(RenderLambSuffolk.modid, RenderLambSuffolk.SheepBaseDir + "sheep_suffolk_" + "brown_ewe_sheared_blink.png") };
