...
public class RenderEweMerino<T extends EntityEweMerino> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_BLINK = new ResourceLocation[] { new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "white_ewe_blink.png"), new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "brown_ewe_blink.png") };
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED_BLINK = new ResourceLocation[] { new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "white_ewe_sheared_blink.png"), new ResourceLocation(RenderEweMerino.modid, RenderEweMerino.SheepBaseDir + "sheep_merino_" + "brown_ewe_sheared_blink.png") };
