...
public class RenderRamDorset<T extends EntityRamDorset> extends RenderLiving<T>
{
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_BLINK = new ResourceLocation[] { new ResourceLocation(RenderRamDorset.modid, RenderRamDorset.SheepBaseDir + "sheep_dorset_" + "white_ram_blink.png"), new ResourceLocation(RenderRamDorset.modid, RenderRamDorset.SheepBaseDir + "sheep_dorset_" + "brown_ram_blink.png") };
	...
	private static final ResourceLocation[] SHEEP_TEXTURES_SHEARED_BLINK = new ResourceLocation[] { new ResourceLocation(RenderRamDorset.modid, RenderRamDorset.SheepBaseDir + "sheep_dorset_" + "white_ram_sheared_blink.png"), new ResourceLocation(RenderRamDorset.modid, RenderRamDorset.SheepBaseDir + "sheep_dorset_" + "brown_ram_sheared_blink.png") };
