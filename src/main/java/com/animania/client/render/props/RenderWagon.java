...
public class RenderWagon<T extends EntityWagon> extends Render<T>
{
	...
	public void drawSelectionBox(Entity entityIn, float partialTicks)
	{
		...
		drawSelectionBoundingBox(entityIn.getEntityBoundingBox().expand(0.0020000000949949026D, 0.0020000000949949026D, 0.0020000000949949026D).offset(-d0, -d1, -d2), 1.0F, 1.0F, 1.0F, 1.0F);
		renderFilledBox(entityIn.getEntityBoundingBox().expand(0.0020000000949949026D, 0.0020000000949949026D, 0.0020000000949949026D).offset(-d0, -d1, -d2), 1.0F, 1.0F, 1.0F, 0.2F);
	...
	public static void addChainedFilledBoxVertices(BufferBuilder buffer, double p_189693_1_, double p_189693_3_, double p_189693_5_, double p_189693_7_, double p_189693_9_, double p_189693_11_, float p_189693_13_, float p_189693_14_, float p_189693_15_, float p_189693_16_)
	{
