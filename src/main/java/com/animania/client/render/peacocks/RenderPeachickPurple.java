...
public class RenderPeachickPurple<T extends EntityPeachickPurple> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeachickPurple(RenderManager rm) {
    ...
    static class Factory<T extends EntityPeachickPurple> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeachickPurple(manager);
        }
    }
