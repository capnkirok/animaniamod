...
public class RenderPeafowlOpal<T extends EntityPeafowlOpal> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeafowlOpal(RenderManager rm) {
    ...
    protected void preRenderScale(EntityPeafowlOpal entity, float f) {
    ...
    static class Factory<T extends EntityPeafowlOpal> implements IRenderFactory<T>
    {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeafowlOpal(manager);
        }
    }
