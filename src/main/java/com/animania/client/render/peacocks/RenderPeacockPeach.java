...
public class RenderPeacockPeach<T extends EntityPeacockPeach> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeacockPeach(RenderManager rm) {
    ...
    static class Factory<T extends EntityPeacockPeach> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeacockPeach(manager);
        }
    }
}
