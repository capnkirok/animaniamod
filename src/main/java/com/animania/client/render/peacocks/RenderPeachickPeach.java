...
public class RenderPeachickPeach<T extends EntityPeachickPeach> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeachickPeach(RenderManager rm) {
    ...
    static class Factory<T extends EntityPeachickPeach> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeachickPeach(manager);
        }
    }
