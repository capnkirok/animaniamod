...
public class RenderPeacockWhite<T extends EntityPeacockWhite> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityPeacockWhite> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeacockWhite(manager);
        }
    }
}