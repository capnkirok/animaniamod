...
public class RenderPeachickWhite<T extends EntityPeachickWhite> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityPeachickWhite> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeachickWhite(manager);
        }
    }
}