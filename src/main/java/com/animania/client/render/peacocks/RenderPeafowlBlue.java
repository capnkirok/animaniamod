...
public class RenderPeafowlBlue<T extends EntityPeafowlBlue> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityPeafowlBlue> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeafowlBlue(manager);
        }
    }
