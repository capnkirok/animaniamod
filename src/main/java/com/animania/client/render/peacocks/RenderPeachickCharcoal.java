...
public class RenderPeachickCharcoal<T extends EntityPeachickCharcoal> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeachickCharcoal(RenderManager rm) {
    ...
    static class Factory<T extends EntityPeachickCharcoal> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeachickCharcoal(manager);
        }
    }
