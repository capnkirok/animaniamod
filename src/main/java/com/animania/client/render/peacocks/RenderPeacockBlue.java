...
public class RenderPeacockBlue<T extends EntityPeacockBlue> extends RenderLiving<T>
{
    ...
    static class Factory<T extends EntityPeacockBlue> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeacockBlue(manager);
        }
    }
}
