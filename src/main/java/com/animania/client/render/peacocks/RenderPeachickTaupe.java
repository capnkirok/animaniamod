...
public class RenderPeachickTaupe<T extends EntityPeachickTaupe> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeachickTaupe(RenderManager rm) {
    ...
    static class Factory<T extends EntityPeachickTaupe> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeachickTaupe(manager);
        }
    }
