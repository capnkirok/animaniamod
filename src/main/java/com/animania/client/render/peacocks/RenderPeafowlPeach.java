...
public class RenderPeafowlPeach<T extends EntityPeafowlPeach> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeafowlPeach(RenderManager rm) {
    ...
    protected void preRenderScale(EntityPeafowlPeach entity, float f) {
    ...
    static class Factory<T extends EntityPeafowlPeach> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeafowlPeach(manager);
        }
    }
