...
public class RenderPeacockOpal<T extends EntityPeacockOpal> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();

    public RenderPeacockOpal(RenderManager rm) {
    ...
    static class Factory<T extends EntityPeacockOpal> implements IRenderFactory<T>
    {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderPeacockOpal(manager);
        }
    }
}
