...
public class ModelPigletHampshire extends ModelBase
{
	...
	public ModelPigletHampshire()
	{
		this( 0.0f );
	}

	public ModelPigletHampshire( float par1 )
	{
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entitylivingbaseIn instanceof EntityPigletHampshire) {
			this.Head.rotationPointY = 17.0F + ((EntityPigletHampshire)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 3.0F; //number should match model Y point
