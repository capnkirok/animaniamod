...
public class ModelEweFriesian extends ModelBase
{	
	...
	public ModelEweFriesian()
	{
		this(0.0f);
	}

	public ModelEweFriesian(float par1)
	{
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		this.HeadNode.rotationPointY = + 7.75F + ((EntityDoeKiko)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 6.0F;
		this.headRotationAngleX = ((EntityDoeKiko)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
