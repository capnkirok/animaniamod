...
public class ModelRamFriesian extends ModelBase
{	
	...
	public ModelRamFriesian()
	{
		this(0.0f);
	}

	public ModelRamFriesian(float par1)
	{
		...
		Horn1_R.addBox( -1F, -8.5F, -1F, 2, 9, 2);
		Horn1_R.setRotationPoint( -1.691772F, -4.510839F - 8.730923F, -8.884541F  + 1.162896F);
		
		Horn2_R = new ModelRenderer( this, 38, 71 );
		Horn2_R.setTextureSize( 128, 128 );
		Horn2_R.addBox( 0F, -9.1F, 1.5F, 2, 7, 2);
		Horn2_R.setRotationPoint( -6.85363F, -9.151012F - 8.730923F, -7.733873F + 1.162896F );
		
		Horn1_L = new ModelRenderer( this, 38, 71 );
		Horn1_L.setTextureSize( 128, 128 );
		Horn1_L.addBox( -1F, -8.5F, -1F, 2, 9, 2);
		Horn1_L.setRotationPoint( 1.691772F, -4.510839F - 8.730923F, -8.884541F + 1.162896F );
	
		Horn2_L = new ModelRenderer( this, 38, 71 );
		Horn2_L.setTextureSize( 128, 128 );
		Horn2_L.addBox( -2F, -9.1F, 1.5F, 2, 7, 2);
		Horn2_L.setRotationPoint( 6.853631F, -9.151009F - 8.730923F, -7.733873F + 1.162896F );
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		Horn1_R.rotateAngleX = -0.7281985F;
		Horn1_R.rotateAngleY = -0.4957605F;
		Horn1_R.rotateAngleZ = -0.5339621F;
		Horn2_R.rotateAngleX = -1.205367F;
		Horn2_R.rotateAngleY = -0.2829273F;
		Horn2_R.rotateAngleZ = -0.01425832F;
		Horn1_L.rotateAngleX = -0.7281986F;
		Horn1_L.rotateAngleY = 0.4957606F;
		Horn1_L.rotateAngleZ = 0.5339621F;
		Horn2_L.rotateAngleX = -1.205367F;
		Horn2_L.rotateAngleY = 0.2829274F;
		Horn2_L.rotateAngleZ = 0.01425837F;
