...
public class ModelSowHampshire extends ModelBase
{
	...
	public ModelSowHampshire()
	{
		this( 0.0f );
	}

	public ModelSowHampshire( float par1 )
	{
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (entitylivingbaseIn instanceof EntitySowHampshire) {
			this.Head.rotationPointY = 11.0F + ((EntitySowHampshire)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; //number should match model Y point
			this.headRotationAngleX = ((EntitySowHampshire)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
		} 
