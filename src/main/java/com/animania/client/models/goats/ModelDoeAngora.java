...
{	
	...
	public ModelDoeAngora(float par1)
	{
		...
		Udder = new ModelRenderer( this, 10, 10 );
		Udder.setTextureSize( 128, 256 );
		Udder.addBox( -3F, -2F, -3F, 6, 4, 6);
		Udder.setRotationPoint( 0F, 15.37166F, 17.41618F );
		Udder1 = new ModelRenderer( this, 15, 15 );
		Udder1.setTextureSize( 128, 256 );
		Udder1.addBox( -0.5F, -0.5F, -0.5F, 1, 1, 1);
		Udder1.setRotationPoint( 2F, 17.87166F, 15.41618F );
		Udder2 = new ModelRenderer( this, 15, 15 );
		Udder2.setTextureSize( 128, 256 );
		Udder2.addBox( -0.5F, -0.5F, -0.5F, 1, 1, 1);
		Udder2.setRotationPoint( -2F, 17.87166F, 15.41618F );
		Udder3 = new ModelRenderer( this, 15, 15 );
		Udder3.setTextureSize( 128, 256 );
		Udder3.addBox( -0.5F, -0.5F, -0.5F, 1, 1, 1);
		Udder3.setRotationPoint( -2F, 17.87166F, 19.41618F );
		Udder4 = new ModelRenderer( this, 15, 15 );
		Udder4.setTextureSize( 128, 256 );
		Udder4.addBox( -0.5F, -0.5F, -0.5F, 1, 1, 1);
		Udder4.setRotationPoint( 2F, 17.87166F, 19.41618F );
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		this.HeadNode.rotationPointY = + 7.75F + ((EntityDoeAngora)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 6.0F;
		this.headRotationAngleX = ((EntityDoeAngora)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
