...
public class ModelCowLonghorn extends ModelBase
{
	...
	public ModelCowLonghorn()
	{
		...
		Horn1 = new ModelRenderer( this, 1, 59 );
        Horn1.setTextureSize( 64, 64 );
        Horn1.addBox( -2.5F, -1F, -1F, 5, 2, 2);
        Horn1.setRotationPoint( 6F, -2.5F, 0F );
        
        Horn1A = new ModelRenderer( this, 17, 59 );
        Horn1A.setTextureSize( 64, 64 );
        Horn1A.addBox( -1F, -1F, -1F, 2, 2, 2);
        Horn1A.setRotationPoint( 9.5F, -3.5F, 0F );
        
        Horn1B = new ModelRenderer( this, 25, 59 );
        Horn1B.setTextureSize( 64, 64 );
        Horn1B.addBox( -0.5F, -1F, -1F, 1, 2, 2);
        Horn1B.setRotationPoint( 11F, -4.5F, 0F );
        
        Horn1C = new ModelRenderer( this, 26, 60 );
        Horn1C.setTextureSize( 64, 64 );
        Horn1C.addBox( -0.5F, -1F, -0.5F, 1, 2, 1);
        Horn1C.setRotationPoint( 12F, -5.5F, 0F );
        
        Horn2 = new ModelRenderer( this, 1, 59 );
        Horn2.setTextureSize( 64, 64 );
        Horn2.addBox( -2.5F, -1F, -1F, 5, 2, 2);
        Horn2.setRotationPoint( -6F, -2.5F, 0F );
        
        Horn2A = new ModelRenderer( this, 17, 59 );
        Horn2A.setTextureSize( 64, 64 );
        Horn2A.addBox( -1F, -1F, -1F, 2, 2, 2);
        Horn2A.setRotationPoint( -9.5F, -3.5F, 0F );
        
        Horn2B = new ModelRenderer( this, 25, 59 );
        Horn2B.setTextureSize( 64, 64 );
        Horn2B.addBox( -0.5F, -1F, -1F, 1, 2, 2);
        Horn2B.setRotationPoint( -11F, -4.5F, 0F );
        
        Horn2C = new ModelRenderer( this, 26, 60 );
        Horn2C.setTextureSize( 64, 64 );
        Horn2C.addBox( -0.5F, -1F, -0.5F, 1, 2, 1);
        Horn2C.setRotationPoint( -12F, -5.5F, 0F );
