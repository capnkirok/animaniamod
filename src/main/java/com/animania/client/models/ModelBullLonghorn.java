...
public class ModelBullLonghorn extends ModelBase {
	...
	public ModelBullLonghorn() {
		...
		HeadTop = new ModelRenderer(this, 5, 5);
		...
		Horn1.addBox(0F, -1F, -1F, 6, 2, 2);
		Horn1.setRotationPoint(3F, -4F, -0F);

		Horn1A = new ModelRenderer(this, 38, 0);
		Horn1A.setTextureSize(128, 64);
		Horn1A.addBox(-1F, -1F, -1F, 2, 2, 2);
		Horn1A.setRotationPoint(9.964239F, -4.87F, 0F);

		Horn1B = new ModelRenderer(this, 46, 0);
		Horn1B.setTextureSize(128, 64);
		Horn1B.addBox(-0.5F, -1F, -1F, 1, 2, 2);
		Horn1B.setRotationPoint(11.40985F, -5.9427986F, 0F);

		Horn1C = new ModelRenderer(this, 52, 1);
		Horn1C.setTextureSize(128, 64);
		Horn1C.addBox(-0.5F, -1F, -0.5F, 1, 2, 1);
		Horn1C.setRotationPoint(12.35614F, -6.993765F, 0F);

		Horn2 = new ModelRenderer(this, 22, 0);
		Horn2.setTextureSize(128, 64);
		Horn2.addBox(0F, -1F, -1F, 6, 2, 2);
		Horn2.setRotationPoint(-9F, -4F, 0F); // was 3

		Horn2A = new ModelRenderer(this, 38, 0);
		Horn2A.setTextureSize(128, 64);
		Horn2A.addBox(-1F, -1F, -1F, 2, 2, 2);
		Horn2A.setRotationPoint(-9.964239F, -4.87F, 0F);

		Horn2B = new ModelRenderer(this, 46, 0);
		Horn2B.setTextureSize(128, 64);
		Horn2B.addBox(-0.5F, -1F, -1F, 1, 2, 2);
		Horn2B.setRotationPoint(-11.40985F, -5.9427986F, 0F);

		Horn2C = new ModelRenderer(this, 52, 1);
		Horn2C.setTextureSize(128, 64);
		Horn2C.addBox(-0.5F, -1F, -0.5F, 1, 2, 1);
		Horn2C.setRotationPoint(-12.35614F, -6.993765F, 0F);
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_,
		...
		if (entitylivingbaseIn instanceof EntityBullLonghorn) {
			this.Head.rotationPointY = 6.0F
					+ ((EntityBullLonghorn) entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 9.0F;
