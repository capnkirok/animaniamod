...
public class ModelBullHereford extends ModelBase
{
	...
	public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
	{
		...
		Horn1.rotateAngleX = 0.7853982F;

		Horn1A.rotateAngleX = 0.361367F;
		Horn1A.rotateAngleY = 1.1832F;
		Horn1A.rotateAngleZ = 0.6264579F;

		Horn1B.rotateAngleX = 0.6983591F;
		Horn1B.rotateAngleY = -0.1574829F;
		Horn1B.rotateAngleZ = -0.4074575F;

		Horn1C.rotateAngleX = 1.249138F;
		Horn1C.rotateAngleY = -1.755701F;
		Horn1C.rotateAngleZ = -2.136354F;

		Horn2.rotateAngleX = 0.7853982F;

		Horn1A1.rotateAngleX = -0.3613672F;
		Horn1A1.rotateAngleY = 1.958393F;
		Horn1A1.rotateAngleZ = -0.6264579F;

		Horn1B1.rotateAngleX = 0.7020042F;
		Horn1B1.rotateAngleY = 0.1701485F;
		Horn1B1.rotateAngleZ = 0.382166F;
		Horn1C1.rotateAngleX = 1.268307F;
		Horn1C1.rotateAngleY = 1.798498F;
		Horn1C1.rotateAngleZ = 2.130788F;
