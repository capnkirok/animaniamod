...
public class ModelDutch extends ModelBase
{	
	...
	public ModelDutch(float par1)
	{
		...
		HeadFront.setTextureSize( 64, 64 );
		...
		WhiskerR1.setTextureSize( 64, 64 );
		WhiskerR1.addBox( -0.5F, -0.5F, -2F, 1, 1, 2);
		WhiskerR1.setRotationPoint( -0.5F, 13.54453F - 15.88453F, -10.60801F + 3.429656F);

		WhiskerR2 = new ModelRenderer( this, 0, 2 );
		WhiskerR2.setTextureSize( 64, 64 );
		WhiskerR2.addBox( -1F, -0.5F, -1.9F, 1, 1, 2);
		WhiskerR2.setRotationPoint( -0.4F, 14.29407F - 15.88453F, -10.82755F + 3.429656F );

		WhiskerL1 = new ModelRenderer( this, 0, 2 );
		WhiskerL1.setTextureSize( 64, 64 );
		WhiskerL1.addBox( -0.5F, -0.5F, -2F, 1, 1, 2);
		WhiskerL1.setRotationPoint( 0.5F, 13.54453F - 15.88453F, -10.60801F + 3.429656F);

		WhiskerL2 = new ModelRenderer( this, 0, 2 );
		WhiskerL2.setTextureSize( 64, 64 );
		WhiskerL2.addBox( 0F, -0.5F, -1.9F, 1, 1, 2);
		WhiskerL2.setRotationPoint( 0.4F, 14.29407F - 15.88453F, -10.82755F + 3.429656F );
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		float f = par3 - (float)entity.ticksExisted;
		EntityAnimaniaRabbit entityrabbit = (EntityAnimaniaRabbit)entity;
		...
		this.BackLegL1.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
		this.BackLegL2.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
		this.BackLegR1.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
		this.BackLegR2.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
