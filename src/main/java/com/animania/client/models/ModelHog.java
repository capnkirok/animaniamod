	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_,
		...
		if (entitylivingbaseIn instanceof EntityHogYorkshire) {
			this.Head.rotationPointY = 11.0F
					+ ((EntityHogYorkshire) entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; // number
																												// should
																												// match
																												// model
																												// Y
			...
			this.Head.rotationPointY = 11.0F
					+ ((EntityHogOldSpot) entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; // number
																												// should
																												// match
																												// model
																												// Y
			...
			this.Head.rotationPointY = 11.0F
					+ ((EntityHogDuroc) entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; // number
																											// should
																											// match
																											// model
																											// Y
			...
			this.Head.rotationPointY = 11.0F
					+ ((EntityHogLargeWhite) entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 5.5F; // number
																												// should
																												// match
																												// model
																												// Y
