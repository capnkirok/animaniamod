...
import com.animania.models.ModelTrough;
...
public class TileEntityTroughRenderer extends TileEntitySpecialRenderer<TileEntityTrough>
{
	...
	public void renderTrough(float x, float y, float z, EnumFacing facing, float p_188190_5_, int troughType, @Nullable GameProfile profile, int destroyStage, float animateTicks)
	{
